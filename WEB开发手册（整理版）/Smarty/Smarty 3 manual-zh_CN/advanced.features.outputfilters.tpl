...
<html lang="en">
  <head>
    ...
    <title>输出过滤器 | Smarty</title>
    <meta name="description" content="输出过滤器">
...
<tr><th colspan="3" align="center">输出过滤器</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="advanced.features.postfilters.tpl">Prev</a> </td>
...
<div class="sect1" title="输出过滤器">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="advanced.features.outputfilters"></a>输出过滤器</h2></div></div></div>
<p>
   当通过<a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code></a>或
   <a class="link" href="api.fetch.tpl" title="fetch()"><code class="varname">fetch()</code></a>来调用模板的时候，
   输出的内容将会经过一个或者多个输出过滤器来进行处理。
   对比<a class="link" href="advanced.features.postfilters.tpl" title="后置过滤器">
    <code class="varname">后置过滤器</code></a>，
	后置过滤器是在模板编译后但没有被存储到编译文件前调用，
	输出过滤器是模板执行后准备输出时调用。
   </p>
<p>
 输出过滤器可以通过<a class="link" href="api.register.filter.tpl" title="registerFilter()">注册过滤器</a>来调用，
...
<div class="example">
<a name="id522505"></a><p class="title"><b>Example 17.13. 使用输出过滤器</b></p>
...
// 现在，所有显示的电子邮件地址都会经过简单保护，以防止垃圾邮件爬虫
?&gt;
...
<br class="example-break"><p>
   ...
   <a class="link" href="advanced.features.postfilters.tpl" title="后置过滤器">后置过滤器</a> 和
...
<tr>
<td width="40%" align="left" valign="top">后置过滤器 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 18. 以插件扩展Smarty</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/advanced.features.outputfilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02643 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
