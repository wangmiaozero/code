...
<html lang="en">
  <head>
    ...
    <title>后置过滤器 | Smarty</title>
    <meta name="description" content="后置过滤器">
...
<tr><th colspan="3" align="center">后置过滤器</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="advanced.features.prefilters.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 17. 高级特性</th>
<td width="20%" align="right"> <a accesskey="n" href="advanced.features.outputfilters.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="后置过滤器">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="advanced.features.postfilters"></a>后置过滤器</h2></div></div></div>
<p>
 模板的后置过滤器是当<span class="emphasis"><em>模板被编译后</em></span>时执行的PHP函数。
 后置过滤器可以通过<a class="link" href="api.register.filter.tpl" title="registerFilter()">注册过滤器</a>来调用，
 或者放置到<a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir">插件目录</a>中，用
 <a class="link" href="api.load.filter.tpl" title="loadFilter()"><code class="varname">loadFilter()</code></a>函数或者
 设置<a class="link" href="variable.autoload.filters.tpl" title="$autoload_filters">
   <em class="parameter"><code>$autoload_filters</code></em></a>来调用。
   Smarty把编译后的代码作为第一个参数传递到函数中，并期待函数返回经过处理的代码。
 </p>
<div class="example">
<a name="id522223"></a><p class="title"><b>Example 17.12. 使用后置过滤器</b></p>
...
<p>
  上面的后置过滤器把编译后的<code class="filename">index.tpl</code>的代码变成这样：
  </p>
<pre class="screen">
...
<td width="40%" align="right"> <a accesskey="n" href="advanced.features.outputfilters.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">前置过滤器 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 输出过滤器</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 19 plus 11? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/advanced.features.postfilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02254 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
