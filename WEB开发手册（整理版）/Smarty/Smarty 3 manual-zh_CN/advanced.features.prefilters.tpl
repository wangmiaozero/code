...
<html lang="en">
  <head>
    ...
    <title>前置过滤器 | Smarty</title>
    <meta name="description" content="前置过滤器">
...
<tr><th colspan="3" align="center">前置过滤器</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="advanced.features.static.classes.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 17. 高级特性</th>
<td width="20%" align="right"> <a accesskey="n" href="advanced.features.postfilters.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="前置过滤器">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="advanced.features.prefilters"></a>前置过滤器</h2></div></div></div>
<p>
 前置过滤器是在<span class="emphasis"><em>模板编译之前</em></span>调用的PHP函数。
 该过滤器经常用于删除一些模板中的无用注释、检查注释的来源等等。
 </p>
<p>
 前置过滤器可以通过<a class="link" href="api.register.filter.tpl" title="registerFilter()">注册过滤器</a>来调用，
...
<div class="example">
<a name="id521999"></a><p class="title"><b>Example 17.11. 使用前置过滤器</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="advanced.features.postfilters.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">静态类 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 后置过滤器</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 16 plus 6? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/advanced.features.prefilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02188 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
