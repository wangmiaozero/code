...
<html lang="en">
  <head>
    ...
    <title>静态类 | Smarty</title>
    <meta name="description" content="静态类">
...
<tr><th colspan="3" align="center">静态类</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="advanced.features.objects.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 17. 高级特性</th>
<td width="20%" align="right"> <a accesskey="n" href="advanced.features.prefilters.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="静态类">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="advanced.features.static.classes"></a>静态类</h2></div></div></div>
<p>
 你可以直接用静态类，语法和PHP一样。
 </p>
...
<p>
 不建议直接访问PHP类。这样会将程序的底层代码结构和显示层绑在一起了，
 而且使得模板语法更复杂。
 建议是注册插件以隔离模板和PHP类/对象。
 参见Smarty网站上关于最佳实践的文章。
 </p>
</div>
<div class="example">
<a name="id521375"></a><p class="title"><b>Example 17.10. 静态类存取语法</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="advanced.features.prefilters.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">对象 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 前置过滤器</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 20 plus 6? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/advanced.features.static.classes.tpl">
            </form>
            </div>
          </div>
