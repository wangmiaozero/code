...
<html lang="en">
  <head>
    ...
    <title>数据流 | Smarty</title>
    <meta name="description" content="数据流">
...
<tr><th colspan="3" align="center">数据流</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="advanced.features.template.inheritance.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 17. 高级特性</th>
<td width="20%" align="right"> <a accesskey="n" href="advanced.features.objects.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="数据流">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="advanced.features.streams"></a>数据流</h2></div></div></div>
<p>
你可以用数据流来作为变量。<span class="emphasis"><em>{$foo:bar}</em></span>将使用<span class="emphasis"><em>foo://bar</em></span>的 
数据流来获取模板变量。
</p>
<div class="example">
<a name="id520959"></a><p class="title"><b>Example 17.8. 数据流变量</b></p>
<div class="example-contents">
<p>模板中使用PHP数据流来作为变量</p>
...
<br class="example-break"><p>
  参见
  <a class="link" href="resources.tpl" title="Chapter 16. 资源"><code class="varname">模板资源</code></a>
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="advanced.features.objects.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">模板继承 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 对象</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 0 plus 4? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/advanced.features.streams.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02118 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
