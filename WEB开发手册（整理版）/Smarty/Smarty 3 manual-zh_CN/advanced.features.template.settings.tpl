...
<html lang="en">
  <head>
    ...
    <title>修改模板设置 | Smarty</title>
    <meta name="description" content="修改模板设置">
...
<tr><th colspan="3" align="center">修改模板设置</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="advanced.features.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 17. 高级特性</th>
<td width="20%" align="right"> <a accesskey="n" href="advanced.features.template.inheritance.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="修改模板设置">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="advanced.features.template.settings"></a>修改模板设置</h2></div></div></div>
<p>
 通过你会通过修改<a class="link" href="api.variables.tpl" title="Chapter 13. Smarty成员变量"><code class="varname">Smarty 成员变量</code></a>
 来修改Smarty的设置。
 此外，你还可以通过<a class="link" href="api.functions.tpl" title="Chapter 14. Smarty成员方法"><code class="varname">Smarty 函数</code></a>
 来注册插件、过滤器等等。
 Smarty对象的修改将是全局的。
 </p>
<p>
然而你也可以通过单独的模板对象来修改Smarty的成员变量或调用函数。
模板对象的修改将只会作用于当前模板和其包含的子模板。
</p>
<p>
  </p>
<div class="example">
<a name="id520420"></a><p class="title"><b>Example 17.4. 创建模板对象并修改Smarty的设置</b></p>
...
<div class="example">
<a name="id520441"></a><p class="title"><b>Example 17.5. 创建模板对象并注册插件</b></p>
<div class="example-contents"><pre class="programlisting">
...
<td width="40%" align="right"> <a accesskey="n" href="advanced.features.template.inheritance.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">Chapter 17. 高级特性 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 模板继承</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/advanced.features.template.settings.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02883 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
