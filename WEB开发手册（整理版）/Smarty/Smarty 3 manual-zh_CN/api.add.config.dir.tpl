...
<html lang="en">
  <head>
    ...
    <title>addConfigDir() | Smarty</title>
    <meta name="description" content="addConfigDir()">
    <meta name="keywords" content="addconfigdir, ">
...
<tr><th colspan="3" align="center">addConfigDir()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.functions.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.add.plugins.dir.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="addConfigDir()">
<a name="api.add.config.dir"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>addConfigDir() — 增加一个配置文件目录</p>
</div>
<div class="refsect1" title="说明">
<a name="id487706"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">Smarty </span><span class="methodname">addConfigDir</span>(<span class="methodparam"><span class="type">string|array </span><span class="parameter">config_dir</span></span>,<br>                    <span class="methodparam"><span class="type">string </span><span class="parameter">key</span></span>);</code><div class="example">
<a name="id488057"></a><p class="title"><b>Example 14.1. addConfigDir()</b></p>
...
// 增加一个配置文件的目录并指定一个数组键值
$smarty-&gt;addConfigDir('./config_1', 'one');

// 以数组的方式加入多个配置文件目录，并为每个目录设定一个键值。
$smarty-&gt;addConfigDir(array(
    'two' =&gt; './config_2',
    'three' =&gt; './config_3',
));
...
<br class="example-break"><p>
   参见
   <a class="link" href="api.get.config.dir.tpl" title="getConfigDir()"><code class="varname">getConfigDir()</code></a>,
   <a class="link" href="api.set.config.dir.tpl" title="setConfigDir()"><code class="varname">setConfigDir()</code></a> 和
...
<td width="40%" align="right"> <a accesskey="n" href="api.add.plugins.dir.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">Chapter 14. Smarty成员方法 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> addPluginsDir()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.add.config.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02306 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
