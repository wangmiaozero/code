...
<html lang="en">
  <head>
    ...
    <title>addPluginsDir() | Smarty</title>
    <meta name="description" content="addPluginsDir()">
    <meta name="keywords" content="addpluginsdir, ">
...
<tr><th colspan="3" align="center">addPluginsDir()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.add.config.dir.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.add.template.dir.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="addPluginsDir()">
<a name="api.add.plugins.dir"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>addPluginsDir() — 增加一个插件目录</p>
</div>
<div class="refsect1" title="说明">
<a name="id487778"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">Smarty </span><span class="methodname">addPluginsDir</span>(<span class="methodparam"><span class="type">string|array </span><span class="parameter">plugins_dir</span></span>);</code><div class="example">
<a name="id488287"></a><p class="title"><b>Example 14.2. addPluginsDir()</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="api.add.template.dir.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">addConfigDir() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> addTemplateDir()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.add.plugins.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02128 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
