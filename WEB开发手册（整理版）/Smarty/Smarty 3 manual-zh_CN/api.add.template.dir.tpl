...
<html lang="en">
  <head>
    ...
    <title>addTemplateDir() | Smarty</title>
    <meta name="description" content="addTemplateDir()">
    <meta name="keywords" content="addtemplatedir, ">
...
<tr><th colspan="3" align="center">addTemplateDir()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.add.plugins.dir.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.append.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="addTemplateDir()">
<a name="api.add.template.dir"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>addTemplateDir() — 增加一个模板文件目录</p>
</div>
<div class="refsect1" title="说明">
<a name="id487899"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">Smarty </span><span class="methodname">addTemplateDir</span>(<span class="methodparam"><span class="type">string|array </span><span class="parameter">template_dir</span></span>,<br>                      <span class="methodparam"><span class="type">string </span><span class="parameter">key</span></span>);</code><div class="example">
<a name="id488512"></a><p class="title"><b>Example 14.3. addTemplateDir()</b></p>
...
// 增加一个模板文件的目录并指定一个数组键值
$smarty-&gt;addTemplateDir('./templates_1', 'one');

// 以数组的方式加入多个模板文件目录，并为每个目录设定一个键值。
...
<td width="40%" align="right"> <a accesskey="n" href="api.append.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">addPluginsDir() </td>
...
<td width="40%" align="right" valign="top"> append()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.add.template.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02832 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
