...
<tr><th colspan="3" align="center">append()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.add.template.dir.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.append.by.ref.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="append()">
<a name="api.append"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>append() — 把值追加到数组。</p>
</div>
<div class="refsect1" title="说明">
<a name="id488247"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">append</span>(<span class="methodparam"><span class="type">mixed </span><span class="parameter">var</span></span>);</code><br><code class="methodsynopsis"><span class="type">void </span><span class="methodname">append</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">varname</span></span>,<br>            <span class="methodparam"><span class="type">mixed </span><span class="parameter">var</span></span>,<br>            <span class="methodparam"><span class="type">bool </span><span class="parameter">merge</span></span>);</code><p>
...
<div class="example">
<a name="id488815"></a><p class="title"><b>Example 14.4. append()</b></p>
...
<br class="example-break"><p>参见
  <a class="link" href="api.append.by.ref.tpl" title="appendByRef()"><code class="varname">appendByRef()</code></a>,
...
<td width="40%" align="right"> <a accesskey="n" href="api.append.by.ref.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">addTemplateDir() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> appendByRef()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 13 plus 5? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.append.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01973 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
