...
<html lang="en">
  <head>
    ...
    <title>assignByRef() | Smarty</title>
    <meta name="description" content="assignByRef()">
    <meta name="keywords" content="assignbyref, ">
...
<tr><th colspan="3" align="center">assignByRef()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.assign.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.clear.all.assign.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="assignByRef()">
<a name="api.assign.by.ref"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>assignByRef() — 引用赋值</p>
</div>
<div class="refsect1" title="说明">
<a name="id489464"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">assignByRef</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">varname</span></span>,<br>                 <span class="methodparam"><span class="type">mixed </span><span class="parameter">var</span></span>);</code><p>
   和
   <a class="link" href="api.append.tpl" title="append()"><code class="varname">assign()</code></a> 一样，赋值到模板，但以引用的方式来传递值。
  </p>
<div class="note" title="技术说明" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">技术说明</h3>
<p>
	在PHP5中，<code class="varname">assignByRef()</code>在大部分时候都是没有必要的。只当你希望在模板中可以修改某个PHP数组的值，才有可能会使用到<code class="varname">assignByRef()</code>，当然更好的方法是通过传递对象、改变对象的成员变量来达到目的。
   </p>
</div>
<div class="example">
<a name="id490007"></a><p class="title"><b>Example 14.7. assignByRef()</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="api.clear.all.assign.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">assign() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> clearAllAssign()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 16 plus 15? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.assign.by.ref.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02245 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
