...
<a accesskey="p" href="api.append.by.ref.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.assign.by.ref.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
  如设置第三个参数<em class="parameter"><code>nocache</code></em>为true，则该变量不进行缓存。
   详细参考 <a class="link" href="caching.cacheable.tpl#cacheability.variables" title="变量的缓存控制"><em class="parameter"><code>变量缓存</code></em></a>。
  </p>
...
<div class="example">
<a name="id489577"></a><p class="title"><b>Example 14.6. assign()</b></p>
...
<p>
 参见
 <a class="link" href="api.assign.by.ref.tpl" title="assignByRef()"><code class="varname">assignByRef()</code></a>,
...
<td width="40%" align="right"> <a accesskey="n" href="api.assign.by.ref.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> assignByRef()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 14 plus 14? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.assign.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02224 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
