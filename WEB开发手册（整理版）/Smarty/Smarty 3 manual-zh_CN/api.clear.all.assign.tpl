...
<html lang="en">
  <head>
    ...
    <title>clearAllAssign() | Smarty</title>
    <meta name="description" content="clearAllAssign()">
    <meta name="keywords" content="clearallassign, ">
...
<tr><th colspan="3" align="center">clearAllAssign()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.assign.by.ref.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.clear.all.cache.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="clearAllAssign()">
<a name="api.clear.all.assign"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>clearAllAssign() — 清除全部赋值</p>
</div>
<div class="refsect1" title="说明">
<a name="id489833"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">clearAllAssign</span>();</code><div class="example">
<a name="id489850"></a><p class="title"><b>Example 14.8. clearAllAssign()</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="api.clear.all.cache.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">assignByRef() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> clearAllCache()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.clear.all.assign.tpl">
            </form>
            </div>
          </div>
