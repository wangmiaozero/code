...
<html lang="en">
  <head>
    ...
    <title>clearAllCache() | Smarty</title>
    <meta name="description" content="clearAllCache()">
    <meta name="keywords" content="clearallcache, ">
...
<tr><th colspan="3" align="center">clearAllCache()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.clear.all.assign.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.clear.assign.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="clearAllCache()">
<a name="api.clear.all.cache"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>clearAllCache() — 清除全部缓存</p>
</div>
<div class="refsect1" title="说明">
<a name="id490093"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">clearAllCache</span>(<span class="methodparam"><span class="type">int </span><span class="parameter">expire_time</span></span>);</code><p>
	参数提供了一个最小时间，在这时间到来之前，全部缓存将会被清除。
  </p>
<div class="example">
<a name="id490501"></a><p class="title"><b>Example 14.9. clearAllCache</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="api.clear.assign.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">clearAllAssign() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> clearAssign()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 19 plus 1? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.clear.all.cache.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02167 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
