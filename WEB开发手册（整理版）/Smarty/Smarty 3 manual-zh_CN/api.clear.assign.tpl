...
<html lang="en">
  <head>
    ...
    <title>clearAssign() | Smarty</title>
    <meta name="description" content="clearAssign()">
    <meta name="keywords" content="clearassign, ">
...
<tr><th colspan="3" align="center">clearAssign()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.clear.all.cache.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.clear.cache.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="clearAssign()">
<a name="api.clear.assign"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>clearAssign() — 清除赋值</p>
</div>
<div class="refsect1" title="说明">
<a name="id490215"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">clearAssign</span>(<span class="methodparam"><span class="type">mixed </span><span class="parameter">var</span></span>);</code><p>
可以指定一个单独的值，或是一个数组。
  </p>
<div class="example">
<a name="id490707"></a><p class="title"><b>Example 14.10. clearAssign()</b></p>
...
<br class="example-break"><p>
    ...
    和 <a class="link" href="api.append.tpl" title="append()"><code class="varname">append()</code></a>
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="api.clear.cache.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">clearAllCache() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> clearCache()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.clear.assign.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02162 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
