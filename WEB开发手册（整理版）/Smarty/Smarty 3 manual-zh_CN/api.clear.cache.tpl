...
<html lang="en">
  <head>
    ...
    <title>clearCache() | Smarty</title>
    <meta name="description" content="clearCache()">
...
<tr><th colspan="3" align="center">clearCache()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.clear.assign.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.clear.compiled.tpl.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="clearCache()">
...
<a name="id490471"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">clearCache</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">template</span></span>,<br>                <span class="methodparam"><span class="type">string </span><span class="parameter">cache_id</span></span>,<br>                <span class="methodparam"><span class="type">string </span><span class="parameter">compile_id</span></span>,<br>                <span class="methodparam"><span class="type">int </span><span class="parameter">expire_time</span></span>);</code><div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
   模板中如果有使用<a class="link" href="caching.multiple.caches.tpl" title="单页多个缓存">多个缓存</a>，则可以通过<em class="parameter"><code>cache_id</code></em>指定清除相关缓存。
   </p></li>
<li class="listitem"><p>
   你可以指定第三个参数
   <a class="link" href="variable.compile.id.tpl" title="$compile_id"><em class="parameter"><code>$compile_id</code></em></a>，
   在<a class="link" href="caching.groups.tpl" title="缓存组">模板组</a>中清除一组模板，详见
   <a class="link" href="caching.tpl" title="Chapter 15. 缓存">缓存</a> 了解更多。
   </p></li>
<li class="listitem"><p>
...
<div class="example">
<a name="id491039"></a><p class="title"><b>Example 14.11. clearCache()</b></p>
...
<br class="example-break"><p>
  参见
  <a class="link" href="api.clear.all.cache.tpl" title="clearAllCache()"><code class="varname">clearAllCache()</code></a>
  和
  <a class="link" href="caching.tpl" title="Chapter 15. 缓存"><code class="varname">缓存</code></a>。
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="api.clear.compiled.tpl.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">clearAssign() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> clearCompiledTemplate()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 8 plus 12? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.clear.cache.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02762 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
