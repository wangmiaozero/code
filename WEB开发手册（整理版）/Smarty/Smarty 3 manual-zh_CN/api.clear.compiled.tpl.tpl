...
<html lang="en">
  <head>
    ...
    <title>clearCompiledTemplate() | Smarty</title>
    <meta name="description" content="clearCompiledTemplate()">
    <meta name="keywords" content="clearcompiledtemplate, ">
...
<tr><th colspan="3" align="center">clearCompiledTemplate()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.clear.cache.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.clear.config.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="clearCompiledTemplate()">
<a name="api.clear.compiled.tpl"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>clearCompiledTemplate() — 清除模板编译文件</p>
</div>
<div class="refsect1" title="说明">
<a name="id490819"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">clearCompiledTemplate</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">tpl_file</span></span>,<br>                           <span class="methodparam"><span class="type">string </span><span class="parameter">compile_id</span></span>,<br>                           <span class="methodparam"><span class="type">int </span><span class="parameter">exp_time</span></span>);</code><p>
  清除特定模板的编译文件，如不指定特定模板则清除全部的编译文件。
  设置<a class="link" href="variable.compile.id.tpl" title="$compile_id"><em class="parameter"><code>$compile_id</code></em></a>将只清除该<a class="link" href="variable.compile.id.tpl" title="$compile_id"><em class="parameter"><code>$compile_id</code></em></a>对应的编译文件。
   如设置了exp_time值，则只会清除比<em class="parameter"><code>exp_time</code></em>更老的时间编译的编译文件。
   除非特殊的需要，一般情况下不需要使用该函数。
  </p>
<div class="example">
<a name="id491382"></a><p class="title"><b>Example 14.12. clearCompiledTemplate()</b></p>
...
<br class="example-break"><p>参见
  <a class="link" href="api.clear.cache.tpl" title="clearCache()"><code class="varname">clearCache()</code></a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="api.clear.config.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">clearCache() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> clearConfig()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 14 plus 0? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.clear.compiled.tpl.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02420 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
