...
<html lang="en">
  <head>
    ...
    <title>clearConfig() | Smarty</title>
    <meta name="description" content="clearConfig()">
    <meta name="keywords" content="clearconfig, ">
...
<tr><th colspan="3" align="center">clearConfig()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.clear.compiled.tpl.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.compile.all.config.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="clearConfig()">
<a name="api.clear.config"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>clearConfig() — 清除配置</p>
</div>
<div class="refsect1" title="说明">
<a name="id491295"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">clearConfig</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">var</span></span>);</code><p>
  该函数将清除全部的<a class="link" href="language.config.variables.tpl" title="从配置文件获取的变量">预配置变量</a>。
   如果设置了参数，则仅清除指定的配置值。
  </p>
<div class="example">
<a name="id491174"></a><p class="title"><b>Example 14.13. clearConfig()</b></p>
...
<br class="example-break"><p>
  ...
  <a class="link" href="config.files.tpl" title="Chapter 9. 配置文件"><code class="varname">配置文件</code></a>,
  ...
  和
  <a class="link" href="api.clear.assign.tpl" title="clearAssign()"><code class="varname">clearAssign()</code></a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="api.compile.all.config.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">clearCompiledTemplate() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> compileAllConfig()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 8 plus 15? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.clear.config.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02161 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
