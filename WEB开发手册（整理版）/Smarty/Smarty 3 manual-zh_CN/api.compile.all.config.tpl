...
<html lang="en">
  <head>
    ...
    <title>compileAllConfig() | Smarty</title>
    <meta name="description" content="compileAllConfig()">
    <meta name="keywords" content="compileallconfig, ">
...
<a accesskey="p" href="api.clear.config.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.compile.all.templates.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<h2>Name</h2>
<p>compileAllConfig() — 编译全部配置文件</p>
</div>
<div class="refsect1" title="说明">
<a name="id491463"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">string </span><span class="methodname">compileAllConfig</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">extension</span></span>,<br>                        <span class="methodparam"><span class="type">boolean </span><span class="parameter">force</span></span>,<br>                        <span class="methodparam"><span class="type">integer </span><span class="parameter">timelimit</span></span>,<br>                        <span class="methodparam"><span class="type">integer </span><span class="parameter">maxerror</span></span>);</code><p>
   该函数将编译全部在<a class="link" href="variable.config.dir.tpl" title="$config_dir"><code class="varname">$config_dir</code></a>文件夹内的配置文件。
   参数如下：
    </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
       <em class="parameter"><code>extension</code></em> 字符串，指定模板文件的后缀名。默认为“.conf”。
      </p></li>
<li class="listitem"><p>
...
<div class="example">
<a name="id491999"></a><p class="title"><b>Example 14.14. compileAllConfig()</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="api.compile.all.templates.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> compileAllTemplates()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 20 plus 20? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="81cd6df0fbf04ced9e5efcaa440afbbf">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.compile.all.config.tpl">
            </form>
            </div>
          </div>
