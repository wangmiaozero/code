...
<html lang="en">
  <head>
    ...
    <title>compileAllTemplates() | Smarty</title>
    <meta name="description" content="compileAllTemplates()">
    <meta name="keywords" content="compilealltemplates, ">
...
<tr><th colspan="3" align="center">compileAllTemplates()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.compile.all.config.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.config.load.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="compileAllTemplates()">
<a name="api.compile.all.templates"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>compileAllTemplates() — 编译全部模板</p>
</div>
<div class="refsect1" title="说明">
<a name="id491810"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">string </span><span class="methodname">compileAllTemplates</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">extension</span></span>,<br>                           <span class="methodparam"><span class="type">boolean </span><span class="parameter">force</span></span>,<br>                           <span class="methodparam"><span class="type">integer </span><span class="parameter">timelimit</span></span>,<br>                           <span class="methodparam"><span class="type">integer </span><span class="parameter">maxerror</span></span>);</code><p>
    该函数将编译<a class="link" href="variable.template.dir.tpl" title="$template_dir"><code class="varname">$template_dir</code></a>目录下的模板文件。
    参数如下：
    </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
       <em class="parameter"><code>extension</code></em> 字符串，指定模板文件的后缀名。默认为“.tpl”。
      </p></li>
<li class="listitem"><p>
       <em class="parameter"><code>force</code></em> 布尔值。设定是否仅编译已修改的模板文件（false）或强制编译全部模板文件（true）。默认是false。
      </p></li>
<li class="listitem"><p>
       <em class="parameter"><code>timelimit</code></em> 整型，设定模板编译过程的时间限制。默认是无限制。
      </p></li>
<li class="listitem"><p>
       <em class="parameter"><code>maxerror</code></em> 整型，设定编译过程中出现的最大错误次数，超过此次数将停止编译。默认是无限制。
      </p></li>
</ul></div>
<p>
  </p>
...
<div class="example">
<a name="id492404"></a><p class="title"><b>Example 14.15. compileAllTemplates()</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="api.config.load.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">compileAllConfig() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> configLoad()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 20 plus 19? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="9eef68f6af2e546f45843eb3baa34a1b">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.compile.all.templates.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02323 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
