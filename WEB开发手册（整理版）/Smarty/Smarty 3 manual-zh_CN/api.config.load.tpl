...
<html lang="en">
  <head>
    ...
    <title>configLoad() | Smarty</title>
    <meta name="description" content="configLoad()">
    <meta name="keywords" content="configload, ">
...
<tr><th colspan="3" align="center">configLoad()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.compile.all.templates.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.create.data.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="configLoad()">
<a name="api.config.load"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>configLoad() — 载入预配置的变量</p>
</div>
<div class="refsect1" title="说明">
<a name="id492227"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">configLoad</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">file</span></span>,<br>                <span class="methodparam"><span class="type">string </span><span class="parameter">section</span></span>);</code><p>
  该函数将从<a class="link" href="config.files.tpl" title="Chapter 9. 配置文件">文件</a>中载入预配置的变量，功能等同<a class="link" href="language.function.config.load.tpl" title="{config_load}"><code class="varname">{config_load}</code></a>函数。
  </p>
<div class="note" title="技术说明" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">技术说明</h3>
<p>
    从Smarty 2.4.0开始，当程序调用<a class="link" href="api.fetch.tpl" title="fetch()"><code class="varname">fetch()</code></a>
    和 <a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code></a>的时候，预配置文件才会被载入并赋值，同时
    <code class="varname">configLoad()</code>加载的变量总是全局的变量。
    如果希望更快速地载入预配置变量，请开启<a class="link" href="variable.force.compile.tpl" title="$force_compile">
    <em class="parameter"><code>$force_compile</code></em></a> 和
    <a class="link" href="variable.compile.check.tpl" title="$compile_check">
    <em class="parameter"><code>$compile_check</code></em></a>配置。
   </p>
</div>
<div class="example">
<a name="id492774"></a><p class="title"><b>Example 14.16. configLoad()</b></p>
...
<br class="example-break"><p>
  参见
  <a class="link" href="language.function.config.load.tpl" title="{config_load}"><code class="varname">{config_load}</code></a>,
  <a class="link" href="api.get.config.vars.tpl" title="getConfigVars()"><code class="varname">getConfigVars()</code></a>,
  <a class="link" href="api.clear.config.tpl" title="clearConfig()"><code class="varname">clearConfig()</code></a>,
  和
  <a class="link" href="language.config.variables.tpl" title="从配置文件获取的变量"><code class="varname">预配置变量</code></a>
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="api.create.data.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">compileAllTemplates() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> createData()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 14 plus 2? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.config.load.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02148 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
