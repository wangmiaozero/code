...
<html lang="en">
  <head>
    ...
    <title>createData() | Smarty</title>
    <meta name="description" content="createData()">
    <meta name="keywords" content="createdata, ">
...
<a accesskey="p" href="api.config.load.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.create.template.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<h2>Name</h2>
<p>createData() — 创建数据对象</p>
</div>
<div class="refsect1" title="说明">
<a name="id492614"></a><h2>说明</h2>
...
<div class="itemizedlist"><ul class="itemizedlist" type="disc"><li class="listitem"><p>
      <em class="parameter"><code>parent</code></em>可选。表示一个继承于Smarty对象的上层对象，上层对象可以是用户创建的其他数据对象或者是模板对象，这些对象可以链接起来。对象链条可共同对模板进行赋值。
     </p></li></ul></div>
<p>
  </p>
<p>
...
<div class="example">
<a name="id493114"></a><p class="title"><b>Example 14.17. createData()</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="api.create.template.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> createTemplate()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.create.data.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02143 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
