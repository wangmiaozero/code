...
<html lang="en">
  <head>
    ...
    <title>createTemplate() | Smarty</title>
    <meta name="description" content="createTemplate()">
    <meta name="keywords" content="createtemplate, ">
...
<tr><th colspan="3" align="center">createTemplate()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.create.data.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.disable.security.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="createTemplate()">
<a name="api.create.template"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>createTemplate() — 创建模板对象</p>
</div>
<div class="refsect1" title="说明">
<a name="id493039"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">Smarty_Internal_Template </span><span class="methodname">createTemplate</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">template</span></span>,<br>                                        <span class="methodparam"><span class="type">object </span><span class="parameter">parent</span></span>);</code><br><code class="methodsynopsis"><span class="type">Smarty_Internal_Template </span><span class="methodname">createTemplate</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">template</span></span>,<br>                                        <span class="methodparam"><span class="type">array </span><span class="parameter">data</span></span>);</code><br><code class="methodsynopsis"><span class="type">Smarty_Internal_Template </span><span class="methodname">createTemplate</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">template</span></span>,<br>                                        <span class="methodparam"><span class="type">string </span><span class="parameter">cache_id</span></span>,<br>                                        <span class="methodparam"><span class="type">string </span><span class="parameter">compile_id</span></span>,<br>                                        <span class="methodparam"><span class="type">object </span><span class="parameter">parent</span></span>);</code><br><code class="methodsynopsis"><span class="type">Smarty_Internal_Template </span><span class="methodname">createTemplate</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">template</span></span>,<br>                                        <span class="methodparam"><span class="type">string </span><span class="parameter">cache_id</span></span>,<br>                                        <span class="methodparam"><span class="type">string </span><span class="parameter">compile_id</span></span>,<br>                                        <span class="methodparam"><span class="type">array </span><span class="parameter">data</span></span>);</code><p>
   创建一个模板对象，可以让<a class="link" href="api.display.tpl" title="display()">display</a>或者<a class="link" href="api.fetch.tpl" title="fetch()">fetch</a>来使用。
    参数如下：
    </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
       <em class="parameter"><code>template</code></em>必须是 
       <a class="link" href="resources.tpl" title="Chapter 16. 资源">模板资源</a>类型和路径。
      </p></li>
<li class="listitem"><p>
<em class="parameter"><code>cache_id</code></em> is an optional parameter. You can
 also set the <a class="link" href="variable.cache.id.tpl" title="$cache_id">
 <em class="parameter"><code>$cache_id</code></em></a> variable once instead of passing
  this to each call to this function. It is used in the event that you want to 
  cache different content of the same template, such as pages for displaying different products. See also the <a class="link" href="caching.tpl" title="Chapter 15. 缓存">caching
   section</a> for more information.
</p></li>
<li class="listitem"><p>
<em class="parameter"><code>compile_id</code></em> is an optional parameter. You can
...
<li class="listitem"><p>
<em class="parameter"><code>data</code></em> is an optional parameter. It is an associative array
...
<div class="example">
<a name="id493644"></a><p class="title"><b>Example 14.18. createTemplate()</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="api.disable.security.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">createData() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> disableSecurity()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.create.template.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02484 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
