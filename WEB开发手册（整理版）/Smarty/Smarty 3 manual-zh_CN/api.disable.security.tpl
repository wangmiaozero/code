...
<html lang="en">
  <head>
    ...
    <title>disableSecurity() | Smarty</title>
    <meta name="description" content="disableSecurity()">
    <meta name="keywords" content="disablesecurity, ">
...
<tr><th colspan="3" align="center">disableSecurity()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.create.template.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.display.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="disableSecurity()">
<a name="api.disable.security"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>disableSecurity() — 关闭安全检查</p>
</div>
<div class="refsect1" title="说明">
<a name="id493820"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">string </span><span class="methodname">disableSecurity</span>();</code><p>
  该函数将关闭模板的安全检查。
  </p>
<p>
   参见
   <a class="link" href="api.enable.security.tpl" title="enableSecurity()"><code class="varname">enableSecurity()</code></a>,
    和
...
<td width="40%" align="right"> <a accesskey="n" href="api.display.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">createTemplate() </td>
...
<td width="40%" align="right" valign="top"> display()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 13 plus 6? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.disable.security.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02481 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
