...
<html lang="en">
  <head>
    ...
    <title>enableSecurity() | Smarty</title>
    <meta name="description" content="enableSecurity()">
    <meta name="keywords" content="enablesecurity, ">
...
<tr><th colspan="3" align="center">enableSecurity()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.display.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.fetch.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="enableSecurity()">
<a name="api.enable.security"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>enableSecurity() — 开启安全检查</p>
</div>
<div class="refsect1" title="说明">
<a name="id494314"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">string </span><span class="methodname">enableSecurity</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">securityclass</span></span>);</code><br><code class="methodsynopsis"><span class="type">string </span><span class="methodname">enableSecurity</span>(<span class="methodparam"><span class="type">object </span><span class="parameter">securityobject</span></span>);</code><br><code class="methodsynopsis"><span class="type">string </span><span class="methodname">enableSecurity</span>();</code><p>
  开启模板的安全检查。
  参数如下：
    </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
       <em class="parameter"><code>securityclass</code></em>可选，安全机制中设定的类。
      </p></li>
<li class="listitem"><p>
       <em class="parameter"><code>securityobject</code></em>可选，安全机制中设定的对象。
      </p></li>
</ul></div>
<p>
  </p>
<p>
  关于安全机制，详细请参见<a class="link" href="advanced.features.tpl#advanced.features.security" title="安全">安全</a>。
  </p>
<p>
   参见
   <a class="link" href="api.disable.security.tpl" title="disableSecurity()"><code class="varname">disableSecurity()</code></a>,
    和
...
<td width="40%" align="right"> <a accesskey="n" href="api.fetch.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> fetch()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 8 plus 20? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.enable.security.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02918 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
