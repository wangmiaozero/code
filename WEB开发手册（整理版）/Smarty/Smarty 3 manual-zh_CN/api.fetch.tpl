...
<a accesskey="p" href="api.enable.security.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.get.cache.dir.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<code class="methodsynopsis"><span class="type">string </span><span class="methodname">fetch</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">template</span></span>,<br>             <span class="methodparam"><span class="type">string </span><span class="parameter">cache_id</span></span>,<br>             <span class="methodparam"><span class="type">string </span><span class="parameter">compile_id</span></span>);</code><p>
  该函数将取得一个模板输出的内容，而不是<a class="link" href="api.display.tpl" title="display()">显示</a>出来。
...
<div class="example">
<a name="id495131"></a><p class="title"><b>Example 14.21. fetch()</b></p>
...
<div class="example">
<a name="id495154"></a><p class="title"><b>Example 14.22. 用fetch()来发邮件</b></p>
<div class="example-contents">
<p>
     <code class="filename">email_body.tpl</code>模板的内容：
    </p>
...
<p>
	该PHP脚本使用了PHP的<a class="ulink" href="../../../www.php.net/function.mail" target="_top">
     <code class="varname">mail()</code></a>函数。
    </p>
<pre class="programlisting">
...
<td width="40%" align="right"> <a accesskey="n" href="api.get.cache.dir.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">enableSecurity() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> getCacheDir()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 11 plus 4? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.fetch.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02181 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
