...
<html lang="en">
  <head>
    ...
    <title>getCacheDir() | Smarty</title>
    <meta name="description" content="getCacheDir()">
    <meta name="keywords" content="getcachedir, ">
...
<tr><th colspan="3" align="center">getCacheDir()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.fetch.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.get.compile.dir.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="getCacheDir()">
<a name="api.get.cache.dir"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>getCacheDir() — 取得缓存目录</p>
</div>
<div class="refsect1" title="说明">
<a name="id495001"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">string </span><span class="methodname">getCacheDir</span>();</code><div class="example">
<a name="id495018"></a><p class="title"><b>Example 14.23. getCacheDir()</b></p>
...
<br class="example-break"><p>
  参见
   <a class="link" href="api.set.cache.dir.tpl" title="setCacheDir()"><code class="varname">setCacheDir()</code></a>和
...
<td width="40%" align="right"> <a accesskey="n" href="api.get.compile.dir.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">fetch() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> getCompileDir()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 9 plus 0? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.get.cache.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02370 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
