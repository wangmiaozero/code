...
<html lang="en">
  <head>
    ...
    <title>getCompileDir() | Smarty</title>
    <meta name="description" content="getCompileDir()">
    <meta name="keywords" content="getcompiledir, ">
...
<tr><th colspan="3" align="center">getCompileDir()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.get.cache.dir.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.get.config.dir.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="getCompileDir()">
<a name="api.get.compile.dir"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>getCompileDir() — 取得编译目录</p>
</div>
<div class="refsect1" title="说明">
<a name="id495526"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">string </span><span class="methodname">getCompileDir</span>();</code><div class="example">
<a name="id495319"></a><p class="title"><b>Example 14.24. getCompileDir()</b></p>
...
<br class="example-break"><p>
   参见
   <a class="link" href="api.set.compile.dir.tpl" title="setCompileDir()"><code class="varname">setCompileDir()</code></a> 和
...
<td width="40%" align="right"> <a accesskey="n" href="api.get.config.dir.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">getCacheDir() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> getConfigDir()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 1 plus 7? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.get.compile.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02141 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
