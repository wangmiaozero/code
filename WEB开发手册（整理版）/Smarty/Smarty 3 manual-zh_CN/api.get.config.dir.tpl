...
<html lang="en">
  <head>
    ...
    <title>getConfigDir() | Smarty</title>
    <meta name="description" content="getConfigDir()">
    <meta name="keywords" content="getconfigdir, ">
...
<tr><th colspan="3" align="center">getConfigDir()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.get.compile.dir.tpl">Prev</a> </td>
...
<div class="refentry" title="getConfigDir()">
<a name="api.get.config.dir"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>getConfigDir() — 取得配置文件目录</p>
</div>
<div class="refsect1" title="说明">
<a name="id495443"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">string|array </span><span class="methodname">getConfigDir</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">key</span></span>);</code><div class="example">
<a name="id495478"></a><p class="title"><b>Example 14.25. getConfigDir()</b></p>
...
<br class="example-break"><p>
   参见
   <a class="link" href="api.set.config.dir.tpl" title="setConfigDir()"><code class="varname">setConfigDir()</code></a>,
...
<tr>
<td width="40%" align="left" valign="top">getCompileDir() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> getConfigVars()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 0 plus 5? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.get.config.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02778 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
