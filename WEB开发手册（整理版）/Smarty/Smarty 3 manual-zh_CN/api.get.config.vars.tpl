...
<html lang="en">
  <head>
    ...
    <title>getConfigVars() | Smarty</title>
    <meta name="description" content="getConfigVars()">
    <meta name="keywords" content="getconfigvars, ">
...
<tr><th colspan="3" align="center">getConfigVars()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.get.config.dir.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.get.plugins.dir.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="getConfigVars()">
<a name="api.get.config.vars"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>getConfigVars() — 取得预配置变量</p>
</div>
<div class="refsect1" title="说明">
<a name="id495680"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">array </span><span class="methodname">getConfigVars</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">varname</span></span>);</code><p>
  当不设置参数的时候，该函数将返回全部的<a class="link" href="language.config.variables.tpl" title="从配置文件获取的变量">预配置变量</a>。
  </p>
<div class="example">
<a name="id496097"></a><p class="title"><b>Example 14.26. getConfigVars()</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="api.get.plugins.dir.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">getConfigDir() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> getPluginsDir()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 10 plus 12? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.get.config.vars.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02941 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
