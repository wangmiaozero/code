...
<html lang="en">
  <head>
    ...
    <title>getPluginsDir() | Smarty</title>
    <meta name="description" content="getPluginsDir()">
    <meta name="keywords" content="getpluginsdir, ">
...
<tr><th colspan="3" align="center">getPluginsDir()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.get.config.vars.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.get.registered.object.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="getPluginsDir()">
<a name="api.get.plugins.dir"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>getPluginsDir() — 取得插件目录</p>
</div>
<div class="refsect1" title="说明">
<a name="id495870"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">array </span><span class="methodname">getPluginsDir</span>();</code><div class="example">
<a name="id496314"></a><p class="title"><b>Example 14.27. getPluginsDir()</b></p>
...
<br class="example-break"><p>
   参见
   <a class="link" href="api.set.plugins.dir.tpl" title="setPluginsDir()"><code class="varname">setPluginsDir()</code></a>,
   <a class="link" href="api.add.plugins.dir.tpl" title="addPluginsDir()"><code class="varname">addPluginsDir()</code></a> 和
...
<td width="40%" align="right"> <a accesskey="n" href="api.get.registered.object.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">getConfigVars() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> getRegisteredObject()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 19 plus 16? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.get.plugins.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02172 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
