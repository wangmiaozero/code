...
<html lang="en">
  <head>
    ...
    <title>getRegisteredObject() | Smarty</title>
    <meta name="description" content="getRegisteredObject()">
    <meta name="keywords" content="getregisteredobject, ">
...
<tr><th colspan="3" align="center">getRegisteredObject()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.get.plugins.dir.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.get.tags.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="getRegisteredObject()">
<a name="api.get.registered.object"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>getRegisteredObject() — 获取已注册对象</p>
</div>
<div class="refsect1" title="说明">
<a name="id496075"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">array </span><span class="methodname">getRegisteredObject</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">object_name</span></span>);</code><p>
  该函数可以很方便地在自定义函数中获取一个<a class="link" href="api.register.object.tpl" title="registerObject()">注册对象</a>。详情参见
   <a class="link" href="advanced.features.objects.tpl" title="对象">对象</a>。
  </p>
<div class="example">
<a name="id496528"></a><p class="title"><b>Example 14.28. getRegisteredObject()</b></p>
...
<br class="example-break"><p>
  ...
  <a class="link" href="api.unregister.object.tpl" title="unregisterObject()"><code class="varname">unregisterObject()</code></a>
  和
  <a class="link" href="advanced.features.objects.tpl" title="对象">对象</a>
  </p>
</div>
...
<td width="40%" align="right"> <a accesskey="n" href="api.get.tags.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">getPluginsDir() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> getTags()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.get.registered.object.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02864 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
