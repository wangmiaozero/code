...
<html lang="en">
  <head>
    ...
    <title>getTags() | Smarty</title>
    <meta name="description" content="getTags()">
    <meta name="keywords" content="gettags, ">
...
<tr><th colspan="3" align="center">getTags()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.get.registered.object.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.get.template.dir.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="getTags()">
<a name="api.get.tags"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>getTags() — 取得模板标签</p>
</div>
<div class="refsect1" title="说明">
<a name="id496279"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">string </span><span class="methodname">getTags</span>(<span class="methodparam"><span class="type">object </span><span class="parameter">template</span></span>);</code><p>
   该函数将返回模板内全部的标签名/值。
  参数如下：
    </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc"><li class="listitem"><p>
       <em class="parameter"><code>template</code></em> 模板对象
      </p></li></ul></div>
<p>
  </p>
...
<div class="example">
<a name="id496774"></a><p class="title"><b>Example 14.29. getTags()</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="api.get.template.dir.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">getRegisteredObject() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> getTemplateDir()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 4 plus 11? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.get.tags.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02811 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
