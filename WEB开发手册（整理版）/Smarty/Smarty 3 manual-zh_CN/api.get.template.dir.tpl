...
<html lang="en">
  <head>
    ...
    <title>getTemplateDir() | Smarty</title>
    <meta name="description" content="getTemplateDir()">
    <meta name="keywords" content="gettemplatedir, ">
...
<tr><th colspan="3" align="center">getTemplateDir()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.get.tags.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.get.template.vars.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="getTemplateDir()">
<a name="api.get.template.dir"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>getTemplateDir() — 取得模板目录</p>
</div>
<div class="refsect1" title="说明">
<a name="id496468"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">string|array </span><span class="methodname">getTemplateDir</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">key</span></span>);</code><div class="example">
<a name="id496954"></a><p class="title"><b>Example 14.30. getTemplateDir()</b></p>
...
var_dump($template_dir); // 数组

// 取得特定的模板目录
$template_dir = $smarty-&gt;getTemplateDir('one');
var_dump($template_dir); // 字符串
...
<br class="example-break"><p>
   参见
   <a class="link" href="api.set.template.dir.tpl" title="setTemplateDir()"><code class="varname">setTemplateDir()</code></a>,
...
<td width="40%" align="right"> <a accesskey="n" href="api.get.template.vars.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">getTags() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> getTemplateVars()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.get.template.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02237 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
