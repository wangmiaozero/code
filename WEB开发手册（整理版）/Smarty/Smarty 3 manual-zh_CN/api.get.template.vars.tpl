...
<html lang="en">
  <head>
    ...
    <title>getTemplateVars() | Smarty</title>
    <meta name="description" content="getTemplateVars()">
    <meta name="keywords" content="gettemplatevars, ">
...
<tr><th colspan="3" align="center">getTemplateVars()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.get.template.dir.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.is.cached.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="getTemplateVars()">
<a name="api.get.template.vars"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>getTemplateVars() — 取得变量值</p>
</div>
<div class="refsect1" title="说明">
<a name="id496680"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">array </span><span class="methodname">getTemplateVars</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">varname</span></span>);</code><p>
  如果不设置参数，则全部<a class="link" href="api.assign.tpl" title="assign()">赋值</a>的变量值都将返回。
  </p>
<div class="example">
<a name="id497175"></a><p class="title"><b>Example 14.31. getTemplateVars</b></p>
...
<br class="example-break"><p>
  参见 <a class="link" href="api.assign.tpl" title="assign()"><code class="varname">assign()</code></a>,
  <a class="link" href="language.function.assign.tpl" title="{assign}"><code class="varname">{assign}</code></a>,
  <a class="link" href="api.append.tpl" title="append()"><code class="varname">append()</code></a>,
  <a class="link" href="api.clear.assign.tpl" title="clearAssign()"><code class="varname">clearAssign()</code></a>,
  <a class="link" href="api.clear.all.assign.tpl" title="clearAllAssign()"><code class="varname">clearAllAssign()</code></a>
  和
...
<td width="40%" align="right"> <a accesskey="n" href="api.is.cached.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">getTemplateDir() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> isCached()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 5 plus 13? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.get.template.vars.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03142 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
