...
<html lang="en">
  <head>
    ...
    <title>isCached() | Smarty</title>
    <meta name="description" content="isCached()">
...
<tr><th colspan="3" align="center">isCached()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.get.template.vars.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.load.filter.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<h2>Name</h2>
<p>isCached() — 检查模板是否已经缓存</p>
</div>
<div class="refsect1" title="说明">
<a name="id497141"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">bool </span><span class="methodname">isCached</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">template</span></span>,<br>              <span class="methodparam"><span class="type">string </span><span class="parameter">cache_id</span></span>,<br>              <span class="methodparam"><span class="type">string </span><span class="parameter">compile_id</span></span>);</code><div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
  此函数仅在<a class="link" href="variable.caching.tpl" title="$caching">
    <em class="parameter"><code>$caching</code></em></a>设置为<code class="literal">Smarty::CACHING_LIFETIME_CURRENT</code>或<code class="literal">Smarty::CACHING_LIFETIME_SAVED</code>的时候启用。
	参见
   <a class="link" href="caching.tpl" title="Chapter 15. 缓存">缓存</a>。
  </p></li>
<li class="listitem"><p>
	当你需要使用<a class="link" href="caching.multiple.caches.tpl" title="单页多个缓存">多个缓存</a>时，需要设置
	<em class="parameter"><code>$cache_id</code></em>这个可选参数。
  </p></li>
<li class="listitem"><p>
  你可以传递第三个可选的参数
  <a class="link" href="variable.compile.id.tpl" title="$compile_id"><em class="parameter"><code>$compile id</code></em></a>。
  如果省略了该参数，那么会继续使用之前的<a class="link" href="variable.compile.id.tpl" title="$compile_id">
   <em class="parameter"><code>$compile_id</code></em></a>，如果它有设置的话。
  </p></li>
<li class="listitem"><p>
  如果你不希望传递<em class="parameter"><code>$cache_id</code></em>但想传递<a class="link" href="variable.compile.id.tpl" title="$compile_id">
   <em class="parameter"><code>$compile_id</code></em></a>参数，你可以传递一个<code class="constant">NULL</code>作为<em class="parameter"><code>$cache_id</code></em>.
  </p></li>
</ul></div>
<div class="note" title="技术说明" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">技术说明</h3>
<p>
   如果<code class="varname">isCached()</code>返回 <code class="constant">TRUE</code> ，那么系统底层将已经载入了缓存的内容并存储到系统中。
   接着执行的<a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code></a> 或者
   <a class="link" href="api.fetch.tpl" title="fetch()"><code class="varname">fetch()</code></a>
   将直接返回存储在系统中的缓存内容，而不会再从缓存文件内读取。
   这个机制避免了在执行<code class="varname">isCached()</code>和
   <a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code></a>的时候重复两次读取缓存内容，导致系统开销。
   这也意味着，在<code class="varname">isCached()</code> 返回<code class="constant">TRUE</code>后，调用的
   <a class="link" href="api.clear.cache.tpl" title="clearCache()"><code class="varname">clearCache()</code></a>
   或者其他缓存设置，将不会影响缓存的内容输出。
  </p>
</div>
<div class="example">
<a name="id497644"></a><p class="title"><b>Example 14.32. isCached()</b></p>
...
<a name="id497662"></a><p class="title"><b>Example 14.33. isCached()用于多缓存的模板</b></p>
<div class="example-contents"><pre class="programlisting">
...
<td width="40%" align="right"> <a accesskey="n" href="api.load.filter.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> loadFilter()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 10 plus 7? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.is.cached.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02834 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
