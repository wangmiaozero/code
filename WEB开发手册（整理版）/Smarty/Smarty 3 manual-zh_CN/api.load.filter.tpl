...
<html lang="en">
  <head>
    ...
    <title>loadFilter() | Smarty</title>
    <meta name="description" content="loadFilter()">
    <meta name="keywords" content="loadfilter, ">
...
<tr><th colspan="3" align="center">loadFilter()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.is.cached.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.mute.expected.errors.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="loadFilter()">
<a name="api.load.filter"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>loadFilter() — 载入过滤插件</p>
</div>
<div class="refsect1" title="说明">
<a name="id497741"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">loadFilter</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">type</span></span>,<br>                <span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>);</code><p>
  第一个参数代表过滤器的类型，取值应当是<code class="literal">pre</code>、<code class="literal">post</code>或者
   <code class="literal">output</code>之一。
   第二个参数<em class="parameter"><code>name</code></em> 设定过滤器的名称。
  </p>
<div class="example">
<a name="id498121"></a><p class="title"><b>Example 14.34. 载入过滤插件</b></p>
...
// 载入另一个名为'datefooter'的前置过滤器
$smarty-&gt;loadFilter('pre', 'datefooter');

// 载入名为'compress'的输出过滤器
...
<br class="example-break"><p>
  参见
  <a class="link" href="api.register.filter.tpl" title="registerFilter()"><code class="varname">registerFilter()</code></a>,
  ...
  和
  <a class="link" href="advanced.features.tpl" title="Chapter 17. 高级特性">高级特性</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="api.mute.expected.errors.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">isCached() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Smarty::muteExpectedErrors()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 17 plus 14? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.load.filter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01714 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
