...
<html lang="en">
  <head>
    ...
    <title>Smarty::muteExpectedErrors() | Smarty</title>
    <meta name="description" content="Smarty::muteExpectedErrors()">
    <meta name="keywords" content="smarty, muteexpectederrors, ">
...
<a accesskey="p" href="api.load.filter.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.register.cacheresource.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<h2>Name</h2>
<p>Smarty::muteExpectedErrors() — 忽略脚本警告信息</p>
</div>
<div class="refsect1" title="说明">
<a name="id498048"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">string </span><span class="methodname">muteExpectedErrors</span>();</code><p>
  muteExpectedErrors() 通过PHP的<a class="ulink" href="../../../www.php.net/set_error_handler/index.htm" target="_top">set_error_handler()</a>函数来注册一个自定义错误处理器。
  该错误处理器仅简单通过<code class="literal">$errno</code> 和 <code class="literal">$errfile</code>来检查当前错误，如果当前错误级别是warning或notice将被忽略，而如果是其他错误级别将被传递到下一个错误处理器。 
  </p>
<p>
   <code class="literal">Smarty::unmuteExpectedErrors()</code>可移除当前的自定义错误处理器。
   请注意，如果在调用了muteExpectedErrors()后，你还有注册一些自定义错误处理器，那么<code class="literal">Smarty::unmuteExpectedErrors()</code>将只会移除在后面注册的处理器，而不会移除muteExpectedErrors()注册的处理器。
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="api.register.cacheresource.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> registerCacheResource()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 0 plus 8? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="91705eefaede1044d330e5bd2ef9bed4">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.mute.expected.errors.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02371 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
