...
<html lang="en">
  <head>
    ...
    <title>registerCacheResource() | Smarty</title>
    <meta name="description" content="registerCacheResource()">
    <meta name="keywords" content="registercacheresource, ">
...
<tr><th colspan="3" align="center">registerCacheResource()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.mute.expected.errors.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.register.class.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="registerCacheResource()">
<a name="api.register.cacheresource"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>registerCacheResource() — 注册缓存资源</p>
</div>
<div class="refsect1" title="说明">
<a name="id498379"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">registerCacheResource</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>,<br>                           <span class="methodparam"><span class="type">Smarty_CacheResource </span><span class="parameter">resource_handler</span></span>);</code><p>
  该函数可以在Smarty中注册一个<a class="link" href="caching.custom.tpl" title="自定义缓存实现">自定义缓存资源</a>。
  参数<em class="parameter"><code>name</code></em>是继承于Smarty_CacheResource的缓存资源名称。
   详情参见<a class="link" href="caching.custom.tpl" title="自定义缓存实现">自定义缓存</a>。
  </p>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
<p>
   在Smarty2中使用了callback回调函数来调用$cache_handler_func。
   Smarty3用<code class="literal">Smarty_CacheResource</code>模块来替代该回调方法。
   </p>
</div>
<div class="example">
<a name="id498599"></a><p class="title"><b>Example 14.35. registerCacheResource()</b></p>
...
<br class="example-break"><p>
  参见
  <a class="link" href="api.unregister.cacheresource.tpl" title="unregisterCacheResource()"><code class="varname">unregisterCacheResource()</code></a>
  和
  <a class="link" href="caching.custom.tpl" title="自定义缓存实现">自定义缓存</a>。
</p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="api.register.class.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">Smarty::muteExpectedErrors() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> registerClass()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.register.cacheresource.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02147 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
