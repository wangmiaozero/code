...
<html lang="en">
  <head>
    ...
    <title>registerClass() | Smarty</title>
    <meta name="description" content="registerClass()">
    <meta name="keywords" content="registerclass, ">
...
<tr><th colspan="3" align="center">registerClass()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.register.cacheresource.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.register.default.plugin.handler.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="registerClass()">
<a name="api.register.class"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>registerClass() — 注册类</p>
</div>
<div class="refsect1" title="说明">
<a name="id498549"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">registerClass</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">class_name</span></span>,<br>                   <span class="methodparam"><span class="type">string </span><span class="parameter">class_impl</span></span>);</code><p>
   在<a class="link" href="advanced.features.tpl#advanced.features.security" title="安全">安全</a>设置许可下，Smarty允许你使用<code class="varname">registerClass()</code>来注册静态类到模板中使用。
  </p>
<div class="example">
<a name="id498862"></a><p class="title"><b>Example 14.36. 注册类</b></p>
...
<a name="id498885"></a><p class="title"><b>Example 14.37. 注册带命名空间的类</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<br class="example-break"><p>
   参见
   <a class="link" href="api.register.object.tpl" title="registerObject()"><code class="varname">registerObject()</code></a>,
   和
   <a class="link" href="advanced.features.tpl#advanced.features.security" title="安全">安全</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="api.register.default.plugin.handler.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">registerCacheResource() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> registerDefaultPluginHandler()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 0 plus 14? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.register.class.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02953 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
