...
<html lang="en">
  <head>
    ...
    <title>registerDefaultPluginHandler() | Smarty</title>
    <meta name="description" content="registerDefaultPluginHandler()">
    <meta name="keywords" content="registerdefaultpluginhandler, ">
...
<a accesskey="p" href="api.register.class.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.register.filter.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<h2>Name</h2>
<p>registerDefaultPluginHandler() — 注册默认插件处理器</p>
</div>
<div class="refsect1" title="说明">
<a name="id498844"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">registerDefaultPluginHandler</span>(<span class="methodparam"><span class="type">mixed </span><span class="parameter">callback</span></span>);</code><p>
  注册一个默认的插件处理器，当编译程序无法找到模板中标签定义的时候，将调用这个处理器进行回调。
      参数：
      </p>
...
<p>
  当Smarty在编译过程中遇到未定义（没有注册的插件或者不在插件目录下）的标签时，Smarty将试图调用默认的插件处理器来处理。
  如果未定义标签是在循环中，则该处理器将有可能被多次调用。
  </p>
<div class="example">
<a name="id499150"></a><p class="title"><b>Example 14.38. 默认插件处理器例子</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="api.register.filter.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> registerFilter()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 2 plus 4? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.register.default.plugin.handler.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03096 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
