...
<html lang="en">
  <head>
    ...
    <title>registerFilter() | Smarty</title>
    <meta name="description" content="registerFilter()">
    <meta name="keywords" content="registerfilter, ">
...
<tr><th colspan="3" align="center">registerFilter()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.register.default.plugin.handler.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.register.plugin.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="registerFilter()">
<a name="api.register.filter"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>registerFilter() — 注册过滤器</p>
</div>
<div class="refsect1" title="说明">
<a name="id498998"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">registerFilter</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">type</span></span>,<br>                    <span class="methodparam"><span class="type">mixed </span><span class="parameter">callback</span></span>);</code><p>
   注册过滤器。
   参数如下：
   </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
<em class="parameter"><code>type</code></em> defines the type of the filter. Valid values are "pre", "post", "output" and "variable".
</p></li>
<li class="listitem">
<p>
...
<p>
   <a class="link" href="plugins.prefilters.postfilters.tpl" title="前置/后置过滤器">prefilter</a>前置过滤器，在模板编译之前执行的过滤器。
   详情参见<a class="link" href="advanced.features.prefilters.tpl" title="前置过滤器">前置过滤器</a>。
  </p>
<p>
   <a class="link" href="plugins.prefilters.postfilters.tpl" title="前置/后置过滤器">postfilter</a>后置过滤器，在模板编译成PHP后执行的过滤器。 
   详情参见<a class="link" href="advanced.features.postfilters.tpl" title="后置过滤器">后置过滤器</a>。
  </p>
<p>
   <a class="link" href="plugins.outputfilters.tpl" title="输出过滤器">outputfilter</a>输出过滤器，在模板将要<a class="link" href="api.display.tpl" title="display()">displayed</a>前执行的过滤器。
   详情参见<a class="link" href="advanced.features.outputfilters.tpl" title="输出过滤器">输出过滤器</a>。
  </p>
<p>
参见
<a class="link" href="api.unregister.filter.tpl" title="unregisterFilter()"><code class="varname">unregisterFilter()</code></a>,
<a class="link" href="api.load.filter.tpl" title="loadFilter()"><code class="varname">loadFilter()</code></a>,
<a class="link" href="variable.autoload.filters.tpl" title="$autoload_filters"><em class="parameter"><code>$autoload_filters</code></em></a>,
 <a class="link" href="advanced.features.prefilters.tpl" title="前置过滤器">前置过滤器</a>
 <a class="link" href="advanced.features.postfilters.tpl" title="后置过滤器">后置过滤器</a>
 <a class="link" href="advanced.features.outputfilters.tpl" title="输出过滤器">输出过滤器</a>。
</p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="api.register.plugin.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">registerDefaultPluginHandler() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> registerPlugin()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 6 plus 3? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="582966cdf525edf76979dbf8dc8100d5">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.register.filter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02601 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
