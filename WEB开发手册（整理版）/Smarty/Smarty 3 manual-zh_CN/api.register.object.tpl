...
<html lang="en">
  <head>
    ...
    <title>registerObject() | Smarty</title>
    <meta name="description" content="registerObject()">
...
<a accesskey="p" href="api.register.plugin.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.register.resource.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<h2>Name</h2>
<p>registerObject() — 注册对象</p>
</div>
<div class="refsect1" title="说明">
<a name="id500582"></a><h2>说明</h2>
...
<p>
   详情参见<a class="link" href="advanced.features.objects.tpl" title="对象">对象</a>。
  </p>
<p>
参见
   <a class="link" href="api.get.registered.object.tpl" title="getRegisteredObject()"><code class="varname">getRegisteredObject()</code></a>,
   和
...
<td width="40%" align="right"> <a accesskey="n" href="api.register.resource.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> registerResource()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 1 plus 4? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.register.object.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02413 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
