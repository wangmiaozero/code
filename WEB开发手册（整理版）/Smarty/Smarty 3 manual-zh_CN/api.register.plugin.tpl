...
<html lang="en">
  <head>
    ...
    <title>registerPlugin() | Smarty</title>
    <meta name="description" content="registerPlugin()">
    <meta name="keywords" content="registerplugin, ">
...
<tr><th colspan="3" align="center">registerPlugin()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.register.filter.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.register.object.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<a name="api.register.plugin"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>registerPlugin() — 注册插件</p>
</div>
<div class="refsect1" title="说明">
<a name="id499827"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">registerPlugin</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">type</span></span>,<br>                    <span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>,<br>                    <span class="methodparam"><span class="type">mixed </span><span class="parameter">callback</span></span>,<br>                    <span class="methodparam"><span class="type">bool </span><span class="parameter">cacheable</span></span>,<br>                    <span class="methodparam"><span class="type">mixed </span><span class="parameter">cache_attrs</span></span>);</code><p>
  该函数将以插件的形式来注册函数或者方法。
  参数如下：
   </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
<em class="parameter"><code>type</code></em> defines the type of the plugin. Valid values are "function", "block", "compiler" and "modifier".
</p></li>
<li class="listitem"><p>
<em class="parameter"><code>name</code></em> defines the name of the plugin.
</p></li>
<li class="listitem">
<p>
...
<li class="listitem"><p>
     大多数情况下<em class="parameter"><code>cacheable</code></em> 和 <em class="parameter"><code>cache_attrs</code></em>可被省略。
	 参见<a class="link" href="caching.cacheable.tpl" title="控制输出缓存">缓存能力</a>设置它们的值。
    </p></li>
</ul></div>
<p>
  </p>
<div class="example">
<a name="id500359"></a><p class="title"><b>Example 14.39. 注册函数</b></p>
...
<a name="id500389"></a><p class="title"><b>Example 14.40. 注册块函数</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<br class="example-break"><div class="example">
<a name="id500418"></a><p class="title"><b>Example 14.41. 注册修饰器</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<p>模板中可使用<code class="literal">ss</code>来过滤反斜线。</p>
<pre class="programlisting">
...
参见
<a class="link" href="api.unregister.plugin.tpl" title="unregisterPlugin"><code class="varname">unregisterPlugin()</code></a>,
<a class="link" href="plugins.functions.tpl" title="模板函数">插件函数</a>,
<a class="link" href="plugins.block.functions.tpl" title="块函数">块函数</a>,
<a class="link" href="plugins.compiler.functions.tpl" title="编译函数">编译函数</a>,
和
 <a class="link" href="plugins.modifiers.tpl" title="修饰器">修饰器</a>。
</p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="api.register.object.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> registerObject()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 8 plus 14? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="a900fdeaa38f34289a06c8e210ce0e8d">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.register.plugin.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02303 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
