...
<html lang="en">
  <head>
    ...
    <title>registerResource() | Smarty</title>
    <meta name="description" content="registerResource()">
    <meta name="keywords" content="registerresource, ">
...
<a accesskey="p" href="api.register.object.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.set.cache.dir.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<h2>Name</h2>
<p>registerResource() — 注册资源</p>
</div>
<div class="refsect1" title="说明">
<a name="id500827"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">registerResource</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>,<br>                      <span class="methodparam"><span class="type">Smarty_resource </span><span class="parameter">resource_handler</span></span>);</code><p>
  在Smarty中注册一个<a class="link" href="resources.tpl" title="Chapter 16. 资源">资源</a>。
   参数分别是资源的<em class="parameter"><code>name</code></em>和继承于 Smarty_Resource 的对象。
   详情参见<a class="link" href="resources.tpl" title="Chapter 16. 资源">资源</a>。
     </p>
<div class="note" title="技术说明" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">技术说明</h3>
<p>
   资源名称必须至少有两个字母以上的长度。
   单个字母作为资源名称会被当作文件路径的一部分，如<code class="literal">$smarty-&gt;display('c:/path/to/index.tpl');</code>
   </p>
</div>
<p>
   </p>
...
<p>
	Smarty 3.1之前，<code class="varname">registerResource()</code>可设置callback类型的资源。
	这是为了向前兼容，但强烈建议不要使用callback函数，这在Smarty 3.1已经废弃。
   </p>
</div>
<div class="example">
<a name="id501294"></a><p class="title"><b>Example 14.42. registerResource()</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="api.set.cache.dir.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> setCacheDir()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.register.resource.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02201 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
