...
<html lang="en">
  <head>
    ...
    <title>setCacheDir() | Smarty</title>
    <meta name="description" content="setCacheDir()">
    <meta name="keywords" content="setcachedir, ">
...
<tr><th colspan="3" align="center">setCacheDir()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.register.resource.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.set.compile.dir.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="setCacheDir()">
<a name="api.set.cache.dir"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>setCacheDir() — 设置缓存目录</p>
</div>
<div class="refsect1" title="说明">
<a name="id501089"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">Smarty </span><span class="methodname">setCacheDir</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">cache_dir</span></span>);</code><div class="example">
<a name="id501118"></a><p class="title"><b>Example 14.43. setCacheDir()</b></p>
...
<br class="example-break"><p>
   参见
   <a class="link" href="api.get.cache.dir.tpl" title="getCacheDir()"><code class="varname">getCacheDir()</code></a> 和
...
<td width="40%" align="right"> <a accesskey="n" href="api.set.compile.dir.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">registerResource() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> setCompileDir()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 20 plus 5? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.set.cache.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02121 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
