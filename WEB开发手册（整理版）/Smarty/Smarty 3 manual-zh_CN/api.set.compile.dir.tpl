...
<html lang="en">
  <head>
    ...
    <title>setCompileDir() | Smarty</title>
    <meta name="description" content="setCompileDir()">
    <meta name="keywords" content="setcompiledir, ">
...
<tr><th colspan="3" align="center">setCompileDir()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.set.cache.dir.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.set.config.dir.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="setCompileDir()">
<a name="api.set.compile.dir"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>setCompileDir() — 设置编译目录</p>
</div>
<div class="refsect1" title="说明">
<a name="id501544"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">Smarty </span><span class="methodname">setCompileDir</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">compile_dir</span></span>);</code><div class="example">
<a name="id501368"></a><p class="title"><b>Example 14.44. setCompileDir()</b></p>
...
<br class="example-break"><p>
   参见
   <a class="link" href="api.get.compile.dir.tpl" title="getCompileDir()"><code class="varname">getCompileDir()</code></a> 和   <a class="link" href="variable.compile.dir.tpl" title="$compile_dir"><em class="parameter"><code>$compile_dir</code></em></a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="api.set.config.dir.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">setCacheDir() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> setConfigDir()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 11 plus 13? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.set.compile.dir.tpl">
            </form>
            </div>
          </div>
