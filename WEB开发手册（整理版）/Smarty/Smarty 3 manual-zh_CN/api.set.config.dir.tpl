...
<html lang="en">
  <head>
    ...
    <title>setConfigDir() | Smarty</title>
    <meta name="description" content="setConfigDir()">
    <meta name="keywords" content="setconfigdir, ">
...
<tr><th colspan="3" align="center">setConfigDir()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.set.compile.dir.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.set.plugins.dir.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="setConfigDir()">
<a name="api.set.config.dir"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>setConfigDir() — 设置配置目录</p>
</div>
<div class="refsect1" title="说明">
<a name="id501458"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">Smarty </span><span class="methodname">setConfigDir</span>(<span class="methodparam"><span class="type">string|array </span><span class="parameter">config_dir</span></span>);</code><div class="example">
<a name="id501486"></a><p class="title"><b>Example 14.45. setConfigDir()</b></p>
...
<br class="example-break"><p>
   ...
   <a class="link" href="api.add.config.dir.tpl" title="addConfigDir()"><code class="varname">addConfigDir()</code></a> 和
...
<td width="40%" align="right"> <a accesskey="n" href="api.set.plugins.dir.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">setCompileDir() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> setPluginsDir()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 14 plus 10? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.set.config.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02607 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
