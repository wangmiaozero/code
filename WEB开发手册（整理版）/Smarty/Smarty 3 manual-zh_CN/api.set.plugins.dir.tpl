...
<html lang="en">
  <head>
    ...
    <title>setPluginsDir() | Smarty</title>
    <meta name="description" content="setPluginsDir()">
    <meta name="keywords" content="setpluginsdir, ">
...
<tr><th colspan="3" align="center">setPluginsDir()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.set.config.dir.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.set.template.dir.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<a name="api.set.plugins.dir"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>setPluginsDir() — 设置插件目录</p>
</div>
<div class="refsect1" title="说明">
<a name="id501694"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">Smarty </span><span class="methodname">setPluginsDir</span>(<span class="methodparam"><span class="type">string|array </span><span class="parameter">plugins_dir</span></span>);</code><div class="example">
<a name="id502140"></a><p class="title"><b>Example 14.46. setPluginsDir()</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="api.set.template.dir.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> setTemplateDir()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 11 plus 12? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.set.plugins.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02142 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
