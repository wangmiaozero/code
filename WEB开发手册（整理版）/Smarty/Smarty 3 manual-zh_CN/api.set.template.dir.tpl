...
<html lang="en">
  <head>
    ...
    <title>setTemplateDir() | Smarty</title>
    <meta name="description" content="setTemplateDir()">
    <meta name="keywords" content="settemplatedir, ">
...
<tr><th colspan="3" align="center">setTemplateDir()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.set.plugins.dir.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.template.exists.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="setTemplateDir()">
<a name="api.set.template.dir"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>setTemplateDir() — 设置模板目录</p>
</div>
<div class="refsect1" title="说明">
<a name="id501885"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">Smarty </span><span class="methodname">setTemplateDir</span>(<span class="methodparam"><span class="type">string|array </span><span class="parameter">template_dir</span></span>);</code><div class="example">
<a name="id502353"></a><p class="title"><b>Example 14.47. setTemplateDir()</b></p>
...
<br class="example-break"><p>
   ...
   <a class="link" href="api.add.template.dir.tpl" title="addTemplateDir()"><code class="varname">addTemplateDir()</code></a> 和
...
<td width="40%" align="right"> <a accesskey="n" href="api.template.exists.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">setPluginsDir() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> templateExists()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 19 plus 3? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.set.template.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02030 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
