...
<html lang="en">
  <head>
    ...
    <title>templateExists() | Smarty</title>
    <meta name="description" content="templateExists()">
    <meta name="keywords" content="templateexists, ">
...
<tr><th colspan="3" align="center">templateExists()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.set.template.dir.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.unregister.cacheresource.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="templateExists()">
<a name="api.template.exists"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>templateExists() — 检查模板是否存在</p>
</div>
<div class="refsect1" title="说明">
<a name="id502080"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">bool </span><span class="methodname">templateExists</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">template</span></span>);</code><p>
  检查的模板可以指定文件路径，或者一个模板资源。
  </p>
<div class="example">
<a name="id502571"></a><p class="title"><b>Example 14.48. templateExists()</b></p>
<div class="example-contents">
<p>
	下面例子使用<code class="literal">$_GET['page']</code>来<a class="link" href="language.function.include.tpl" title="{include}"><code class="varname">{include}</code></a>指定的模板。
	如果模板不存在，则会显示一个“page not found”的错误信息。
	首先是<code class="filename">page_container.tpl</code>的模板内容：
    </p>
...
<td width="40%" align="right"> <a accesskey="n" href="api.unregister.cacheresource.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">setTemplateDir() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> unregisterCacheResource()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 13 plus 14? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.template.exists.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02192 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
