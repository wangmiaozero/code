...
<html lang="en">
  <head>
    ...
    <title>testInstall() | Smarty</title>
    <meta name="description" content="testInstall()">
    <meta name="keywords" content="testinstall, ">
...
<tr><th colspan="3" align="center">testInstall()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.unregister.resource.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="caching.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="testInstall()">
<a name="api.test.install"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>testInstall() — 测试Smarty安装</p>
</div>
<div class="refsect1" title="说明">
<a name="id503646"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">testInstall</span>();</code><p>
  该函数测试Smarty需要的全部工作目录是否可以读写。
   该函数显示一个格式化的结果。
  </p>
<div class="example">
<a name="id503668"></a><p class="title"><b>Example 14.52. testInstall()</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="caching.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">unregisterResource() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 15. 缓存</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 9 plus 1? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.test.install.tpl">
            </form>
            </div>
          </div>
