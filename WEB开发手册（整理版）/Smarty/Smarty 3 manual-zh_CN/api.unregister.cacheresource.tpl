...
<html lang="en">
  <head>
    ...
    <title>unregisterCacheResource() | Smarty</title>
    <meta name="description" content="unregisterCacheResource()">
    <meta name="keywords" content="unregistercacheresource, ">
...
<tr><th colspan="3" align="center">unregisterCacheResource()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.template.exists.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.unregister.filter.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="unregisterCacheResource()">
<a name="api.unregister.cacheresource"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>unregisterCacheResource() — 注销缓存资源</p>
</div>
<div class="refsect1" title="说明">
<a name="id502560"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregisterCacheResource</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>);</code><p>
   参数<em class="parameter"><code>name</code></em>是缓存资源的名称。
  </p>
<div class="example">
<a name="id502880"></a><p class="title"><b>Example 14.49. unregisterCacheResource()</b></p>
...
参见
  <a class="link" href="api.register.cacheresource.tpl" title="registerCacheResource()">
  <code class="varname">registerCacheResource()</code></a>
  和
...
<td width="40%" align="right"> <a accesskey="n" href="api.unregister.filter.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">templateExists() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> unregisterFilter()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 5 plus 8? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="24e2f779262c4b55130af80214b26cf6">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.unregister.cacheresource.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02120 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
