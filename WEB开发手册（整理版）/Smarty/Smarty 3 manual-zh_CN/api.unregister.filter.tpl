...
<html lang="en">
  <head>
    ...
    <title>unregisterFilter() | Smarty</title>
    <meta name="description" content="unregisterFilter()">
    <meta name="keywords" content="unregisterfilter, ">
...
<tr><th colspan="3" align="center">unregisterFilter()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.unregister.cacheresource.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.unregister.plugin.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="unregisterFilter()">
<a name="api.unregister.filter"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>unregisterFilter() — 注销过滤器</p>
</div>
<div class="refsect1" title="Description">
<a name="id502690"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregisterFilter</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">type</span></span>,<br>                      <span class="methodparam"><span class="type">string|array </span><span class="parameter">callback</span></span>);</code><p>
   注销过滤器。
   参数如下：
   </p>
...
<td width="40%" align="right"> <a accesskey="n" href="api.unregister.plugin.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">unregisterCacheResource() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> unregisterPlugin</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 7 plus 2? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.unregister.filter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02153 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
