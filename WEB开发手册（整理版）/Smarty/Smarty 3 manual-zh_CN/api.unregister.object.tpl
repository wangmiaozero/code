...
<html lang="en">
  <head>
    ...
    <title>unregisterObject() | Smarty</title>
    <meta name="description" content="unregisterObject()">
...
<tr><th colspan="3" align="center">unregisterObject()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.unregister.plugin.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.unregister.resource.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="unregisterObject()">
<a name="api.unregister.object"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>unregisterObject() — 注销对象</p>
</div>
<div class="refsect1" title="说明">
<a name="id503401"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregisterObject</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">object_name</span></span>);</code><p>
参见
...
<td width="40%" align="right"> <a accesskey="n" href="api.unregister.resource.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">unregisterPlugin </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> unregisterResource()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 3 plus 19? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.unregister.object.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02262 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
