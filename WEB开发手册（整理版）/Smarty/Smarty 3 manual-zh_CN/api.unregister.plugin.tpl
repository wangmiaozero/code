...
<html lang="en">
  <head>
    ...
    <title>unregisterPlugin | Smarty</title>
    <meta name="description" content="unregisterPlugin">
    <meta name="keywords" content="unregisterplugin">
...
<tr><th colspan="3" align="center">unregisterPlugin</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.unregister.filter.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.unregister.object.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="unregisterPlugin">
<a name="api.unregister.plugin"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>unregisterPlugin — 注销插件</p>
</div>
<div class="refsect1" title="说明">
<a name="id502960"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregisterPlugin</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">type</span></span>,<br>                      <span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>);</code><p>
  该函数将注销通过<a class="link" href="api.register.plugin.tpl" title="registerPlugin()">registerPlugin()</a>注册的插件。
   参数如下：
   </p>
...
<div class="example">
<a name="id503488"></a><p class="title"><b>Example 14.50. 注销函数</b></p>
...
<br class="example-break"><p>
  参见<a class="link" href="api.register.plugin.tpl" title="registerPlugin()">
  <code class="varname">registerPlugin()</code></a>.
</p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="api.unregister.object.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">unregisterFilter() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> unregisterObject()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 16 plus 0? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.unregister.plugin.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02503 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
