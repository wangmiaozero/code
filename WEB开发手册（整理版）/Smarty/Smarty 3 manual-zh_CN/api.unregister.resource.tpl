...
<html lang="en">
  <head>
    ...
    <title>unregisterResource() | Smarty</title>
    <meta name="description" content="unregisterResource()">
    <meta name="keywords" content="unregisterresource, ">
...
<tr><th colspan="3" align="center">unregisterResource()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.unregister.object.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 14. Smarty成员方法</th>
<td width="20%" align="right"> <a accesskey="n" href="api.test.install.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="unregisterResource()">
<a name="api.unregister.resource"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>unregisterResource() — 注销资源</p>
</div>
<div class="refsect1" title="说明">
<a name="id503710"></a><h2>说明</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregisterResource</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>);</code><p>
  传递资源的名称<em class="parameter"><code>name</code></em>。
  </p>
<div class="example">
<a name="id503543"></a><p class="title"><b>Example 14.51. unregisterResource()</b></p>
...
参见
 <a class="link" href="api.register.resource.tpl" title="registerResource()">
 <code class="varname">registerResource()</code></a>
 和
 <a class="link" href="resources.tpl" title="Chapter 16. 资源">资源</a>
</p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="api.test.install.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">unregisterObject() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> testInstall()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 3 plus 0? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="68408d8dfcf2a21288ef27e8f532d730">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.unregister.resource.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02286 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
