...
<html lang="en">
  <head>
    ...
    <title>Chapter 13. Smarty成员变量 | Smarty</title>
    <meta name="description" content="Chapter 13. Smarty成员变量">
    <meta name="keywords" content="chapter, 13, smarty, ">
...
<tr><th colspan="3" align="center">Chapter 13. Smarty成员变量</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="smarty.constants.tpl">Prev</a> </td>
<th width="60%" align="center">Part III. 程序开发者篇</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.auto.literal.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="chapter" title="Chapter 13. Smarty成员变量">
<div class="titlepage"><div><div><h2 class="title">
<a name="api.variables"></a>Chapter 13. Smarty成员变量</h2></div></div></div>
<div class="toc">
...
<p>
   这里都是Smarty可用的成员变量。
   你可以直接存取它们，或者使用相应的setter/getter方法。
   </p>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
<p>
全部成员变量都有setter/getter的魔术方法。
和变量格式不一样的是，setter/getter方法都是用驼峰命名法。
例如，你可以使用$smarty-&gt;setTemplateDir($dir) 和 $dir = $smarty-&gt;getTemplateDir()
 来存和取$smarty-&gt;template_dir变量。
</p>
</div>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
...
<div class="sect1" title="$allow_php_templates">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.allow.php.templates"></a>$allow_php_templates</h2></div></div></div>
<p>
	  默认PHP模板文件是不允许使用的。设置<code class="varname">$allow_php_templates</code>为true，则允许使用PHP模板文件。
      </p>
<p>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.auto.literal.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">Chapter 12. 常量 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $auto_literal</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 2 plus 9? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/api.variables.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02322 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
