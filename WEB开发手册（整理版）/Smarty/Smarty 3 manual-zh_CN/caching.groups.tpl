...
<html lang="en">
  <head>
    ...
    <title>缓存组 | Smarty</title>
    <meta name="description" content="缓存组">
...
<tr><th colspan="3" align="center">缓存组</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="caching.multiple.caches.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 15. 缓存</th>
<td width="20%" align="right"> <a accesskey="n" href="caching.cacheable.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="缓存组">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="caching.groups"></a>缓存组</h2></div></div></div>
<p>
	 你可以通过设置<em class="parameter"><code>$cache_id</code></em>更精细地组织你的缓存。
	 在<em class="parameter"><code>$cache_id</code></em>值中使用竖线<code class="literal">|</code>来设置缓存组，
	 同时你可以根据需要设置多个缓存组。
     </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
	 你可以把缓存组理解成目录层次结构。
	 比如缓存组<code class="literal">'a|b|c'</code>可以理解成目录结构<code class="literal">'/a/b/c/'</code>。
      </p></li>
<li class="listitem"><p>
      <code class="literal">clearCache(null,'a|b|c')</code>相等于删除文件 <code class="literal">'/a/b/c/*'</code>。
      <code class="literal">clearCache(null,'a|b')</code>相等于删除文件 <code class="literal">'/a/b/*'</code>。
      </p></li>
<li class="listitem"><p>
	  如果你按照<code class="literal">clearCache(null,'a|b','foo')</code>的方式来设置
	  <a class="link" href="variable.compile.id.tpl" title="$compile_id"><em class="parameter"><code>$compile_id</code></em></a>，
	  那么它将自动附带一个<a class="link" href="variable.compile.id.tpl" title="$compile_id"><em class="parameter"><code>$compile_id</code></em></a>
	  的缓存组。
      </p></li>
<li class="listitem"><p>
	  如果你按照<code class="literal">clearCache('foo.tpl','a|b|c')</code>的方式来设置模板名称，
	  然后Smarty将试图删除<code class="literal">'/a/b/c/foo.tpl'</code>。
      </p></li>
<li class="listitem"><p>
	  因为缓存组是“从左到右”顺序删除缓存的，所以你不能单独删除某个缓存如<code class="literal">'/a/b/*/foo.tpl'</code>。
	  你可以另外再设置一个缓存组来达到此目的。
     </p></li>
</ul></div>
<p>
	 不能混淆缓存组和模板目录结构，缓存组与你的模板层次结构是无关的。
      比如说，你有一个模板文件<code class="filename">themes/blue/index.tpl</code>，
	  然后你想删除全部带<span class="quote">“<span class="quote">blue</span>”</span>的主题（theme），
	  这样你可以参考模板目录结构来创建一个缓存组，如
	   <code class="literal">display('themes/blue/index.tpl','themes|blue')</code>，
	   之后你可以通过<code class="literal">clearCache(null,'themes|blue')</code>来删除它们。
     </p>
<div class="example">
<a name="id513683"></a><p class="title"><b>Example 15.9. $cache_id 组</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="caching.cacheable.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">单页多个缓存 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 控制输出缓存</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 16 plus 14? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="d119f7b38675b4e921aa7339264fa41f">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/caching.groups.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02979 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
