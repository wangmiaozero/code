...
<html lang="en">
  <head>
    ...
    <title>单页多个缓存 | Smarty</title>
    <meta name="description" content="单页多个缓存">
...
<tr><th colspan="3" align="center">单页多个缓存</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="caching.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 15. 缓存</th>
<td width="20%" align="right"> <a accesskey="n" href="caching.groups.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="单页多个缓存">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="caching.multiple.caches"></a>单页多个缓存</h2></div></div></div>
<p>
	在调用<a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code></a>或者
	<a class="link" href="api.fetch.tpl" title="fetch()"><code class="varname">fetch()</code></a>的时候，
	你可以设置单个页面有多个缓存。
	当我们希望执行<code class="literal">display('index.tpl')</code>的时候，
	可以根据不同的情况来生成不同的缓存，并且可以单独区分，
	那么就需要设置<em class="parameter"><code>$cache_id</code></em>为第二个参数来实现了。
    </p>
<div class="example">
<a name="id513080"></a><p class="title"><b>Example 15.6. display()的参数作为$cache_id</b></p>
...
<br class="example-break"><p>
	上面，我们将<code class="literal">$my_cache_id</code>值作为<em class="parameter"><code>$cache_id</code></em>参数传递给
	<a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code></a>。
     每个单独的<code class="literal">$my_cache_id</code>值，对应将会有单独的
	 <code class="filename">index.tpl</code>模板的缓存文件生成。
	在这个例子里面，<em class="parameter"><code>$cache_id</code></em>是我们从URL中获得的<code class="literal">article_id</code>。
    </p>
...
<p>
	 ...
	 虽然上面例子通过URL传递article_id显得比较方便，但可能会引起问题。
      <em class="parameter"><code>$cache_id</code></em>值会用来建立文件目录的，
...
<p>
	确保用同一个<em class="parameter"><code>$cache_id</code></em>作为
     <a class="link" href="api.is.cached.tpl" title="isCached()"><code class="varname">isCached()</code></a> 和
     <a class="link" href="api.clear.cache.tpl" title="clearCache()"><code class="varname">clearCache()</code></a>的第二个参数。
    </p>
<div class="example">
<a name="id513200"></a><p class="title"><b>Example 15.7. 给 isCached() 传递一个 cache_id </b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
	要删除特定<em class="parameter"><code>$cache_id</code></em>的全部缓存，
	同时需要给<a class="link" href="api.clear.cache.tpl" title="clearCache()"><code class="varname">clearCache()</code></a>
	传递null作为第一个参数。
    </p>
<div class="example">
<a name="id513239"></a><p class="title"><b>Example 15.8. 删除特定$cache_id的缓存</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
	按这种方式，你可以通过设置同一个<em class="parameter"><code>$cache_id</code></em>来把你的缓存<span class="quote">“<span class="quote">组织</span>”</span>起来。
    </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="caching.groups.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">Chapter 15. 缓存 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 缓存组</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 12 plus 8? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="455dbcce275f7bafd86b09f5f359de84">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/caching.multiple.caches.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02971 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
