...
<html lang="en">
  <head>
    ...
    <title>Chapter 11. 字符集编码 | Smarty</title>
    <meta name="description" content="Chapter 11. 字符集编码">
    <meta name="keywords" content="chapter, 11, ">
...
<tr><th colspan="3" align="center">Chapter 11. 字符集编码</th></tr>
<tr>
...
<div class="chapter" title="Chapter 11. 字符集编码">
<div class="titlepage"><div><div><h2 class="title">
<a name="charset"></a>Chapter 11. 字符集编码</h2></div></div></div>
<div class="toc">
<p><b>Table of Contents</b></p>
<dl><dt><span class="sect1"><a href="charset.tpl#charset.encoding">字符集编码</a></span></dt></dl>
</div>
<div class="sect1" title="字符集编码">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="charset.encoding"></a>字符集编码</h2></div></div></div>
<p>
 有许多种文本数据的编码方式，ISO-8859-1 (Latin1) 和 UTF-8 是最常见的。
  除非明确声明<code class="varname">SMARTY_RESOURCE_CHAR_SET</code>使用的字符集，默认
  Smarty当遇到<a class="ulink" href="../../../www.php.net/mbstring/index.htm" target="_top">多字节字符</a>情况
  会使用<code class="literal">UTF-8</code>作为内置的字符集，
  而当没有多字节字符情况下使用<code class="literal">ISO-8859-1</code>。
 </p>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
<p>
  <code class="literal">ISO-8859-1</code>从开始就是PHP内置的默认字符集。
  Unicode从1991年开始演变而来，而且逐渐替代了其他的字符集，因为其能对大多数已知的字符进行编码，
  而且做到了跨各种不同字符集的系统(latin, cyrillic, japanese, …)。
  <code class="literal">UTF-8</code>是unicode中使用的最多的编码，它可以用最小的尺寸提供成千上万的字符。
 </p>
<p>现在unicode和UTF-8已经非常流行了，所以强烈建议使用它们。</p>
</div>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
<p>
 从Smarty3.1开始，Smarty核心类和插件都被设计成兼容UTF-8的。
 要做到良好的兼容性，最好开启<a class="ulink" href="../../../www.php.net/mbstring/index.htm" target="_top">多字节字符</a>的PECL库。
 除非PHP环境可以提供这个库，Smarty将不一定能完整兼容UTF-8。
 </p>
</div>
<div class="example">
<a name="id476564"></a><p class="title"><b>Example 11.1. 设置字符集编码</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Part III. 程序开发者篇 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 12. 常量</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 9 plus 14? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/charset.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02186 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
