...
<html lang="en">
  <head>
    ...
    <title>进阶安装 | Smarty</title>
    <meta name="description" content="进阶安装">
...
<tr><th colspan="3" align="center">进阶安装</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="installing.smarty.basic.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 2. 安装</th>
<td width="20%" align="right"> <a accesskey="n" href="smarty.for.designers.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="进阶安装">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="installing.smarty.extended"></a>进阶安装</h2></div></div></div>
<p>
   这是<a class="link" href="installing.smarty.basic.tpl" title="基础安装">基础安装</a>的进阶，请先阅读基础安装文章。
   </p>
<p>
   稍微更灵活的方式是使用<a class="ulink" href="../www.php.net/ref.classobj" target="_top">扩展类</a>来安装Smarty和初始化。
   代替反复地定义路径，赋同样的值等等，我们可以把这些操作放在一个地方进行。
    </p>
<p>
	我们新建一个目录<code class="filename">/php/includes/guestbook/</code>，并新建一个
	<code class="filename">setup.php</code>文件。
	在下面的例子中，我们假设<code class="filename">/php/includes</code>
	目录已经在<code class="literal">include_path</code>中。
	确定你已经进行这个配置，或者使用绝对路径。
   </p>
<div class="example">
<a name="id404679"></a><p class="title"><b>Example 2.10. /php/includes/guestbook/setup.php</b></p>
...
<br class="example-break"><p>
  在<code class="filename">index.php</code>文件中使用<code class="filename">setup.php</code>:
  </p>
<div class="example">
<a name="id404721"></a><p class="title"><b>Example 2.11. /web/www.example.com/guestbook/htdocs/index.php</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
  现在你可以看到这是非常简单就可以实例化一个Smarty的对象，
  仅调用<code class="literal">Smarty_GuestBook()</code>就可以自动初始化程序。
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="smarty.for.designers.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">基础安装 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Part II. 模板设计师篇</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 8 plus 17? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/installing.smarty.extended.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01397 secs with <a href="../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
