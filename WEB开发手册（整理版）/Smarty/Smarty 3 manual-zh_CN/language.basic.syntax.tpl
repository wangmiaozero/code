...
<html lang="en">
  <head>
    ...
    <title>Chapter 3. 基本语法 | Smarty</title>
    <meta name="description" content="Chapter 3. 基本语法">
...
<tr><th colspan="3" align="center">Chapter 3. 基本语法</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="smarty.for.designers.tpl">Prev</a> </td>
<th width="60%" align="center">Part II. 模板设计师篇</th>
<td width="20%" align="right"> <a accesskey="n" href="language.syntax.variables.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="chapter" title="Chapter 3. 基本语法">
<div class="titlepage"><div><div><h2 class="title">
<a name="language.basic.syntax"></a>Chapter 3. 基本语法</h2></div></div></div>
<div class="toc">
...
<p>
 Smarty的标签都是使用定界符括起来。
 默认定界符是<code class="literal">{</code> 和
  <code class="literal">}</code>, 但定界符可以被<a class="link" href="variable.left.delimiter.tpl" title="$left_delimiter">改变</a>。
 </p>
<p>
 比如说在本手册，我们会假定你在使用默认的定界符。
  在Smarty看来，任何在定界符之外的内容，都是静态的，或者是不改变的内容。 
  当Smarty读取到这些标签时，将会试图解析它们，并且在对应的位置输出结果。
 </p>
<div class="sect1" title="注释">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.syntax.comments"></a>注释</h2></div></div></div>
<p>
 模板中的注释是星号开头，然后外面包含着
...
<p>
  Smarty的注释在不会在最终的页面输出里显示，
  像<code class="literal">&lt;!-- HTML comments --&gt;</code>一样。
  这是内部进行一些标记而不被人看到的好方法;-)
 </p>
<div class="example">
<a name="id406276"></a><p class="title"><b>Example 3.1. 注释例子</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="language.syntax.variables.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">Part II. 模板设计师篇 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 变量</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 10 plus 6? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.basic.syntax.tpl">
            </form>
            </div>
          </div>
