...
<html lang="en">
  <head>
    ...
    <title>Chapter 6. 复合修饰器 | Smarty</title>
    <meta name="description" content="Chapter 6. 复合修饰器">
    <meta name="keywords" content="chapter, 6, ">
...
<tr><th colspan="3" align="center">Chapter 6. 复合修饰器</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.modifier.wordwrap.tpl">Prev</a> </td>
<th width="60%" align="center">Part II. 模板设计师篇</th>
<td width="20%" align="right"> <a accesskey="n" href="language.builtin.functions.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="chapter" title="Chapter 6. 复合修饰器">
<div class="titlepage"><div><div><h2 class="title">
<a name="language.combining.modifiers"></a>Chapter 6. 复合修饰器</h2></div></div></div>
<p>
 你可以联合使用多个修饰器。
 它们会按复合的顺序来作用于变量，从左到右。
 它们必须以<code class="literal">|</code> (竖线)进行分隔。
 </p>
<div class="example">
<a name="id425471"></a><p class="title"><b>Example 6.1. 复合修饰器</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="language.builtin.functions.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">wordwrap </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 7. 内置函数</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 9 plus 12? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.combining.modifiers.tpl">
            </form>
            </div>
          </div>
