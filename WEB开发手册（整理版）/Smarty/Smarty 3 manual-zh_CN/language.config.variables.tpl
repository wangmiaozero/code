...
<html lang="en">
  <head>
    ...
    <title>从配置文件获取的变量 | Smarty</title>
    <meta name="description" content="从配置文件获取的变量">
...
<tr><th colspan="3" align="center">从配置文件获取的变量</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.variable.scopes.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 4. 变量</th>
<td width="20%" align="right"> <a accesskey="n" href="language.variables.smarty.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="从配置文件获取的变量">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.config.variables"></a>从配置文件获取的变量</h2></div></div></div>
<p>
  从<a class="link" href="config.files.tpl" title="Chapter 9. 配置文件">配置文件</a>获取的变量，可以通过
  井号引用起来访问如<code class="literal">#hash_marks#</code>，
  或者通过Smarty变量
  <a class="link" href="language.variables.smarty.tpl#language.variables.smarty.config" title="{$smarty.config}">
 <em class="parameter"><code>$smarty.config</code></em></a>来访问。
 后者在使用其他属性或者是访问别的变量值时比较有用，如$smarty.config.$foo。
  </p>
<div class="example">
<a name="id409550"></a><p class="title"><b>Example 4.7. 配置变量</b></p>
<div class="example-contents">
<p>
     配置文件<code class="filename">foo.conf</code>例子:
    </p>
...
<p>
	示范使用<em class="parameter"><code>#hash#</code></em>方式的模板:
    </p>
<pre class="programlisting">
...
<p>
     示范使用<a class="link" href="language.variables.smarty.tpl#language.variables.smarty.config" title="{$smarty.config}">
     <em class="parameter"><code>$smarty.config</code></em></a>方式的模板：
    </p>
<pre class="programlisting">
...
<br class="example-break"><p>
  配置变量必须先载入配置文件才能使用。
  这个过程会本文档的<a class="link" href="language.function.config.load.tpl" title="{config_load}">
  <code class="varname">{config_load}</code></a>说明里面解释。
</p>
<p>
  参见 <a class="link" href="language.syntax.variables.tpl" title="变量">变量</a> 和
  <a class="link" href="language.variables.smarty.tpl" title="{$smarty} 保留变量">$smarty保留变量</a>
</p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="language.variables.smarty.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">变量作用范围 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> {$smarty} 保留变量</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 13 plus 3? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.config.variables.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02171 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
