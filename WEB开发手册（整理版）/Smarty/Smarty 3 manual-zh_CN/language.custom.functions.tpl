...
<html lang="en">
  <head>
    ...
    <title>Chapter 8. 自定义函数 | Smarty</title>
    <meta name="description" content="Chapter 8. 自定义函数">
    <meta name="keywords" content="chapter, 8, ">
...
<tr><th colspan="3" align="center">Chapter 8. 自定义函数</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.function.while.tpl">Prev</a> </td>
<th width="60%" align="center">Part II. 模板设计师篇</th>
<td width="20%" align="right"> <a accesskey="n" href="language.function.cycle.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="chapter" title="Chapter 8. 自定义函数">
<div class="titlepage"><div><div><h2 class="title">
<a name="language.custom.functions"></a>Chapter 8. 自定义函数</h2></div></div></div>
<div class="toc">
...
<p>
   <code class="varname">{counter}</code>用于显示一个计数器。
   <code class="varname">{counter}</code>可以记住foreach循环的次数。
   你可以设置计数器的数值、步长、计算方向，和是否每次显示数值。
   你可以同时使用多个不同名的计数器。
   如果没有指定计数器名称，那么<span class="quote">“<span class="quote">default</span>”</span>将是默认的名称。
  </p>
<p>
  如果你指定了<em class="parameter"><code>assign</code></em>属性，那么<code class="varname">{counter}</code>
  的输出将被赋值给模板变量。
 </p>
...
<div class="example">
<a name="id455474"></a><p class="title"><b>Example 8.1. {counter}</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="language.function.cycle.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> {cycle}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 16 plus 7? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.custom.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02246 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
