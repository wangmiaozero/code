...
<html lang="en">
  <head>
    ...
    <title>避免Smarty解析 | Smarty</title>
    <meta name="description" content="避免Smarty解析">
...
<tr><th colspan="3" align="center">避免Smarty解析</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.math.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 3. 基本语法</th>
<td width="20%" align="right"> <a accesskey="n" href="language.variables.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="避免Smarty解析">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.escaping"></a>避免Smarty解析</h2></div></div></div>
<p>
 有时候部分模板中的代码是不需要或者不希望被Smarty解析的，
比较典型的例子是嵌入在页面HTML中的Javascript或CSS代码。 
问题通常发生在这些语言会经常使用{ 和 }，但{ 和 }也恰好是Smarty的
<a class="link" href="language.function.ldelim.tpl" title="{ldelim},{rdelim}">定界符</a>。
 </p>
...
<p>
  ...
  此特性可以通过设置Smarty的成员变量
  <a class="link" href="variable.auto.literal.tpl" title="$auto_literal"><em class="parameter"><code>$auto_literal</code></em></a>为false来关闭。
 </p>
<div class="example">
<a name="id407600"></a><p class="title"><b>Example 3.8. 使用自动忽略解析的特性</b></p>
...
<br class="example-break"><p>
  <a class="link" href="language.function.literal.tpl" title="{literal}">
  <code class="varname">{literal}..{/literal}</code></a>可以让块中间的内容忽略Smarty的解析。
  在需要使用定界符的时候，可以通过
  <a class="link" href="language.function.ldelim.tpl" title="{ldelim},{rdelim}"><code class="varname">{ldelim}</code></a>，<a class="link" href="language.function.ldelim.tpl" title="{ldelim},{rdelim}"><code class="varname">{rdelim}</code></a>标签，或者<a class="link" href="language.variables.smarty.tpl#language.variables.smarty.ldelim" title="{$smarty.ldelim}, {$smarty.rdelim}">
  <code class="varname">{$smarty.ldelim}</code>,<code class="varname">{$smarty.rdelim}</code></a>的变量来使用。
 </p>
<p>
 Smarty的默认定界符{ 和 }可以整齐地界定一般内容的显示。
 然而你可以通过修改Smarty的<a class="link" href="variable.left.delimiter.tpl" title="$left_delimiter">
  <em class="parameter"><code>$left_delimiter</code></em></a> 和
  <a class="link" href="variable.right.delimiter.tpl" title="$right_delimiter">
  <em class="parameter"><code>$right_delimiter</code></em></a> 的变量值，设置更适合的定界符。
  </p>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
<p>
...
<div class="example">
<a name="id407685"></a><p class="title"><b>Example 3.9. 改变定界符的例子</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="language.variables.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">数学计算 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 4. 变量</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 20 plus 10? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.escaping.tpl">
            </form>
            </div>
          </div>
