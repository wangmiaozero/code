...
<html lang="en">
  <head>
    ...
    <meta name="keywords" content=", ldelim, append, rdelim, ">
...
<td width="20%" align="right"> <a accesskey="n" href="language.function.assign.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="{append}">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.function.append"></a>{append}</h2></div></div></div>
<p>
   <code class="varname">{append}</code>可以在
   <span class="bold"><strong>运行时</strong></span>
   为数组变量增加或者创建值。
 </p>
...
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>
	 数组元素的新索引，如果没有提供此参数，则附加的值会加到数组最后。</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>赋值变量的访问范围: 'parent','root' 或 'global'</td>
</tr>
</tbody>
</table></div>
...
<div class="example">
<a name="id427201"></a><p class="title"><b>Example 7.7. {append}</b></p>
...
参见<a class="link" href="api.append.tpl" title="append()"><code class="varname">append()</code></a>
   和
...
<td width="40%" align="right"> <a accesskey="n" href="language.function.assign.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">Chapter 7. 内置函数 </td>
...
<td width="40%" align="right" valign="top"> {assign}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 1 plus 5? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="f5129db97cd7cad224538fc246c87029">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.append.tpl">
            </form>
            </div>
          </div>
