...
<html lang="en">
  <head>
    ...
    <title>{call} | Smarty</title>
    <meta name="description" content="{call}">
    <meta name="keywords" content=", ldelim, call, rdelim, ">
...
<tr><th colspan="3" align="center">{call}</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.function.block.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 7. 内置函数</th>
<td width="20%" align="right"> <a accesskey="n" href="language.function.capture.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<a name="language.function.call"></a>{call}</h2></div></div></div>
<p>
  <code class="varname">{call}</code>可以调用一个通过
 <a class="link" href="language.function.function.tpl" title="{function}"><code class="varname">{function}</code></a>
标签来定义的模板函数，如同调用插件函数一样。 
  </p>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
<p>
  模板函数是全局定义的。因为Smarty编译器是一个单次的编译器，所以
  <a class="link" href="language.function.call.tpl" title="{call}"><code class="varname">{call}</code></a>
  标签调用的函数，务必定义在当前模板之外的位置。
  或者你可以直接通过<code class="literal">{funcname ...}</code>的方式来使用该函数。
  </p>
</div>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
  <code class="varname">{call}</code>必须设置<em class="parameter"><code>name</code></em>属性，
  标识要调用的模板函数的名称。
  </p></li>
<li class="listitem"><p>
 可以按照<a class="link" href="language.syntax.attributes.tpl" title="属性">属性</a>的方式来给函数传递参数。
 </p></li>
</ul></div>
...
<p><span class="bold"><strong>可选的标记:</strong></span></p>
<div class="informaltable"><table border="1">
<colgroup>
<col align="center">
<col>
...
<div class="example">
<a name="id430057"></a><p class="title"><b>Example 7.20. 调用一个递归菜单的例子</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="language.function.capture.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> {capture}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 15 plus 8? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.call.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01271 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
