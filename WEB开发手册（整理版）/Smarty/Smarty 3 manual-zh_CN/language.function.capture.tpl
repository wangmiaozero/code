...
<html lang="en">
  <head>
    ...
    <title>{capture} | Smarty</title>
    <meta name="description" content="{capture}">
    <meta name="keywords" content=", ldelim, capture, rdelim, ">
...
<tr><th colspan="3" align="center">{capture}</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.function.call.tpl">Prev</a> </td>
...
<p>
   <code class="varname">{capture}</code>可以捕获标记范围内的输出内容，存到变量中而不显示。
   任何在<code class="varname">{capture name='foo'}</code> 和 <code class="varname">{/capture}</code>
   之间的内容都会被捕获到变量，变量名可以通过<em class="parameter"><code>name</code></em>属性来指定。
   </p>
<p>捕获的内容可以通过<a class="link" href="language.variables.smarty.tpl#language.variables.smarty.capture" title="{$smarty.capture}"><em class="parameter"><code>$smarty.capture.foo</code></em></a>变量来使用，这里foo是设置的<em class="parameter"><code>name</code></em>属性。
	如果没有提供<em class="parameter"><code>name</code></em>属性，默认是<span class="quote">“<span class="quote">default</span>”</span>，也就是
	<em class="parameter"><code>$smarty.capture.default</code></em>.
   </p>
<p><code class="varname">{capture}</code>可以被嵌套使用。
   </p>
...
<div class="note" title="警告" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">警告</h3>
<p>
  当捕获<a class="link" href="language.function.insert.tpl" title="{insert}"><code class="varname">{insert}</code></a>输出的时候请小心。
   如果开启了<a class="link" href="caching.tpl" title="Chapter 15. 缓存"><em class="parameter"><code>$caching</code></em></a>并且
   你希望通过<a class="link" href="language.function.insert.tpl" title="{insert}"><code class="varname">{insert}</code></a>
...
<div class="example">
<a name="id430758"></a><p class="title"><b>Example 7.21. {capture}使用name属性</b></p>
...
<div class="example">
<a name="id430771"></a><p class="title"><b>Example 7.22. {capture} 捕获内容到变量</b></p>
...
<div class="example">
<a name="id430791"></a><p class="title"><b>Example 7.23. {capture} 捕获内容到数组变量</b></p>
<div class="example-contents">
<p>
...
<p>
  ...
  和 <a class="link" href="language.function.assign.tpl" title="{assign}"><code class="varname">{assign}</code></a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> {config_load}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 6 plus 7? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.capture.tpl">
            </form>
            </div>
          </div>
