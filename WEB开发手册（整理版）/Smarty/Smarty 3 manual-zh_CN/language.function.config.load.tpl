...
<html lang="en">
  <head>
    ...
    <meta name="description" content="{config_load}">
    <meta name="keywords" content=", ldelim, config_load, rdelim, ">
...
<a accesskey="p" href="language.function.capture.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 7. 内置函数</th>
<td width="20%" align="right"> <a accesskey="n" href="language.function.debug.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
   <code class="varname">{config_load}</code>用于从<a class="link" href="config.files.tpl" title="Chapter 9. 配置文件">配置文件</a>中
   加载配置变量<a class="link" href="language.config.variables.tpl" title="从配置文件获取的变量"><em class="parameter"><code>#variables#</code></em></a>。
 </p>
...
<td>
	 配置变量的作用范围，取值local, parent 或 global.
...
<div class="example">
<a name="id431500"></a><p class="title"><b>Example 7.24. {config_load}</b></p>
<div class="example-contents">
<p>
   <code class="filename">example.conf</code> 配置文件.
  </p>
...
<br class="example-break"><p>
  <a class="link" href="config.files.tpl" title="Chapter 9. 配置文件">配置文件</a>
  可能会有一些段落。你可以用<em class="parameter"><code>section</code></em>属性单独载入某个指定段落的配置变量。
  注意全局的配置变量会同时被载入，同名的段落配置变量会覆盖全局的配置变量。
 </p>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
<p>
  配置文件的<span class="emphasis"><em>sections</em></span>和内置函数<a class="link" href="language.function.section.tpl" title="{section},{sectionelse}"><code class="varname">{section}</code></a>是不相关的，它们只是刚好名称比较像。
  </p>
</div>
<div class="example">
<a name="id431577"></a><p class="title"><b>Example 7.25.  {config_load} 载入段落配置变量</b></p>
...
<br class="example-break"><p>
参见<a class="link" href="variable.config.overwrite.tpl" title="$config_overwrite"><em class="parameter"><code>$config_overwrite</code></em></a>。
</p>
<p>
  参见<a class="link" href="config.files.tpl" title="Chapter 9. 配置文件">配置文件</a>,
...
<td width="40%" align="right"> <a accesskey="n" href="language.function.debug.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> {debug}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 0 plus 19? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.config.load.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02432 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
