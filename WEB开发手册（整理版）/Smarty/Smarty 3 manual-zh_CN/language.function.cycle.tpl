...
<p>
   <code class="varname">{cycle}</code>用于交替循环一系列值。
...
<td>
	 交替遍历的值，可以是用逗号分隔的字符串列表（注意限定符号），也可以是数组。</td>
</tr>
<tr>
...
<td>交替循环将重置回到最前面的值，而不会递进。</td>
</tr>
</tbody>
</table></div>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
 你可以在模板内使用多个不同<em class="parameter"><code>name</code></em>属性的<code class="varname">{cycle}</code>。
 </p></li>
<li class="listitem"><p>
 设置<em class="parameter"><code>print</code></em>为<code class="constant">FALSE</code>可以让当前值不显示。
 在你希望可以静默地跳过一些值的时候很有用。
 </p></li>
<li class="listitem"><p>
 <em class="parameter"><code>advance</code></em>属性用来重复一个值。当设置成<code class="constant">FALSE</code>
 下次执行<code class="varname">{cycle}</code>将输出同一个值。
 </p></li>
<li class="listitem"><p>
 如果你设置了<em class="parameter"><code>assign</code></em>属性，那么<code class="varname">{cycle}</code>的输出将会被赋值给变量。
 </p></li>
</ul></div>
<div class="example">
<a name="id456105"></a><p class="title"><b>Example 8.2. {cycle}</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 8. 自定义函数 </td>
...
<td width="40%" align="right" valign="top"> {eval}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.cycle.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02269 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
