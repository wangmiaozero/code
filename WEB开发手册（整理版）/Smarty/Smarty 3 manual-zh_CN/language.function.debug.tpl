...
<html lang="en">
  <head>
    ...
    <title>{debug} | Smarty</title>
    <meta name="description" content="{debug}">
    <meta name="keywords" content=", ldelim, debug, rdelim, ">
...
<tr><th colspan="3" align="center">{debug}</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.function.config.load.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 7. 内置函数</th>
<td width="20%" align="right"> <a accesskey="n" href="language.function.extends.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="{debug}">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.function.debug"></a>{debug}</h2></div></div></div>
<p>
  <code class="varname">{debug}</code>会在页面上显示调试控制台。
  它将忽略PHP代码中的<a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. 调试控制台">debug</a>配置。
  在它执行的过程中，仅可以显示<a class="link" href="api.assign.tpl" title="assign()">赋值</a>变量。
  然而，你可以看到模板范围内全部可用的变量。
 </p>
<p>
 如果开启了缓存，而<code class="varname">{debug}</code>在缓存的页面中执行，那么它仅会显示从缓存
 文件中赋值到模板的变量。
 </p>
<p>
 希望能看到整个模板的本地赋值变量，可以将<code class="varname">{debug}</code>放在模板的最后。
 </p>
<p>
 参见
...
<td width="40%" align="right"> <a accesskey="n" href="language.function.extends.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">{config_load} </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> {extends}</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 20 plus 1? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.debug.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02227 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
