...
<html lang="en">
  <head>
    ...
    <title>{eval} | Smarty</title>
    <meta name="description" content="{eval}">
    <meta name="keywords" content=", ldelim, eval, rdelim, ">
...
<a accesskey="p" href="language.function.cycle.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 8. 自定义函数</th>
<td width="20%" align="right"> <a accesskey="n" href="language.function.fetch.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
   <code class="varname">{eval}</code>可以执行变量显示。它可用于执行模板变量中的标签/变量，
   或者来自于配置文件的标签/变量。
  </p>
<p>
  如果你提供了<em class="parameter"><code>assign</code></em> 属性，
  <code class="varname">{eval}</code>函数的输出将不会显示，而是赋值给模板变量。
 </p>
...
<li class="listitem"><p>
  执行变量的操作将在每次编译的时候都会启动，编译版本的程序不会被保存！
  然而如果你开启了<a class="link" href="caching.tpl" title="Chapter 15. 缓存">缓存</a>设置，那么
  模板的其余部分会被缓存。
  </p></li>
<li class="listitem"><p>
  如果执行的内容不会经常变化，或者被多次使用，可以考虑使用
  <code class="literal">{include file="string:{$template_code}"}</code>来代替。
...
<div class="example">
<a name="id456693"></a><p class="title"><b>Example 8.3. {eval}</b></p>
<div class="example-contents">
<p>这里有个配置文件，<code class="filename">setup.conf</code>.</p>
...
<a name="id456742"></a><p class="title"><b>Example 8.4. 另一个{eval}例子</b></p>
<div class="example-contents">
<p>
   例子将显示服务器名称（大写字母）和IP。
   赋值的<em class="parameter"><code>$str</code></em>可以是来自于数据库的查询。</p>
<pre class="programlisting">
...
<td width="40%" align="right"> <a accesskey="n" href="language.function.fetch.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> {fetch}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 2 plus 14? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.eval.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02230 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
