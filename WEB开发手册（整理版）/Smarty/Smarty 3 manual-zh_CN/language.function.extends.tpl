...
<html lang="en">
  <head>
    ...
    <title>{extends} | Smarty</title>
    <meta name="description" content="{extends}">
    <meta name="keywords" content=", ldelim, extends, rdelim, ">
...
<tr><th colspan="3" align="center">{extends}</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.function.debug.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 7. 内置函数</th>
<td width="20%" align="right"> <a accesskey="n" href="language.function.for.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="{extends}">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.function.extends"></a>{extends}</h2></div></div></div>
<p>
 模板继承中，你可以在子模板内使用<code class="varname">{extends}</code>标签来扩展父模板。
  详细参见<a class="link" href="advanced.features.template.inheritance.tpl" title="模板继承">模板继承</a>.
  </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
   <code class="varname">{extends}</code>必须放在模板的第一行。
  </p></li>
<li class="listitem"><p>
   如果子模板要用<code class="varname">{extends}</code>来扩展父模板，那么它只能有
   <code class="varname">{block}</code>的区域。任何其他的模板内容都会被忽略。 
   </p></li>
<li class="listitem"><p>
  扩展使用在<a class="link" href="variable.template.dir.tpl" title="$template_dir"><em class="parameter"><code>$template_dir</code></em></a> 
  之外的文件，请使用<a class="link" href="resources.tpl" title="Chapter 16. 资源">模板资源</a>的语法。
  </p></li>
</ul></div>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
<p>
   当你扩展一个父模板名称的变量如<code class="literal">{extends file=$parent_file}</code>，
   请确保<code class="varname">$parent_file</code>变量放到同一个
   <a class="link" href="variable.cache.id.tpl" title="$cache_id"><code class="varname">$cache_id</code></a>中.
   否则Smarty无法辨别不同的<code class="varname">$parent_file</code>变量。
   </p>
</div>
...
<div class="example">
<a name="id432338"></a><p class="title"><b>Example 7.26. 简单 {extends} 例子</b></p>
...
<br class="example-break"><p>
  ...
  和 <a class="link" href="language.function.block.tpl" title="{block}"><code class="varname">{block}</code></a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="language.function.for.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> {for}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 8 plus 9? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="1f68045541d3de3fd447e1536117a3bd">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.extends.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02194 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
