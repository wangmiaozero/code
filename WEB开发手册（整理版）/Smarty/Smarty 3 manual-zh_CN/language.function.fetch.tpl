...
<html lang="en">
  <head>
    ...
    <meta name="keywords" content=", ldelim, fetch, rdelim, ">
...
<a accesskey="p" href="language.function.eval.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 8. 自定义函数</th>
<td width="20%" align="right"> <a accesskey="n" href="language.function.html.checkboxes.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
   <code class="varname">{fetch}</code>用于获取文件内容、HTTP或者FTP内容，以便输出。
   </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem">
<p>
   如果提供的文件名是以<em class="parameter"><code>http://</code></em>开头，那么网站的内容将被获取并显示。
	</p>
...
<li class="listitem"><p>
   如果文件名是以<em class="parameter"><code>ftp://</code></em>开头，那么文件会被从FTP中下载并显示。
   </p></li>
<li class="listitem">
<p>
...
<h3 class="title">Note</h3>
<p>
	  如果开启了安全机制，那么从本地获取文件内容，<code class="varname">{fetch}</code>函数仅能读取在
	  <em class="parameter"><code>$secure_dir</code></em>安全目录下的文件。
...
<li class="listitem"><p>
  如果你提供了<em class="parameter"><code>assign</code></em> 属性，
  <code class="varname">{fetch}</code>函数的输出将不会显示，而是赋值给模板变量。
   </p></li>
</ul></div>
...
<div class="example">
<a name="id457288"></a><p class="title"><b>Example 8.5. {fetch} 例子</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="language.function.html.checkboxes.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> {html_checkboxes}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 14 plus 13? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.fetch.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02542 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
