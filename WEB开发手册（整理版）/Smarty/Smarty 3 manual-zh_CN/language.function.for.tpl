...
<html lang="en">
  <head>
    ...
    <title>{for} | Smarty</title>
    <meta name="description" content="{for}">
    <meta name="keywords" content=", ldelim, for, rdelim, ">
...
<a accesskey="p" href="language.function.extends.tpl">Prev</a> </td>
...
<div class="sect1" title="{for}">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.function.for"></a>{for}</h2></div></div></div>
<p>
  <code class="varname">{for}{forelse}</code>用于创建一个简单的循环。
  下面的几种方式都是支持的：
 </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
    <code class="varname">{for $var=$start to $end}</code>步长1的简单循环。
   </p></li>
<li class="listitem"><p>
    <code class="varname">{for $var=$start to $end step $step}</code>指定步长的循环。
   </p></li>
</ul></div>
<p>
  <code class="varname">{forelse}</code>在循环不能遍历的时候执行。 
 </p>
...
<td>关闭<code class="varname">{for}</code> 循环的缓存</td>
</tr></tbody>
</table></div>
<div class="example">
<a name="id432843"></a><p class="title"><b>Example 7.27. 简单的<code class="varname">{for}</code> 循环</b></p>
...
<a name="id432873"></a><p class="title"><b>Example 7.28. 使用<code class="varname">max</code> 属性</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<br class="example-break"><div class="example">
<a name="id432910"></a><p class="title"><b>Example 7.29. <code class="varname">{forelse}</code>的执行</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<tr>
<td width="40%" align="left" valign="top">{extends} </td>
...
<td width="40%" align="right" valign="top"> {foreach},{foreachelse}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 1 plus 18? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.for.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02213 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
