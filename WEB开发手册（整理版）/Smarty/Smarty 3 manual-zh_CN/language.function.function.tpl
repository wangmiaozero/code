...
<html lang="en">
  <head>
    ...
    <title>{function} | Smarty</title>
    <meta name="description" content="{function}">
    <meta name="keywords" content=", ldelim, function, rdelim, ">
...
<p>
  <code class="varname">{function}</code>用于在模板内创建函数，这些函数可以像插件函数一样调用。
...
<p>
  ...
  标签来调用定义在当前模板的函数。
  或者你可以直接使用函数，如<code class="literal">{funcname ...}</code>。
  </p>
</div>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
    <code class="varname">{function}</code>标签必须设置<em class="parameter"><code>name</code></em>属性，
	也就是模板函数的名称。
	该名称可以用于调用模板函数。
   </p></li>
<li class="listitem"><p>
   可以按<a class="link" href="language.syntax.attributes.tpl" title="属性">属性</a>的方式传递给模板函数变量默认值。
   和PHP函数定义一样，你只可以使用标量值作为默认。
   默认值可以被覆盖，当模板函数被调用的时候。
 </p></li>
<li class="listitem"><p>
...
<p>
 ...
 <code class="literal">{funcname ...}</code>标签内定义参数。
 默认值必须是标量而且不是变量，变量必须在函数调用时才能传递。
 </p>
</div>
<div class="example">
<a name="id435563"></a><p class="title"><b>Example 7.43. 递归菜单 {function} 例子</b></p>
...
<td width="40%" align="right" valign="top"> {if},{elseif},{else}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 10 plus 10? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.function.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01721 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
