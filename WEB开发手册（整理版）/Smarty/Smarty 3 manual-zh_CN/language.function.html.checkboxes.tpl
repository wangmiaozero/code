...
<html lang="en">
  <head>
    ...
    <title>{html_checkboxes} | Smarty</title>
    <meta name="description" content="{html_checkboxes}">
    <meta name="keywords" content=", ldelim, html_checkboxes, rdelim, ">
...
<a accesskey="p" href="language.function.fetch.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 8. 自定义函数</th>
<td width="20%" align="right"> <a accesskey="n" href="language.function.html.image.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
   <code class="varname">{html_checkboxes}</code>是一个
   <a class="link" href="language.custom.functions.tpl" title="Chapter 8. 自定义函数">自定义函数</a>，用于创建HTML的多选框组和提供数据。
   请注意默认选中的情况。
   </p>
...
<div class="example">
<a name="id457985"></a><p class="title"><b>Example 8.6. {html_checkboxes}</b></p>
...
<a name="id458055"></a><p class="title"><b>Example 8.7. 
...
<br class="example-break"><p>
  ...
  和
  <a class="link" href="language.function.html.options.tpl" title="{html_options}"><code class="varname">{html_options}</code></a>
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="language.function.html.image.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> {html_image}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 20 plus 15? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.html.checkboxes.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02259 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
