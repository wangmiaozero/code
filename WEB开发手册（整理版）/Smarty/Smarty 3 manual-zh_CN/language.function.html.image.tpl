...
<html lang="en">
  <head>
    ...
    <title>{html_image} | Smarty</title>
    <meta name="description" content="{html_image}">
    <meta name="keywords" content=", ldelim, html_image, rdelim, ">
...
<a accesskey="p" href="language.function.html.checkboxes.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 8. 自定义函数</th>
<td width="20%" align="right"> <a accesskey="n" href="language.function.html.options.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
   <code class="varname">{html_image}</code>用于生成HTML的<code class="literal">&lt;img&gt;</code>标签的
   <a class="link" href="language.custom.functions.tpl" title="Chapter 8. 自定义函数">自定义函数</a>。
   如果没有提供<em class="parameter"><code>height</code></em> 和 <em class="parameter"><code>width</code></em>参数，
   此函数会自动从图片文件计算出来。
 </p>
...
<td align="center"><span class="emphasis"><em>真实图片高度</em></span></td>
<td>图片显示高度</td>
</tr>
<tr>
...
<td align="center">string</td>
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>真实图片宽度</em></span></td>
<td>图片显示宽度</td>
</tr>
<tr>
...
<td align="center">string</td>
<td align="center">no</td>
<td align="center"><span class="emphasis"><em>网站根目录</em></span></td>
<td>相对路径的起始目录</td>
</tr>
<tr>
...
<li class="listitem"><p>
  <em class="parameter"><code>basedir</code></em>设置了相对图片路径的起始目录。如果没有提供，
  则使用网站根目录<code class="varname">$_ENV['DOCUMENT_ROOT']</code>。
  如果开启了安全限制，图片文件必须放置在<em class="parameter"><code>$secure_dir</code></em>目录。
	参见<a class="link" href="advanced.features.tpl#advanced.features.security" title="安全">安全机制</a>来了解更多。
 </p></li>
<li class="listitem"><p>
  <em class="parameter"><code>href</code></em>设置图片上超链接地址。如果链接地址有提供，那么
  图片标签的外围会加上<code class="literal">&lt;a href="超链接地址"&gt;&lt;a&gt;</code>的标签。
 </p></li>
<li class="listitem"><p>
  <em class="parameter"><code>path_prefix</code></em>可选的，设置显示路径时的前缀字符串。
  当你需要给图片设置不同的服务器名时，这会很有用。
 </p></li>
<li class="listitem"><p>
 其他不在上面列表中的键值对参数，会直接在输出的<code class="literal">&lt;img&gt;</code>标签中显示成 名称=值 的属性。
 </p></li>
</ul></div>
<div class="note" title="技术说明" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">技术说明</h3>
<p>
   <code class="varname">{html_image}</code>需要每次都读取硬盘上的图片，并且计算图片长宽。
   除非你开启了<a class="link" href="caching.tpl" title="Chapter 15. 缓存">缓存</a>，否则一般建议是避免使用
   <code class="varname">{html_image}</code>，用回HTML的IMG标签，会有更高的性能。
  </p>
</div>
<div class="example">
<a name="id458980"></a><p class="title"><b>Example 8.8. {html_image} 例子</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="language.function.html.options.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> {html_options}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 7 plus 20? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.html.image.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02403 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
