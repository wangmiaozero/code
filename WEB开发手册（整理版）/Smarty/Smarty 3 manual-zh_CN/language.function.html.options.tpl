...
<html lang="en">
  <head>
    ...
    <title>{html_options} | Smarty</title>
    <meta name="description" content="{html_options}">
    <meta name="keywords" content=", ldelim, html_options, rdelim, ">
...
<a accesskey="p" href="language.function.html.image.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 8. 自定义函数</th>
<td width="20%" align="right"> <a accesskey="n" href="language.function.html.radios.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
   <code class="varname">{html_options}</code>是一个<a class="link" href="language.custom.functions.tpl" title="Chapter 8. 自定义函数">自定义函数</a>，
   可以使用提供的数据，生成HTML的<code class="literal">&lt;select&gt;&lt;option&gt;</code>标签，还可以设置选中项等属性。
   </p>
...
<td align="center">Yes, 除非使用 options 属性</td>
...
<td align="center">Yes, 除非使用 values 和 output</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>键值对的数组，用于下拉框</td>
</tr>
<tr>
...
<li class="listitem"><p>
   必要的属性是<em class="parameter"><code>values</code></em> 和 <em class="parameter"><code>output</code></em>,
   除非你使用组合的<em class="parameter"><code>options</code></em>来代替。
 </p></li>
<li class="listitem"><p>
 除非提供了可选属性<em class="parameter"><code>name</code></em>， 才会创建
 <code class="literal">&lt;select&gt;&lt;/select&gt;</code>标签，
 不然，只会生成<code class="literal">&lt;option&gt;</code>列表。
 </p></li>
<li class="listitem"><p>
  如果设置的值是数组，会当作HTML的<code class="literal">&lt;optgroup&gt;</code>，并且显示该下拉组。
  <code class="literal">&lt;optgroup&gt;</code>是支持递归的。
 </p></li>
<li class="listitem"><p>
 其他不在上面列表中的键值对参数，会直接在输出的 <code class="literal">&lt;select&gt;</code> 标签中显示成 名称=值 的属性。
 如果可选参数<em class="parameter"><code>name</code></em>没有设置，那么它们将被忽略。
 </p></li>
<li class="listitem"><p>
	全部的输出都符合XHTML的。
	</p></li>
...
<div class="example">
<a name="id459731"></a><p class="title"><b>Example 8.9. 使用<code class="varname">options</code>属性</b></p>
...
<p>
	下面模板将生成一个下拉列表。
	注意<em class="parameter"><code>name</code></em>提供了值，所以会生成
	<code class="literal">&lt;select&gt;</code>标签。
  </p>
<pre class="programlisting">
...
<a name="id459790"></a><p class="title"><b>Example 8.10. 分开赋值<code class="varname">values</code> 和 <code class="varname">ouptut</code></b></p>
<div class="example-contents">
<pre class="programlisting">
...
<p>
  上面的两个数组，将会如下输出HTML
  (注意这里有使用了PHP的<a class="ulink" href="../../../www.php.net/function.count" target="_top">
  <code class="varname">count()</code></a>函数作为修饰器来计算size值).
  </p>
<pre class="programlisting">
...
<br class="example-break"><div class="example">
<a name="id459845"></a><p class="title"><b>Example 8.11. 数据库例子(如 ADODB 或 PEAR)</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<p>
下面是模板，注意使用了
<a class="link" href="language.modifier.truncate.tpl" title="truncate"><code class="varname">truncate</code></a>
修饰器。
</p>
<pre class="programlisting">
...
<br class="example-break"><div class="example">
<a name="id459889"></a><p class="title"><b>Example 8.12. &lt;optgroup&gt; 下拉组</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<br class="example-break"><p>
    参见
    <a class="link" href="language.function.html.checkboxes.tpl" title="{html_checkboxes}"><code class="varname">{html_checkboxes}</code></a>
    和
    <a class="link" href="language.function.html.radios.tpl" title="{html_radios}"><code class="varname">{html_radios}</code></a>
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="language.function.html.radios.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> {html_radios}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 17 plus 18? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="7f10313ce1964dc4ea93d256adc4ca70">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.html.options.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02556 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
