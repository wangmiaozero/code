...
<html lang="en">
  <head>
    ...
    <title>{html_radios} | Smarty</title>
    <meta name="description" content="{html_radios}">
    <meta name="keywords" content=", ldelim, html_radios, rdelim, ">
...
<a accesskey="p" href="language.function.html.options.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 8. 自定义函数</th>
<td width="20%" align="right"> <a accesskey="n" href="language.function.html.select.date.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
   <code class="varname">{html_radios}</code>是一个
   <a class="link" href="language.custom.functions.tpl" title="Chapter 8. 自定义函数">自定义函数</a>，用于创建HTML的单选框组和提供数据。
   请注意默认选中的情况。
   </p>
...
<td align="center">必选，除非使用options属性</td>
...
<td align="center">必须, 除非使用values 和 output属性</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>单选框的值-显示的数组</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em><code class="constant">TRUE</code></em></span></td>
<td>将输出中的/转换(值总是会被转换)</td>
</tr>
</tbody>
</table></div>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
   必须赋值的属性是<em class="parameter"><code>values</code></em> 和
   <em class="parameter"><code>output</code></em>, 除非使用<em class="parameter"><code>options</code></em>来代替。
    </p></li>
<li class="listitem"><p>
   全部的输出标签都遵循XHTML规则。
    </p></li>
<li class="listitem"><p>
   任何不在上面列表中的键值对属性，都会被输出到<code class="literal">&lt;input&gt;</code>标签中作为属性和值。
     </p></li>
</ul></div>
<div class="example">
<a name="id460842"></a><p class="title"><b>Example 8.13. {html_radios}第一个例子</b></p>
...
<a name="id460875"></a><p class="title"><b>Example 8.14. {html_radios}第二个例子</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<br class="example-break"><div class="example">
<a name="id460914"></a><p class="title"><b>Example 8.15. {html_radios} 数据库例子(如 PEAR 或 ADODB):</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<br class="example-break"><p>
  参见<a class="link" href="language.function.html.checkboxes.tpl" title="{html_checkboxes}"><code class="varname">{html_checkboxes}</code></a>
  和 <a class="link" href="language.function.html.options.tpl" title="{html_options}"><code class="varname">{html_options}</code></a>
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="language.function.html.select.date.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> {html_select_date}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 18 plus 6? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.html.radios.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02288 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
