...
<p>
   <code class="varname">{html_table}</code>是一个
   <a class="link" href="language.custom.functions.tpl" title="Chapter 8. 自定义函数">自定义函数</a>，可使用数组形式的数据来创建一个HTML的<code class="literal">&lt;table&gt;</code>.
   </p>
...
<td>
	 表格的列数，或者是逗号分隔的列头文字列表，或是列头文字的数组。
	 如果cols属性为空，但设置了rows，将以rows数量和显示元素的总数进行计算得出列数，
	 以便每列能显示全部的元素。
	 如果rows和cols都设置了，那么cols会忽略默认值3.
	 如果设置cols为一个列表或数组，那么列数将取决于列表或数组的元素个数。
     </td>
</tr>
<tr>
...
<td>
	 表格的行数。如果设置为空，但设置了cols，那么将以cols数量和显示元素的总数进行计算得出行数，
	 以便每行能显示全部的元素。
     </td>
</tr>
<tr>
...
<td>
	 显示元素的循环方向。<span class="emphasis"><em>cols</em></span>意味着元素将按“一列一列”地显示。
	 而<span class="emphasis"><em>rows</em></span>意味着元素将“一行一行”地显示。
     </td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>empty</em></span></td>
<td>表格中<code class="literal">&lt;caption&gt;</code>属性值</td>
</tr>
<tr>
...
<td>
<code class="literal">&lt;table&gt;</code>标签的属性</td>
</tr>
<tr>
...
<td align="center"><span class="emphasis"><em>empty</em></span></td>
<td>
<code class="literal">&lt;th&gt;</code>标签的属性
     (循环)</td>
</tr>
<tr>
...
<td align="center"><span class="emphasis"><em>empty</em></span></td>
<td>
<code class="literal">&lt;tr&gt;</code>标签的属性
     (循环)</td>
</tr>
<tr>
...
<td align="center"><span class="emphasis"><em>empty</em></span></td>
<td>
<code class="literal">&lt;td&gt;</code>标签的属性
     (循环)</td>
</tr>
<tr>
...
<td>
	 每行显示的方向。可以设置：
      <span class="emphasis"><em>right</em></span> (从左到右), 和
      <span class="emphasis"><em>left</em></span> (从右到左)
     </td>
</tr>
<tr>
...
<td>
	 每列显示的方向。可以设置：
      <span class="emphasis"><em>down</em></span> (上到下), <span class="emphasis"><em>up</em></span>
      (下到上)
     </td>
</tr>
</tbody>
...
<li class="listitem"><p>
   <em class="parameter"><code>cols</code></em>属性决定表格可以显示多少列。
   </p></li>
<li class="listitem"><p>
   <em class="parameter"><code>table_attr</code></em>, <em class="parameter"><code>tr_attr</code></em>
   和 <em class="parameter"><code>td_attr</code></em> 的值决定了<code class="literal">&lt;table&gt;</code>, <code class="literal">&lt;tr&gt;</code>
   和 <code class="literal">&lt;td&gt;</code> 标签的数量。
   </p></li>
<li class="listitem"><p>
   如果<em class="parameter"><code>tr_attr</code></em> 或者 <em class="parameter"><code>td_attr</code></em>是一个数组，
   那么它们的值将被循环交替使用。
   </p></li>
<li class="listitem"><p>
   <em class="parameter"><code>trailpad</code></em>是在最后行空单元格中填充的字符(如果有的话)。
   </p></li>
</ul></div>
<div class="example">
<a name="id465903"></a><p class="title"><b>Example 8.19. {html_table}</b></p>
...
<td width="40%" align="right" valign="top"> {mailto}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 17 plus 13? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.html.table.tpl">
            </form>
            </div>
          </div>
