...
<html lang="en">
  <head>
    ...
    <title>{include_php} | Smarty</title>
    <meta name="description" content="{include_php}">
    <meta name="keywords" content=", ldelim, include_php, rdelim, ">
...
<a accesskey="p" href="language.function.include.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 7. 内置函数</th>
<td width="20%" align="right"> <a accesskey="n" href="language.function.insert.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<div class="note" title="重要提示" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">重要提示</h3>
<p>
    <code class="varname">{include_php}</code>是废弃的函数，用注册插件的方式来将程序代码和显示分离，是更好的选择。
	在Smarty 3.1，<code class="varname">{include_php}</code>仅在<a class="link" href="bc.tpl" title="Chapter 19. SmartyBC - 向前兼容的类库">SmartyBC</a>中可用.
   </p>
</div>
...
<p>
  <code class="varname">{include_php}</code>用于载入一个PHP文件到模板中。
  属性中的<em class="parameter"><code>file</code></em>路径可以是绝对路径，或是相对于
  <a class="link" href="variable.trusted.dir.tpl" title="$trusted_dir"><em class="parameter"><code>$trusted_dir</code></em></a>的路径。
  如果安全机制开启，那么只有在<em class="parameter"><code>$trusted_dir</code></em>目录中的文件才可以被载入。
   参见<a class="link" href="advanced.features.tpl#advanced.features.security" title="安全">安全机制</a>。
 </p>
<p>
 默认情况下，该PHP文件仅会载入一次，即使多次执行模板。
 你可以设置<em class="parameter"><code>once</code></em>属性使其每次执行都载入。
 当once设置为<code class="constant">FALSE</code>，PHP文件将在每次模板执行的时候都会被载入。
 </p>
<p>
 你可以设置可选的属性<em class="parameter"><code>assign</code></em>，来将<code class="varname">{include_php}</code>载入的内容
 赋值给一个指定的模板变量，而不是输出。
 </p>
<p>
 在载入的PHP文件中，可以通过<em class="parameter"><code>$_smarty_tpl-&gt;smarty</code></em>来获取到当前的Smarty对象。
 </p>
<div class="example">
<a name="id438552"></a><p class="title"><b>Example 7.55.  {include_php} 函数</b></p>
<div class="example-contents">
<p> <code class="filename">load_nav.php</code> 文件:</p>
...
<br class="example-break"><p>
  参见<a class="link" href="language.function.include.tpl" title="{include}"><code class="varname">{include}</code></a>,
<a class="link" href="variable.trusted.dir.tpl" title="$trusted_dir"><em class="parameter"><code>$trusted_dir</code></em></a>,
  <a class="link" href="language.function.php.tpl" title="{php}"><code class="varname">{php}</code></a>, <a class="link" href="language.function.capture.tpl" title="{capture}"><code class="varname">{capture}</code></a>, <a class="link" href="resources.tpl" title="Chapter 16. 资源">资源</a> 和 <a class="link" href="tips.componentized.templates.tpl" title="组件化模板">组件化模板</a> </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="language.function.insert.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> {insert}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 13 plus 8? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.include.php.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02627 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
