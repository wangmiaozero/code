...
<html lang="en">
  <head>
    ...
    <title>{ldelim},{rdelim} | Smarty</title>
    <meta name="description" content="{ldelim},{rdelim}">
    <meta name="keywords" content=", ldelim, ldelim, rdelim, ldelim, rdelim, rdelim, ">
...
<tr><th colspan="3" align="center">{ldelim},{rdelim}</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.function.insert.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 7. 内置函数</th>
<td width="20%" align="right"> <a accesskey="n" href="language.function.literal.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="{ldelim},{rdelim}">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.function.ldelim"></a>{ldelim},{rdelim}</h2></div></div></div>
<p>
   <code class="varname">{ldelim}</code> 和 <code class="varname">{rdelim}</code>用于
   <a class="link" href="language.escaping.tpl" title="避免Smarty解析">避免解析</a>模板定界符，
   默认是
   <span class="bold"><strong>{</strong></span> and <span class="bold"><strong>}</strong></span>。
   同时你也可以用<a class="link" href="language.function.literal.tpl" title="{literal}"><code class="varname">{literal}{/literal}</code></a>来避免解析区域的字符，如javascript或者css。
    参见<a class="link" href="language.variables.smarty.tpl#language.variables.smarty.ldelim" title="{$smarty.ldelim}, {$smarty.rdelim}"><em class="parameter"><code>{$smarty.ldelim}</code></em></a>.
  </p>
<div class="example">
<a name="id439955"></a><p class="title"><b>Example 7.57. {ldelim}, {rdelim}</b></p>
...
<a name="id440001"></a><p class="title"><b>Example 7.58. 再一个 Javascript 例子</b></p>
...
<br class="example-break"><p>参见
  <a class="link" href="language.function.literal.tpl" title="{literal}"><code class="varname">{literal}</code></a>
  和 <a class="link" href="language.escaping.tpl" title="避免Smarty解析">避免Smarty解析</a>.
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="language.function.literal.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">{insert} </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> {literal}</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.ldelim.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02228 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
