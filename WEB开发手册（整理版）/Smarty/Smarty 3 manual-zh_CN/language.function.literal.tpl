...
<html lang="en">
  <head>
    ...
    <title>{literal} | Smarty</title>
    <meta name="description" content="{literal}">
    <meta name="keywords" content=", ldelim, literal, rdelim, ">
...
<a accesskey="p" href="language.function.ldelim.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 7. 内置函数</th>
<td width="20%" align="right"> <a accesskey="n" href="language.function.nocache.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
  <code class="varname">{literal}</code>可以让一个模板区域的字符原样输出。
  这经常用于保护页面上的Javascript或css样式表，避免因为Smarty的<a class="link" href="variable.left.delimiter.tpl" title="$left_delimiter">定界符</a>{语法}而错被解析。
  在<code class="varname">{literal}{/literal}</code>内的任何标签都不会被解析，原样输出。
  所以如果你有需要放到<code class="varname">{literal}</code>内的标签，首先可以考虑是否用
   <a class="link" href="language.function.ldelim.tpl" title="{ldelim},{rdelim}"><code class="varname">{ldelim}{rdelim}</code></a>
   来代替定界符在页面上的显示（不用{literal}）。
 </p>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
<p>
   因为Smarty会忽略那些带空格的定界符，所以通常不需要使用<code class="varname">{literal}{/literal}</code>，。
   请确定你的Javascript或者CSS样式表的大括号周围是有空格的。这是Smarty 3的新特性。
 </p>
</div>
<div class="example">
<a name="id439707"></a><p class="title"><b>Example 7.59. {literal} 标签</b></p>
...
<br class="example-break"><p>
  ...
  <a class="link" href="language.function.ldelim.tpl" title="{ldelim},{rdelim}"><code class="varname">{ldelim} {rdelim}</code></a>
和
  <a class="link" href="language.escaping.tpl" title="避免Smarty解析">避免Smarty解析</a>。
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="language.function.nocache.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> {nocache}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 3 plus 6? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.literal.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02321 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
