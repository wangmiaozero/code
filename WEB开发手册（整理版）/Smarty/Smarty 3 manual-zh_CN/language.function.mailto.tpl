...
<html lang="en">
  <head>
    ...
    <title>{mailto} | Smarty</title>
    <meta name="description" content="{mailto}">
    <meta name="keywords" content=", ldelim, mailto, rdelim, ">
...
<a accesskey="p" href="language.function.html.table.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 8. 自定义函数</th>
<td width="20%" align="right"> <a accesskey="n" href="language.function.math.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
   <code class="varname">{mailto}</code>可以自动创建一个<code class="literal">mailto:</code>链接，而且可以选择编码方式。
...
<td>
	 如何编码电邮。可以是<code class="literal">none</code>,
      <code class="literal">hex</code>, <code class="literal">javascript</code>
      或者 <code class="literal">javascript_charcode</code>.</td>
</tr>
<tr>
...
<div class="example">
<a name="id466846"></a><p class="title"><b>Example 8.20. {mailto}例子和其输出的结果</b></p>
...
<br class="example-break"><p>
 参见
 <a class="link" href="language.modifier.escape.tpl" title="escape"><code class="varname">转码</code></a>,
 <a class="link" href="language.function.textformat.tpl" title="{textformat}"><code class="varname">{textformat}</code></a>
 和
 <a class="link" href="tips.obfuscating.email.tpl" title="混淆电子邮件地址">混淆邮件地址</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="language.function.math.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> {math}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.mailto.tpl">
            </form>
            </div>
          </div>
