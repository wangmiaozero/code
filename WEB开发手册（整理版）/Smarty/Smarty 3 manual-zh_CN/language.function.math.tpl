...
<html lang="en">
  <head>
    ...
    <title>{math} | Smarty</title>
    <meta name="description" content="{math}">
    <meta name="keywords" content=", ldelim, math, rdelim, ">
...
<a accesskey="p" href="language.function.mailto.tpl">Prev</a> </td>
...
<p>
   <code class="varname">{math}</code>可以让模板设计者在模板中进行一些数学运算。
   </p>
...
<li class="listitem"><p>可以允许的计算有 +, -, /, *, abs, ceil, cos,  exp, floor, log, log10, max, min,
   pi, pow, rand, round, sin, sqrt, srans 和 tan 。
   参见PHP手册，了解<a class="ulink" href="../../../www.php.net/eval/index.htm" target="_top">math</a> 函数。
  </p></li>
<li class="listitem"><p>
  如果你提供了<em class="parameter"><code>assign</code></em> 属性，
  <code class="varname">{math}</code>函数的输出将不会显示，而是赋值给模板变量。
   </p></li>
</ul></div>
<div class="note" title="技术说明" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">技术说明</h3>
<p>
  因为使用了PHP函数<a class="ulink" href="../../../www.php.net/eval/index.htm" target="_top">
   <code class="varname">eval()</code></a>，所以<code class="varname">{math}</code>是一个比较耗费性能的操作。
   在PHP中做数学运算会更高效，所以尽可能在PHP进行数学运算并且把结果
   <a class="link" href="api.assign.tpl" title="assign()"><code class="varname">assign()</code></a>到模板中。
   比较不建议的做法是在循环中使用<code class="varname">{math}</code>函数，比如在<a class="link" href="language.function.section.tpl" title="{section},{sectionelse}">
    <code class="varname">{section}</code></a>循环。
  </p>
</div>
...
<div class="example">
<a name="id467596"></a><p class="title"><b>Example 8.21. {math}</b></p>
<div class="example-contents">
<p>
  <span class="bold"><strong>例子 a:</strong></span>
  </p>
...
<p>
    <span class="bold"><strong>例子 b:</strong></span>
  </p>
<pre class="programlisting">
...
<p>
  <span class="bold"><strong>例子 c:</strong></span>
  </p>
<pre class="programlisting">
...
<p>
    <span class="bold"><strong>例子 d:</strong></span>
  </p>
<pre class="programlisting">
...
<td width="40%" align="right" valign="top"> {textformat}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 14 plus 1? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.math.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02083 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
