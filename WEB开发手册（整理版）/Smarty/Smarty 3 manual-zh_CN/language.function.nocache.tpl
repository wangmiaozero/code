...
<html lang="en">
  <head>
    ...
    <title>{nocache} | Smarty</title>
    <meta name="description" content="{nocache}">
    <meta name="keywords" content=", ldelim, nocache, rdelim, ">
...
<tr><th colspan="3" align="center">{nocache}</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.function.literal.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 7. 内置函数</th>
<td width="20%" align="right"> <a accesskey="n" href="language.function.php.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="{nocache}">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.function.nocache"></a>{nocache}</h2></div></div></div>
<p>
   <code class="varname">{nocache}</code>用于关闭模板区块的缓存。
   <code class="varname">{nocache}</code>都必须和一个<code class="varname">{/nocache}</code>匹配。
  </p>
...
<div class="example">
<a name="id440062"></a><p class="title"><b>Example 7.60. 阻止模板区域缓存</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="language.function.php.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">{literal} </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> {php}</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 4 plus 18? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.nocache.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02146 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
