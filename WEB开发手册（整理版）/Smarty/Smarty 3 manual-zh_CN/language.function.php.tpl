...
<html lang="en">
  <head>
    ...
    <meta name="keywords" content=", ldelim, php, rdelim, ">
...
<a accesskey="p" href="language.function.nocache.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 7. 内置函数</th>
<td width="20%" align="right"> <a accesskey="n" href="language.function.section.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<div class="note" title="重要说明" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">重要说明</h3>
<p>
      Smarty已经废弃<code class="varname">{php}</code>标签，强烈建议不要使用。
	  请把你的PHP逻辑放到PHP程序或者插件函数中实现。
   </p>
</div>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
<p>
  在Smarty 3.1，<code class="varname">{php}</code>仅在<a class="link" href="bc.tpl" title="Chapter 19. SmartyBC - 向前兼容的类库">SmartyBC</a>中可用。
  </p>
</div>
<p>
 <code class="varname">{php}</code>标签可以允许PHP代码直接嵌到模板中使用。
 这些代码是否被编码，需要取决于<a class="link" href="variable.php.handling.tpl" title="$php_handling"><em class="parameter"><code>$php_handling</code></em></a> 的设置.
 </p>
<div class="example">
<a name="id440208"></a><p class="title"><b>Example 7.61. {php}标签的使用</b></p>
...
<a name="id440608"></a><p class="title"><b>Example 7.62. {php}标签中使用全局变量来赋值变量</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
  参见
  <a class="link" href="variable.php.handling.tpl" title="$php_handling"><em class="parameter"><code>$php_handling</code></em></a>,
  ...
  和
  <a class="link" href="tips.componentized.templates.tpl" title="组件化模板">组件化模板</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="language.function.section.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">{nocache} </td>
...
<td width="40%" align="right" valign="top"> {section},{sectionelse}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 15 plus 3? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.php.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02169 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
