...
<html lang="en">
  <head>
    ...
    <title>{setfilter} | Smarty</title>
    <meta name="description" content="{setfilter}">
    <meta name="keywords" content=", ldelim, setfilter, rdelim, ">
...
<tr><th colspan="3" align="center">{setfilter}</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.function.section.tpl">Prev</a> </td>
...
<div class="sect1" title="{setfilter}">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.function.setfilter"></a>{setfilter}</h2></div></div></div>
<p>
  <code class="varname">{setfilter}...{/setfilter}</code>块标签可以使用模板定义的变量过滤器。
 </p>
<p>
...
<p>
 <code class="varname">{setfilter}...{/setfilter}</code>可以被嵌套。
 内部的过滤器块会被外部的过滤器块给替代。
</p>
<p>
 ...
 它们会按照如下顺序执行：
  ...
  自动载入的变量过滤器，
  模板块变量过滤器。
  所有在“默认修饰器”之后的东西，都可以被<code class="literal">nofilter</code>关闭。
 </p>
<div class="example">
<a name="id444269"></a><p class="title"><b>Example 7.77. {setfilter} 标签</b></p>
...
<td width="40%" align="right" valign="top"> {strip}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.setfilter.tpl">
            </form>
            </div>
          </div>
