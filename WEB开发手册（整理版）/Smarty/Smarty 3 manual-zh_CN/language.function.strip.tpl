...
<html lang="en">
  <head>
    ...
    <title>{strip} | Smarty</title>
    <meta name="description" content="{strip}">
    <meta name="keywords" content=", ldelim, strip, rdelim, ">
...
<a accesskey="p" href="language.function.setfilter.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 7. 内置函数</th>
<td width="20%" align="right"> <a accesskey="n" href="language.function.while.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
 很多时候，页面设计师会遇到模板上的空格和回车影响到页面输出HTML的情况（浏览器“特性”），
 所以你可以把你的标签都放到一起，以取得想要的结果。但这很容易最终导致模板无法阅读和管理。
 </p>
<p>
 任何在<code class="varname">{strip}{/strip}</code>中的标签都会被过滤掉多余的空格和回车，
 并把全部标签放在同一行内显示。
...
<p>
   <code class="varname">{strip}{/strip}</code>不会作用于变量的内容，
   需要使用<a class="link" href="language.modifier.strip.tpl" title="strip">strip 修饰器</a>来过滤变量内容。
  </p>
</div>
<div class="example">
<a name="id443977"></a><p class="title"><b>Example 7.78. {strip} 标签</b></p>
...
<br class="example-break"><p>
 注意上面的例子，在一行内显示了全部的HTML标签，而且是全部文字都会放到一起。
 如果你有要原样输出的多行文字，那么它们也会变成一行显示。
 </p>
<p>
 参见
 <a class="link" href="language.modifier.strip.tpl" title="strip"><code class="varname">strip</code></a> 修饰器.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="language.function.while.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">{setfilter} </td>
...
<td width="40%" align="right" valign="top"> {while}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 3 plus 9? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.strip.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02216 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
