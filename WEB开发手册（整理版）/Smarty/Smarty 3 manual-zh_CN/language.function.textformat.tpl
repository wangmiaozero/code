...
<html lang="en">
  <head>
    ...
    <title>{textformat} | Smarty</title>
    <meta name="description" content="{textformat}">
    <meta name="keywords" content=", ldelim, textformat, rdelim, ">
...
<td width="20%" align="right"> <a accesskey="n" href="config.files.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
   <code class="varname">{textformat}</code>是一个用于格式化文本的
   <a class="link" href="plugins.block.functions.tpl" title="块函数">块函数</a>。
它一般会清理空格和特殊字符，该函数主要清理空格和特殊字符，对段落按单词边界换行和行缩进等段落格式化处理。
  </p>
<p>
  你可以明确指定参数，或者使用预设风格。当前<span class="quote">“<span class="quote">email</span>”</span>是唯一可用的风格。
 </p>
...
<td>设置<code class="constant">TRUE</code>将会按字符换行，而不是按单词边界换行。</td>
</tr>
<tr>
...
<div class="example">
<a name="id468412"></a><p class="title"><b>Example 8.22. {textformat}</b></p>
...
<br class="example-break"><p>
  参见
  <a class="link" href="language.function.strip.tpl" title="{strip}"><code class="varname">{strip}</code></a>
  和
  <a class="link" href="language.modifier.wordwrap.tpl" title="wordwrap"><code class="varname">自动换行</code></a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="config.files.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">{math} </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 9. 配置文件</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 18 plus 8? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.textformat.tpl">
            </form>
            </div>
          </div>
