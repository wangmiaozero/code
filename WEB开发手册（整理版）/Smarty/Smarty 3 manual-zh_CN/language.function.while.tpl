...
<p>
  Smarty的<code class="varname">{while}</code>循环和PHP的<a class="ulink" href="../../../www.php.net/while/index.htm" target="_top">while</a>
  在灵活性方面是几乎一样的，只是增加了少许特性。
  每个<code class="varname">{while}</code>必须有相应的<code class="varname">{/while}</code>.
  任何的PHP条件或者函数表达式都是可用的，如<span class="emphasis"><em>||</em></span>, <span class="emphasis"><em>or</em></span>,
...
<div class="example">
<a name="id444991"></a><p class="title"><b>Example 7.79. {while} 循环</b></p>
...
<td width="40%" align="right" valign="top"> Chapter 8. 自定义函数</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.function.while.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01348 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
