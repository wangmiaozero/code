...
<html lang="en">
  <head>
    ...
    <title>数学计算 | Smarty</title>
    <meta name="description" content="数学计算">
...
<tr><th colspan="3" align="center">数学计算</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.syntax.quotes.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 3. 基本语法</th>
<td width="20%" align="right"> <a accesskey="n" href="language.escaping.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="数学计算">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.math"></a>数学计算</h2></div></div></div>
<p>
 变量值内可以直接进行数学计算。
 </p>
<div class="example">
<a name="id407020"></a><p class="title"><b>Example 3.7. 数学计算例子</b></p>
...
<p>
 虽然Smarty可以处理一些非常复杂的表达式和运算，
 但最好还是保存模板的语法简洁，把焦点放在显示上。
如果你发现某部分模板代码过于复杂，一个好的方法是将这部分的代码放到插件或者修饰器内使用。
 </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="language.escaping.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">双引号中嵌入变量 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 避免Smarty解析</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 18 plus 13? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.math.tpl">
            </form>
            </div>
          </div>
