...
<html lang="en">
  <head>
    ...
    <title>count_paragraphs | Smarty</title>
    <meta name="description" content="count_paragraphs">
    <meta name="keywords" content="count_paragraphs">
...
<a accesskey="p" href="language.modifier.count.characters.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 5. 变量修饰器</th>
<td width="20%" align="right"> <a accesskey="n" href="language.modifier.count.sentences.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<div class="example">
<a name="id412688"></a><p class="title"><b>Example 5.5. count_paragraphs</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="language.modifier.count.sentences.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> count_sentences</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.modifier.count.paragraphs.tpl">
            </form>
            </div>
          </div>
