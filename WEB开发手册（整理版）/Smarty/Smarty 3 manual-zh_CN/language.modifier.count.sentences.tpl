...
<html lang="en">
  <head>
    ...
    <title>count_sentences | Smarty</title>
    <meta name="description" content="count_sentences">
    <meta name="keywords" content="count_sentences">
...
<tr><th colspan="3" align="center">count_sentences</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.modifier.count.paragraphs.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 5. 变量修饰器</th>
<td width="20%" align="right"> <a accesskey="n" href="language.modifier.count.words.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="count_sentences">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.modifier.count.sentences"></a>count_sentences</h2></div></div></div>
<p>
  计算变量内容有多少个句子。
  每个句子必须以点号、问号或者感叹号结尾。(.?!)
  </p>
<div class="example">
<a name="id413113"></a><p class="title"><b>Example 5.6. count_sentences</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="language.modifier.count.words.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">count_paragraphs </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> count_words</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 20 plus 8? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.modifier.count.sentences.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02125 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
