...
<html lang="en">
  <head>
    ...
    <title>count_words | Smarty</title>
    <meta name="description" content="count_words">
    <meta name="keywords" content="count_words">
...
<tr><th colspan="3" align="center">count_words</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.modifier.count.sentences.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 5. 变量修饰器</th>
<td width="20%" align="right"> <a accesskey="n" href="language.modifier.date.format.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="count_words">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.modifier.count.words"></a>count_words</h2></div></div></div>
<p>
  用于计算变量内容有多少个单词。
  </p>
<div class="example">
<a name="id413074"></a><p class="title"><b>Example 5.7. count_words</b></p>
...
<br class="example-break"><p>
   参见
   <a class="link" href="language.modifier.count.characters.tpl" title="count_characters"><code class="varname">count_characters</code></a>,
...
<td width="40%" align="right"> <a accesskey="n" href="language.modifier.date.format.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">count_sentences </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> date_format</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 4 plus 9? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.modifier.count.words.tpl">
            </form>
            </div>
          </div>
