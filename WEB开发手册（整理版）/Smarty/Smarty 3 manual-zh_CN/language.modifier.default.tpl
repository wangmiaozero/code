...
<a accesskey="p" href="language.modifier.date.format.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 5. 变量修饰器</th>
<td width="20%" align="right"> <a accesskey="n" href="language.modifier.escape.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<td align="center"><span class="emphasis"><em>控制</em></span></td>
<td>当变量为空时输出的值</td>
</tr></tbody>
</table></div>
<div class="example">
<a name="id414750"></a><p class="title"><b>Example 5.9. default</b></p>
...
<br class="example-break"><p>
  参见
   ...
   和
   <a class="link" href="tips.tpl#tips.blank.var.handling" title="空变量的处理">空变量处理</a>。
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="language.modifier.escape.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> escape</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.modifier.default.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02183 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
