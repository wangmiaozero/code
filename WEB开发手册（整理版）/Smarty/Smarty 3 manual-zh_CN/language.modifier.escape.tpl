...
<html lang="en">
  <head>
    ...
    <title>escape | Smarty</title>
    <meta name="description" content="escape">
    <meta name="keywords" content="escape">
...
<a accesskey="p" href="language.modifier.default.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 5. 变量修饰器</th>
<td width="20%" align="right"> <a accesskey="n" href="language.modifier.from_charset.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
    <code class="varname">escape</code>可用于将变量编码或转换成
	<code class="literal">html</code>,
     <code class="literal">url</code>, <code class="literal">单引号</code>,
     <code class="literal">十六进制</code>, <code class="literal">十六进制实体</code>,
     <code class="literal">javascript</code> 和 <code class="literal">电邮地址</code>。
     默认是：<code class="literal">html</code>。
  </p>
...
<code class="literal">html</code>, <code class="literal">htmlall</code>,
              <code class="literal">url</code>,
               <code class="literal">urlpathinfo</code>, <code class="literal">单引号</code>,
               <code class="literal">十六进制</code>, <code class="literal">十六进制实体</code>,
               <code class="literal">javascript</code>, <code class="literal">电邮地址</code>
       </td>
<td align="center"><code class="literal">html</code></td>
<td>这是escape转换后的格式</td>
</tr>
<tr>
...
<code class="literal">ISO-8859-1</code>, <code class="literal">UTF-8</code>,
	  和其他<a class="ulink" href="../../../www.php.net/htmlentities/index.htm" target="_top">
      <code class="varname">htmlentities()</code></a>支持的字符集
      </td>
<td align="center"><code class="literal">UTF-8</code></td>
<td>传递给htmlentities()的字符集类型</td>
</tr>
<tr>
...
<td>两次转换实体，&amp;amp; 到 &amp;amp;amp; (仅在 <code class="literal">html</code> 和 <code class="literal">htmlall</code> 使用)</td>
</tr>
</tbody>
</table></div>
<div class="example">
<a name="id415268"></a><p class="title"><b>Example 5.10. escape</b></p>
...
<p>
   下面是<code class="literal">escape</code>的例子和输出：
   </p>
<pre class="programlisting">
...
<a name="id415299"></a><p class="title"><b>Example 5.11. escape的另一个例子</b></p>
<div class="example-contents">
<pre class="screen">
...
<p>这个方法很适合用在电邮地址上，另外可以参见
	  <a class="link" href="language.function.mailto.tpl" title="{mailto}">
      <code class="varname">{mailto}</code></a></p>
<pre class="screen">
...
<br class="example-break"><p>
   参见
   <a class="link" href="language.escaping.tpl" title="避免Smarty解析">Smarty编译转换</a>,
   <a class="link" href="language.function.mailto.tpl" title="{mailto}"><code class="varname">{mailto}</code></a>
   和
   <a class="link" href="tips.obfuscating.email.tpl" title="混淆电子邮件地址">混淆电邮地址</a>。
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="language.modifier.from_charset.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> from_charset</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 8 plus 2? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="1b8dae781194552a4dbccfd0185a7bc5">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.modifier.escape.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02215 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
