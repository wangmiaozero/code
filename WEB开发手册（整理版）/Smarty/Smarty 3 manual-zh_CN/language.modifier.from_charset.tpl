...
<html lang="en">
  <head>
    ...
    <title>from_charset | Smarty</title>
    <meta name="description" content="from_charset">
    <meta name="keywords" content="from_charset">
...
<tr><th colspan="3" align="center">from_charset</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.modifier.escape.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 5. 变量修饰器</th>
<td width="20%" align="right"> <a accesskey="n" href="language.modifier.indent.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="from_charset">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.modifier.from_charset"></a>from_charset</h2></div></div></div>
<p>
   <code class="varname">from_charset</code>转换变量到内置字符集。
   与<a class="link" href="language.modifier.to_charset.tpl" title="to_charset">to_charset 修饰器</a>刚好相反。
  </p>
...
<code class="literal">ISO-8859-1</code>, <code class="literal">UTF-8</code>或者任何
      ...
      <code class="varname">mb_convert_encoding()</code></a>函数支持的字符集名称。
      </td>
...
<td width="40%" align="right"> <a accesskey="n" href="language.modifier.indent.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">escape </td>
...
<td width="40%" align="right" valign="top"> indent</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 6 plus 9? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.modifier.from_charset.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02138 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
