...
<tr><th colspan="3" align="center">indent</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.modifier.from_charset.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 5. 变量修饰器</th>
<td width="20%" align="right"> <a accesskey="n" href="language.modifier.lower.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="indent">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.modifier.indent"></a>indent</h2></div></div></div>
<p>
	缩进每一行的字符串，默认是缩进4个空格。
	可选的参数可以设置缩进的空格数量。
	可选的第二个参数设置缩进使用的字符，如用 <code class="literal">"\t"</code>
	来代替空格缩进。
  </p>
...
<div class="example">
<a name="id416283"></a><p class="title"><b>Example 5.12. indent</b></p>
...
<br class="example-break"><p>
   参见
   <a class="link" href="language.modifier.strip.tpl" title="strip"><code class="varname">strip</code></a>,
   <a class="link" href="language.modifier.wordwrap.tpl" title="wordwrap"><code class="varname">wordwrap</code></a>
   和
   <a class="link" href="language.modifier.spacify.tpl" title="spacify"><code class="varname">spacify</code></a>.
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="language.modifier.lower.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">from_charset </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> lower</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 15 plus 14? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.modifier.indent.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02725 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
