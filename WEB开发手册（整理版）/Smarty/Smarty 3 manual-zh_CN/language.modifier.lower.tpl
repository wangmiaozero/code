...
<html lang="en">
  <head>
    ...
    <title>lower | Smarty</title>
    <meta name="description" content="lower">
    <meta name="keywords" content="lower">
...
<tr><th colspan="3" align="center">lower</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.modifier.indent.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 5. 变量修饰器</th>
<td width="20%" align="right"> <a accesskey="n" href="language.modifier.nl2br.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="lower">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.modifier.lower"></a>lower</h2></div></div></div>
<p>
  将变量值转成小写字母。
   等同于PHP的<a class="ulink" href="../../../www.php.net/strtolower/index.htm" target="_top">
   <code class="varname">strtolower()</code></a>函数。
  </p>
<div class="example">
<a name="id416170"></a><p class="title"><b>Example 5.13. lower</b></p>
...
<br class="example-break"><p>
  参见
   ...
   和
   <a class="link" href="language.modifiers.tpl#language.modifier.capitalize" title="capitalize"><code class="varname">capitalize</code></a>.
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="language.modifier.nl2br.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">indent </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> nl2br</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.modifier.lower.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02430 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
