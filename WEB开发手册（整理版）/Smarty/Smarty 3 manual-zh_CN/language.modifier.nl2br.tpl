...
<html lang="en">
  <head>
    ...
    <meta name="description" content="nl2br">
    <meta name="keywords" content="nl2br">
...
<p>
  将变量值中的<code class="literal">"\n"</code>回车全部转换成HTML的
  <code class="literal">&lt;br /&gt;</code>。
  等同于PHP的<a class="ulink" href="../../../www.php.net/nl2br/index.htm" target="_top">
   <code class="varname">nl2br()</code></a>函数。
  </p>
<div class="example">
<a name="id416428"></a><p class="title"><b>Example 5.14. nl2br</b></p>
...
<td width="40%" align="right" valign="top"> regex_replace</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.modifier.nl2br.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03130 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
