...
<html lang="en">
  <head>
    ...
    <title>regex_replace | Smarty</title>
    <meta name="description" content="regex_replace">
    <meta name="keywords" content="regex_replace">
...
<a accesskey="p" href="language.modifier.nl2br.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 5. 变量修饰器</th>
<td width="20%" align="right"> <a accesskey="n" href="language.modifier.replace.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
	用正则表达式搜索和替换变量值。
	使用PHP的<a class="ulink" href="../../../www.php.net/preg_replace/index.htm" target="_top">
     <code class="varname">preg_replace()</code></a>函数进行。
  </p>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
<p>
  虽然Smarty提供了较方便的正则表达式修饰器，
  但通常更好的方式是通过自定义函数或自定义修饰器在PHP端进行正则匹配替换。
  正则表达式是程序应用代码，不是显示的逻辑代码。
  </p>
</div>
<p>Parameters</p>
...
<div class="example">
<a name="id417096"></a><p class="title"><b>Example 5.15. regex_replace</b></p>
...
<br class="example-break"><p>
   参见<a class="link" href="language.modifier.replace.tpl" title="replace">
...
<td width="40%" align="right"> <a accesskey="n" href="language.modifier.replace.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> replace</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 19 plus 13? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.modifier.regex.replace.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02260 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
