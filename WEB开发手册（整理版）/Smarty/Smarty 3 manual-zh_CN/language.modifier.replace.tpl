...
<tr><th colspan="3" align="center">replace</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.modifier.regex.replace.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 5. 变量修饰器</th>
<td width="20%" align="right"> <a accesskey="n" href="language.modifier.spacify.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="replace">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.modifier.replace"></a>replace</h2></div></div></div>
<p>
	对变量进行简单的搜索和替换。
	等同于PHP函数的
     <a class="ulink" href="../../../www.php.net/str_replace/index.htm" target="_top">
     <code class="varname">str_replace()</code></a>。
  </p>
...
<div class="example">
<a name="id417513"></a><p class="title"><b>Example 5.16. replace</b></p>
...
<br class="example-break"><p>
   参见
   <a class="link" href="language.modifier.regex.replace.tpl" title="regex_replace"><code class="varname">regex_replace</code></a>
   和
   <a class="link" href="language.modifier.escape.tpl" title="escape"><code class="varname">escape</code></a>.
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="language.modifier.spacify.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">regex_replace </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> spacify</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.modifier.replace.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02238 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
