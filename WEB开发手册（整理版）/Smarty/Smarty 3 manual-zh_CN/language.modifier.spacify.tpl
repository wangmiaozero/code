...
<html lang="en">
  <head>
    ...
    <title>spacify | Smarty</title>
    <meta name="description" content="spacify">
    <meta name="keywords" content="spacify">
...
<tr><th colspan="3" align="center">spacify</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.modifier.replace.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 5. 变量修饰器</th>
<td width="20%" align="right"> <a accesskey="n" href="language.modifier.string.format.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="spacify">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.modifier.spacify"></a>spacify</h2></div></div></div>
<p>
     <code class="varname">spacify</code>会在变量的字符串中插入空格。
	 你可以设置插入的是空格或者别的字符。
  </p>
...
<div class="example">
<a name="id417891"></a><p class="title"><b>Example 5.17. spacify</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="language.modifier.string.format.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">replace </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> string_format</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 16 plus 3? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.modifier.spacify.tpl">
            </form>
            </div>
          </div>
