...
<html lang="en">
  <head>
    ...
    <title>string_format | Smarty</title>
    <meta name="description" content="string_format">
    <meta name="keywords" content="string_format">
...
<tr><th colspan="3" align="center">string_format</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.modifier.spacify.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 5. 变量修饰器</th>
<td width="20%" align="right"> <a accesskey="n" href="language.modifier.strip.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="string_format">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.modifier.string.format"></a>string_format</h2></div></div></div>
<p>
	格式化字符串，如浮点数等。
     使用
     <a class="ulink" href="../../../www.php.net/sprintf/index.htm" target="_top"><code class="varname">sprintf()</code></a>的PHP函数来进行。
  </p>
...
<td>指定哪种格式 (sprintf)</td>
</tr></tbody>
</table></div>
<div class="example">
<a name="id418243"></a><p class="title"><b>Example 5.18. string_format</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="language.modifier.strip.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">spacify </td>
...
<td width="40%" align="right" valign="top"> strip</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.modifier.string.format.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02923 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
