...
<a accesskey="p" href="language.modifier.strip.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 5. 变量修饰器</th>
<td width="20%" align="right"> <a accesskey="n" href="language.modifier.to_charset.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
	去除标记等任何包含在<code class="literal">&lt;</code> 和 <code class="literal">&gt;中间的字符。</code>.
  </p>
...
<div class="example">
<a name="id418775"></a><p class="title"><b>Example 5.20. strip_tags</b></p>
...
<br class="example-break"><p>
 参见
  <a class="link" href="language.modifier.replace.tpl" title="replace"><code class="varname">replace</code></a>
  和
...
<td width="40%" align="right"> <a accesskey="n" href="language.modifier.to_charset.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">strip </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> to_charset</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 16 plus 18? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="dcd34fed81ee6b2e4b24efc38dc3e65a">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.modifier.strip.tags.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02708 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
