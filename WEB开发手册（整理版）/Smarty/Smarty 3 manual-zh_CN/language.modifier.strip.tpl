...
<a accesskey="p" href="language.modifier.string.format.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 5. 变量修饰器</th>
<td width="20%" align="right"> <a accesskey="n" href="language.modifier.strip.tags.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
   ...
   <a class="link" href="language.function.strip.tpl" title="{strip}"><code class="varname">{strip}</code></a> 函数。
   </p>
</div>
<div class="example">
<a name="id418503"></a><p class="title"><b>Example 5.19. strip</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="language.modifier.strip.tags.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> strip_tags</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.modifier.strip.tpl">
            </form>
            </div>
          </div>
