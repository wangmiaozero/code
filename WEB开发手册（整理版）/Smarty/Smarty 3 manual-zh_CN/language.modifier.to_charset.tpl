...
<html lang="en">
  <head>
    ...
    <title>to_charset | Smarty</title>
    <meta name="description" content="to_charset">
    <meta name="keywords" content="to_charset">
...
<tr><th colspan="3" align="center">to_charset</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.modifier.strip.tags.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 5. 变量修饰器</th>
<td width="20%" align="right"> <a accesskey="n" href="language.modifier.truncate.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="to_charset">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.modifier.to_charset"></a>to_charset</h2></div></div></div>
<p>
   <code class="varname">to_charset</code>可将变量值由当前内置字符集转换到指定字符集。 
   它是<a class="link" href="language.modifier.from_charset.tpl" title="from_charset">from_charset 修饰器</a>的相反操作。
  </p>
...
<td align="center">
<code class="literal">ISO-8859-1</code>, <code class="literal">UTF-8</code>或者任何
      <a class="ulink" href="../../../www.php.net/mb_convert_encoding/index.htm" target="_top">
      <code class="varname">mb_convert_encoding()</code></a>函数允许的字符集名。
      </td>
...
<p>
   字符集转换应该由应用程序本身进行。
   该修饰器只在应用程序不确定变量是否需要转字符集的时候使用。
   </p>
</div>
<p>
   参见
   <a class="link" href="charset.tpl" title="Chapter 11. 字符集编码">字符集</a>,
   <a class="link" href="language.modifier.from_charset.tpl" title="from_charset">from_charset 修饰器</a>.
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="language.modifier.truncate.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">strip_tags </td>
...
<td width="40%" align="right" valign="top"> truncate</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.modifier.to_charset.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02206 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
