...
<tr><th colspan="3" align="center">truncate</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.modifier.to_charset.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 5. 变量修饰器</th>
<td width="20%" align="right"> <a accesskey="n" href="language.modifier.unescape.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="truncate">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.modifier.truncate"></a>truncate</h2></div></div></div>
<p>
	截取字符串到指定长度，默认长度是80.
	第二个参数可选，指定了截取后代替显示的字符。
	截取后的字符长度是截取规定的长度加上第二个参数的字符长度。
  默认<code class="varname">truncate</code>会尝试按单词进行截取。
如果你希望按字符截取（单词可能会被截断），需要设置第三个参数<code class="constant">TRUE</code>。
  </p>
...
<td>
	  是否按单词截取<code class="constant">FALSE</code>，或是按字符截取<code class="constant">TRUE</code>。</td>
</tr>
<tr>
...
<td align="center"><code class="constant">FALSE</code></td>
<td>
	  当字符截取的长度刚好等于字符本身长度时，是否截取。
	  <code class="constant">FALSE</code>也会截取。 <code class="constant">TRUE</code>是不会截取。
	  注意如果设置为<code class="constant">TRUE</code>，单词的边界会被忽略。
      </td>
</tr>
</tbody>
</table></div>
<div class="example">
<a name="id419585"></a><p class="title"><b>Example 5.21. truncate</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="language.modifier.unescape.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">to_charset </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> unescape</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.modifier.truncate.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02689 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
