...
<html lang="en">
  <head>
    ...
    <title>unescape | Smarty</title>
    <meta name="description" content="unescape">
    <meta name="keywords" content="unescape">
...
<a accesskey="p" href="language.modifier.truncate.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 5. 变量修饰器</th>
<td width="20%" align="right"> <a accesskey="n" href="language.modifier.upper.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
	 ...
	 它与<a class="link" href="language.modifier.escape.tpl" title="escape">escape 修饰器</a>的效果刚好相反。
    </p>
...
<code class="literal">ISO-8859-1</code>, <code class="literal">UTF-8</code>,
      或者任何
      <a class="ulink" href="../../../www.php.net/htmlentities/index.htm" target="_top">
...
<div class="example">
<a name="id420101"></a><p class="title"><b>Example 5.22. escape</b></p>
...
<br class="example-break"><p>
   ...
   <a class="link" href="language.modifier.escape.tpl" title="escape">escape 修饰器</a>.
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="language.modifier.upper.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> upper</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 15 plus 20? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.modifier.unescape.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02775 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
