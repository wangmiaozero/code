...
<html lang="en">
  <head>
    ...
    <title>upper | Smarty</title>
    <meta name="description" content="upper">
    <meta name="keywords" content="upper">
...
<tr><th colspan="3" align="center">upper</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.modifier.unescape.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 5. 变量修饰器</th>
<td width="20%" align="right"> <a accesskey="n" href="language.modifier.wordwrap.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="upper">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.modifier.upper"></a>upper</h2></div></div></div>
<p>
  将变量值转成大写字母。
   等同于PHP的<a class="ulink" href="../../../www.php.net/strtoupper/index.htm" target="_top">
   <code class="varname">strtoupper()</code></a>函数。
  </p>
<div class="example">
<a name="id420185"></a><p class="title"><b>Example 5.23. upper</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="language.modifier.wordwrap.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">unescape </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> wordwrap</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.modifier.upper.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02127 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
