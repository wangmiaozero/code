...
<html lang="en">
  <head>
    ...
    <title>wordwrap | Smarty</title>
    <meta name="description" content="wordwrap">
    <meta name="keywords" content="wordwrap">
...
<a accesskey="p" href="language.modifier.upper.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 5. 变量修饰器</th>
<td width="20%" align="right"> <a accesskey="n" href="language.combining.modifiers.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
	限制一行字符的长度（自动换行），默认是80个字符长度。
     可选的第二个参数，可自定义换行字符，默认换行字符是
	 <code class="literal">"\n"</code>。
	 默认情况下，是根据单词来换行的，也就是按英文语法的<code class="varname">自动换行</code>。 
	 如果你希望按照字符来换行（边界的单词将拆开），那么可以设置
	 可选的第三个参数为<code class="constant">TRUE</code>，效果与PHP函数<a class="ulink" href="../../../www.php.net/wordwrap/index.htm" target="_top"><code class="varname">wordwrap()</code></a>一样。
  </p>
...
<td>
	  设置按单词换行(<code class="constant">FALSE</code>)，或者按字符换行(<code class="constant">TRUE</code>)。</td>
</tr>
</tbody>
</table></div>
<div class="example">
<a name="id420798"></a><p class="title"><b>Example 5.24. wordwrap</b></p>
...
<br class="example-break"><p>
   参见
   <a class="link" href="language.modifier.nl2br.tpl" title="nl2br"><code class="varname">nl2br</code></a>
   和
...
<td width="40%" align="right"> <a accesskey="n" href="language.combining.modifiers.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">upper </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 6. 复合修饰器</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 19 plus 0? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.modifier.wordwrap.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02217 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
