...
<tr><th colspan="3" align="center">属性</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.syntax.functions.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 3. 基本语法</th>
<td width="20%" align="right"> <a accesskey="n" href="language.syntax.quotes.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="属性">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.syntax.attributes"></a>属性</h2></div></div></div>
<p>
 大多数<a class="link" href="language.syntax.functions.tpl" title="函数">函数</a>
 都会使用属性来定义或者修改它们的行为。
 Smarty函数中的属性比较像HTML语法中的属性。
  静态值不需要引号引起来，但必须是纯字符串。
  带或不带修饰器的变量都可以使用，而且也不需要引号，
  甚至可以使用PHP函数的结果，插件结果和复杂的表达式。
 </p>
<p>
 一些属性要求布尔值(<code class="constant">TRUE</code> 或 <code class="constant">FALSE</code>)。
 它们可以直接写成<code class="literal">true</code> 和 <code class="literal">false</code>。
  如果属性没有被赋值，那么它会将true作为默认值。
 </p>
<div class="example">
<a name="id406644"></a><p class="title"><b>Example 3.4. 函数属性语法</b></p>
...
<p>
 虽然Smarty可以处理很复杂的表达式和语法，但是最好的方式还是
 保持模板语法的简洁，模板层专注于显示。
 如果发现你的模板语法过于复杂，那么建议是将这些逻辑代码写到PHP里，
 然后在模板中通过插件或者修饰器来调用。
 </p>
</div>
</div>
...
<td width="40%" align="right"> <a accesskey="n" href="language.syntax.quotes.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">函数 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 双引号中嵌入变量</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.syntax.attributes.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02589 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
