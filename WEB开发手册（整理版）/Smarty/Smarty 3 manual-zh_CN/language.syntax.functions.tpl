...
<tr><th colspan="3" align="center">函数</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.syntax.variables.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 3. 基本语法</th>
<td width="20%" align="right"> <a accesskey="n" href="language.syntax.attributes.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="函数">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.syntax.functions"></a>函数</h2></div></div></div>
<p>
 每个Smarty的标签都可以是显示一个
 <a class="link" href="language.variables.tpl" title="Chapter 4. 变量">变量</a>或者调用
	某种类型的函数。
	调用和显示的方式是在定界符内包含了函数，和其
	<a class="link" href="language.syntax.attributes.tpl" title="属性">属性</a>，
	如：<code class="literal">{funcname attr1="val1" attr2="val2"}</code>.
 </p>
<div class="example">
<a name="id406342"></a><p class="title"><b>Example 3.3. 函数语法</b></p>
...
<li class="listitem"><p>
 包括<a class="link" href="language.builtin.functions.tpl" title="Chapter 7. 内置函数">内置函数</a>
  和<a class="link" href="language.custom.functions.tpl" title="Chapter 8. 自定义函数">自定义函数</a>
  都是用同样的语法调用。
  </p></li>
<li class="listitem"><p>内置函数是工作在Smarty
  <span class="bold"><strong>内部</strong></span>的函数, 类似
  <a class="link" href="language.function.if.tpl" title="{if},{elseif},{else}"><code class="varname">{if}</code></a>,
  <a class="link" href="language.function.section.tpl" title="{section},{sectionelse}"><code class="varname">{section}</code></a>和
  <a class="link" href="language.function.strip.tpl" title="{strip}"><code class="varname">{strip}</code></a>等等。
  它们不需要进行修改或者改变。
  </p></li>
<li class="listitem"><p>
  自定义函数是通过<a class="link" href="plugins.tpl" title="Chapter 18. 以插件扩展Smarty">插件</a>定义的
  <span class="bold"><strong>额外的</strong></span>函数。
  你可以任意修改自定义函数，或者创建一个新的函数。
  <a class="link" href="language.function.html.options.tpl" title="{html_options}">
  <code class="varname">{html_options}</code></a>就是一个自定义函数的例子。
 </p></li>
</ul></div>
<p>
 参见<a class="link" href="api.register.plugin.tpl" title="registerPlugin()"><code class="varname">registerPlugin()</code></a>
 </p>
</div>
<div class="navfooter">
<hr>
...
<a accesskey="p" href="language.syntax.variables.tpl">Prev</a> </td>
<td width="20%" align="center"><a accesskey="u" href="language.basic.syntax.tpl">Up</a></td>
<td width="40%" align="right"> <a accesskey="n" href="language.syntax.attributes.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">变量 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 属性</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 13 plus 7? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.syntax.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01384 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
