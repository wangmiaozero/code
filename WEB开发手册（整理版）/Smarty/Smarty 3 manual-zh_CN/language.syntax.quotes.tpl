...
<html lang="en">
  <head>
    ...
    <title>双引号中嵌入变量 | Smarty</title>
    <meta name="description" content="双引号中嵌入变量">
...
<tr><th colspan="3" align="center">双引号中嵌入变量</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.syntax.attributes.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 3. 基本语法</th>
<td width="20%" align="right"> <a accesskey="n" href="language.math.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="双引号中嵌入变量">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.syntax.quotes"></a>双引号中嵌入变量</h2></div></div></div>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
 Smarty可以识别出在双引号中嵌套的
 <a class="link" href="language.syntax.variables.tpl" title="变量">变量</a><a class="link" href="api.assign.tpl" title="assign()">值</a>，这些变量名称必须只包括
  字母、数字和下划线。
  参见<a class="ulink" href="../../../www.php.net/language.variables" target="_top">命名规则</a>。
  </p></li>
<li class="listitem"><p>
  另外，带有其他字符的，如点号（.）或者
  <code class="literal">$object-&gt;reference</code>形式的变量，
  必须用<code class="literal">`单引号`</code>括起来。
  </p></li>
<li class="listitem"><p>
...
<div class="example">
<a name="id406905"></a><p class="title"><b>Example 3.5. 例子</b></p>
...
<a name="id407272"></a><p class="title"><b>Example 3.6. 例子</b></p>
<div class="example-contents"><pre class="programlisting">
...
<p>
 虽然Smarty能处理比较复杂的表达式和语法，但是最好保持模板语法的简洁，
 把关注的焦点放在显示层面。如果你发现模板语法非常复杂，那么
 最好把这些逻辑代码转移到插件或者修饰器上，用PHP代码进行编写。
 </p>
</div>
<p>
  参见<a class="link" href="language.modifier.escape.tpl" title="escape"><code class="varname">字符转换</code></a>。
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="language.math.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">属性 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 数学计算</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 13 plus 4? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.syntax.quotes.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02136 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
