...
<html lang="en">
  <head>
    ...
    <title>变量作用范围 | Smarty</title>
    <meta name="description" content="变量作用范围">
...
<tr><th colspan="3" align="center">变量作用范围</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.variables.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 4. 变量</th>
<td width="20%" align="right"> <a accesskey="n" href="language.config.variables.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="变量作用范围">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.variable.scopes"></a>变量作用范围</h2></div></div></div>
<p>
   你可以设置Smarty对象、通过<a class="link" href="api.create.data.tpl" title="createData()"><code class="varname">createData()</code></a>建立的对象、和<a class="link" href="api.create.template.tpl" title="createTemplate()"><code class="varname">createTemplate()</code></a>建立的对象的作用范围。
   这些对象可以连接使用。
   模板内可以使用全部由对象的变量和它们链条上的父对象的变量。
   </p>
<p>
   默认模板通过
   <a class="link" href="api.display.tpl" title="display()"><code class="varname">$smarty-&gt;display(...)</code></a>或
   <a class="link" href="api.fetch.tpl" title="fetch()"><code class="varname">$smarty-&gt;fetch(...)</code></a>调用，可获取到Smarty对象范围的变量。
   </p>
<p>
...
<div class="example">
<a name="id409324"></a><p class="title"><b>Example 4.6. 变量范围的例子</b></p>
...
<p>
    ...
    <a class="link" href="api.create.data.tpl" title="createData()"><code class="varname">createData()</code></a>和
    <a class="link" href="api.create.template.tpl" title="createTemplate()"><code class="varname">createTemplate()</code></a>.
</p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="language.config.variables.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">Chapter 4. 变量 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 从配置文件获取的变量</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/language.variable.scopes.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01898 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
