...
<html lang="en">
  <head>
    ...
    <title>编译函数 | Smarty</title>
    <meta name="description" content="编译函数">
...
<tr><th colspan="3" align="center">编译函数</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="plugins.block.functions.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 18. 以插件扩展Smarty</th>
<td width="20%" align="right"> <a accesskey="n" href="plugins.prefilters.postfilters.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="编译函数">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.compiler.functions"></a>编译函数</h2></div></div></div>
<p>
	编译函数仅会在模板的编译过程中调用，
	它对模板嵌入PHP代码或者对时间敏感的内容时比较有用。
     如果同时存在编译函数和
     <a class="link" href="language.custom.functions.tpl" title="Chapter 8. 自定义函数">自定义函数</a>，那么编译函数会优先使用。
    </p>
...
<p>
	编译函数有两个参数：已预编译的变量字符串数组，及Smarty对象。
	该函数将会返回嵌入到模板的PHP代码。
    </p>
<div class="example">
<a name="id526390"></a><p class="title"><b>Example 18.6. 一个简单的编译函数</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="plugins.prefilters.postfilters.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">块函数 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 前置/后置过滤器</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/plugins.compiler.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02214 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
