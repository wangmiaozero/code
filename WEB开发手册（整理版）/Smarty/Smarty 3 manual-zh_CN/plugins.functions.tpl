...
<html lang="en">
  <head>
    ...
    <title>模板函数 | Smarty</title>
    <meta name="description" content="模板函数">
...
<tr><th colspan="3" align="center">模板函数</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="plugins.writing.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 18. 以插件扩展Smarty</th>
<td width="20%" align="right"> <a accesskey="n" href="plugins.modifiers.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="模板函数">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.functions"></a>模板函数</h2></div></div></div>
...
<code>array <var class="pdparam">$params</var></code>;<br><code>object <var class="pdparam">$template</var></code>;</div>
<div class="funcprototype-spacer"> </div>
</div>
<p>
	模板传递到函数的参数<a class="link" href="language.syntax.attributes.tpl" title="属性">变量</a>，
	都包含在<em class="parameter"><code>$params</code></em>数组内。
    </p>
<p>
	函数输出（返回值）的内容将替代函数标签调用的位置，
	如<a class="link" href="language.function.fetch.tpl" title="{fetch}"><code class="varname">{fetch}</code></a>函数。
	同时，函数也可以仅执行一些任务而没有输出，如<a class="link" href="language.function.assign.tpl" title="{assign}">
     <code class="varname">{assign}</code></a>函数。
    </p>
<p>
	如果函数中对模板赋值，或使用其他Smarty提供的功能，
	可以通过 <em class="parameter"><code>$template</code></em>对象来进行，
	例如<code class="literal">$template-&gt;foo()</code>。
    </p>
<p>
     </p>
<div class="example">
<a name="id525249"></a><p class="title"><b>Example 18.1. 带输出的函数插件</b></p>
...
<div class="example">
<a name="id525287"></a><p class="title"><b>Example 18.2. 不带输出的函数插件</b></p>
<div class="example-contents"><pre class="programlisting">
...
<td width="40%" align="right"> <a accesskey="n" href="plugins.modifiers.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">编写插件 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 修饰器</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 0 plus 20? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/plugins.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02239 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
