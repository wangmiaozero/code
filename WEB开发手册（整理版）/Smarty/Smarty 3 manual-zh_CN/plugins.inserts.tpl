...
<html lang="en">
  <head>
    ...
    <title>插入插件 | Smarty</title>
    <meta name="description" content="插入插件">
...
<tr><th colspan="3" align="center">插入插件</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="plugins.resources.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 18. 以插件扩展Smarty</th>
<td width="20%" align="right"> <a accesskey="n" href="bc.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="插入插件">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.inserts"></a>插入插件</h2></div></div></div>
<p>
	插入插件是用来实现模板中<a class="link" href="language.function.insert.tpl" title="{insert}"><code class="varname">{insert}</code></a>标签的调用。
    </p>
...
<p>
	插入函数将会返回某值，该值将在模板中的<code class="varname">{insert}</code>标签处被替换。
    </p>
<div class="example">
<a name="id527594"></a><p class="title"><b>Example 18.11. 插入插件</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="bc.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">资源插件 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 19. SmartyBC - 向前兼容的类库</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/plugins.inserts.tpl">
            </form>
            </div>
          </div>
