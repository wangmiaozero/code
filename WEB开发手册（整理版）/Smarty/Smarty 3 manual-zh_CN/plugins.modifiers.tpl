...
<tr><th colspan="3" align="center">修饰器</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="plugins.functions.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 18. 以插件扩展Smarty</th>
<td width="20%" align="right"> <a accesskey="n" href="plugins.block.functions.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="修饰器">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.modifiers"></a>修饰器</h2></div></div></div>
<p>
     <a class="link" href="language.modifiers.tpl" title="Chapter 5. 变量修饰器">修饰器</a>是一些小函数，
	 它们会对模板中的变量，在显示之前或使用前进行处理。
	修饰器可以连用。
    </p>
...
<p>
	第一个参数是修饰器所修饰的变量值。
	余下的参数是可选的，它们是附加传递给修饰器的参数。
    </p>
<p>
	修饰器必须<a class="ulink" href="../../../www.php.net/return/index.htm" target="_top">return</a>处理的结果。
    </p>
<div class="example">
<a name="id525599"></a><p class="title"><b>Example 18.3. 一个简单的修饰器</b></p>
...
<div class="example">
<a name="id525627"></a><p class="title"><b>Example 18.4. 更复杂的修饰器</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="plugins.block.functions.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">模板函数 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 块函数</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/plugins.modifiers.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03007 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
