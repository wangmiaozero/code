...
<html lang="en">
  <head>
    ...
    <title>命名规则 | Smarty</title>
    <meta name="description" content="命名规则">
...
<tr><th colspan="3" align="center">命名规则</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="plugins.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 18. 以插件扩展Smarty</th>
<td width="20%" align="right"> <a accesskey="n" href="plugins.writing.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="命名规则">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.naming.conventions"></a>命名规则</h2></div></div></div>
<p>
	插件文件和函数必须遵循特定的命名规则以便Smarty识别。 
    </p>
<p>
     <span class="bold"><strong>插件文件</strong></span>命名规则：
     </p>
...
<li class="listitem">
<p>
	其中<code class="literal">type</code>是以下任一种插件类型：
     </p>
...
<li class="listitem"><p>
	<code class="literal">name</code>必须是合法的函数名（仅包括字母、数字和下划线），参考
     <a class="ulink" href="../../../www.php.net/language.variables" target="_top">php variables</a>。
    </p></li>
<li class="listitem"><p>
     例如： <code class="filename">function.html_select_date.php</code>,
     <code class="filename">resource.db.php</code>,
     <code class="filename">modifier.spacify.php</code>.
    </p></li>
</ul></div>
<p>
     PHP文件内的<span class="bold"><strong>插件函数</strong></span>命名规则： 
     </p>
<div class="blockquote"><blockquote class="blockquote"><p>
...
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
	 <code class="literal">type</code> 和 <code class="literal">name</code>规则同上。
    </p></li>
<li class="listitem"><p>
	  例如一个修饰器名称为 <code class="varname">foo</code>，函数名就是 <code class="literal">function smarty_modifier_foo()</code>。
    </p></li>
</ul></div>
<p>
...
<td width="40%" align="right"> <a accesskey="n" href="plugins.writing.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">Chapter 18. 以插件扩展Smarty </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 编写插件</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 5 plus 9? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/plugins.naming.conventions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02961 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
