...
<a accesskey="p" href="plugins.prefilters.postfilters.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 18. 以插件扩展Smarty</th>
<td width="20%" align="right"> <a accesskey="n" href="plugins.resources.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<a name="plugins.outputfilters"></a>输出过滤器</h2></div></div></div>
<p>
	输出过滤器将处理模板的输出内容，
	执行的时机是在模板载入并执行之后，但在内容显示之前。
    </p>
...
<p>
	第一个参数是将会被处理的输出内容，
	第二个参数是调用该函数的Smarty实例。
	插件会对内容进行处理并返回结果。
    </p>
<div class="example">
<a name="id526991"></a><p class="title"><b>Example 18.9. 输出过滤器</b></p>
...
<br class="example-break"><p>
     参见：
     <a class="link" href="api.register.filter.tpl" title="registerFilter()">
     <code class="varname">registerFilter()</code></a>,
     <a class="link" href="api.unregister.filter.tpl" title="unregisterFilter()">
...
<td width="40%" align="right"> <a accesskey="n" href="plugins.resources.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">前置/后置过滤器 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 资源插件</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 4 plus 3? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/plugins.outputfilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02511 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
