...
<html lang="en">
  <head>
    ...
    <title>前置/后置过滤器 | Smarty</title>
    <meta name="description" content="前置/后置过滤器">
...
<tr><th colspan="3" align="center">前置/后置过滤器</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="plugins.compiler.functions.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 18. 以插件扩展Smarty</th>
<td width="20%" align="right"> <a accesskey="n" href="plugins.outputfilters.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="前置/后置过滤器">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.prefilters.postfilters"></a>前置/后置过滤器</h2></div></div></div>
<p>
...
<p>
	前置过滤器是在模板源码被编译前的时刻执行。
	第一个参数是模板源码，源码可能已被其他过滤器处理过的。
	前置过滤器插件将处理并返回过滤后的源码。
	注意这些返回的源码不会被保存，它们仅提供给编译使用。
    </p>
<div class="funcsynopsis">
<table border="0" summary="Function synopsis" cellspacing="0" cellpadding="0" class="funcprototype-table">
<tr>
...
<p>
	后置过滤器会在编译器已经把模板编译完成，但未保存到文件系统的时候执行。
	第一个参数是已编译的代码，代码可能被其他过滤器处理过的。
	后置过滤器将进行处理并返回处理后的代码。
    </p>
<div class="example">
<a name="id526692"></a><p class="title"><b>Example 18.7. 前置过滤器</b></p>
...
<div class="example">
<a name="id526708"></a><p class="title"><b>Example 18.8. 后置过滤器</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
     ...
     <code class="varname">registerFilter()</code></a> 和
...
<td width="40%" align="right"> <a accesskey="n" href="plugins.outputfilters.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">编译函数 </td>
...
<td width="40%" align="right" valign="top"> 输出过滤器</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/plugins.prefilters.postfilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02342 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
