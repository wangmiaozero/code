...
<html lang="en">
  <head>
    ...
    <title>资源插件 | Smarty</title>
    <meta name="description" content="资源插件">
...
<tr><th colspan="3" align="center">资源插件</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="plugins.outputfilters.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 18. 以插件扩展Smarty</th>
<td width="20%" align="right"> <a accesskey="n" href="plugins.inserts.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="资源插件">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.resources"></a>资源插件</h2></div></div></div>
<p>
	资源插件被认为是为Smarty提供特定的模板源或PHP组件的一种通常的方式。
	例如一些资源如：数据库、LDAP、共享内存、sockets等。
    </p>
<p>
	资源插件可以是在<a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir"><code class="varname">$plugins_dir</code></a>
	目录中的一个文件（如<code class="literal">resource.foobarxyz.php</code>），
	或在运行时通过<a class="link" href="api.register.resource.tpl" title="registerResource()"><code class="varname">registerResource()</code></a>来注册。
	两种方式你可以通过在模板中用<code class="literal">foobarxyz:yourtemplate.tpl</code>方式来获取到资源。
	</p>
<p>
	如果资源模板是不希望经Smarty编译器来处理的，
	那么该资源插件应该是继承于<code class="literal">Smarty_Resource_Uncompiled</code>。
	该资源的处理程序必须实现<code class="literal">renderUncompiled(Smarty_Internal_Template $_template)</code>函数。
	
	<code class="varname">$_template</code>是引用值，包含了当前模板的全部变量，
	这些变量值都可以通过<code class="literal">$_template-&gt;smarty-&gt;getTemplateVars()</code>来进行存取。

	这些资源可以简单地echo它们渲染的内容到输出流。
	如果Smarty设置了输出缓存，这些输出内容将被输出缓存捕获。

	参见例子：<code class="literal">libs/sysplugins/smarty_internal_resource_php.php</code>。
	</p>
<p>
	如果资源插件的模板不能被缓存到磁盘，
	那么该资源插件应该是继承于<code class="literal">Smarty_Resource_Recompiled</code>。
	这些资源将在每次访问的时候都被编译，这会是不小的资源开销。
	
	参见例子：<code class="literal">libs/sysplugins/smarty_internal_resource_eval.php</code>。
	</p>
<div class="example">
<a name="id527253"></a><p class="title"><b>Example 18.10. 资源插件</b></p>
...
<br class="example-break"><p>
 参见：
 <a class="link" href="api.register.resource.tpl" title="registerResource()"><code class="varname">registerResource()</code></a>,
 <a class="link" href="api.unregister.resource.tpl" title="unregisterResource()"><code class="varname">unregisterResource()</code></a>.
</p>
</div>
<div class="navfooter">
<hr>
...
<a accesskey="p" href="plugins.outputfilters.tpl">Prev</a> </td>
<td width="20%" align="center"><a accesskey="u" href="plugins.tpl">Up</a></td>
<td width="40%" align="right"> <a accesskey="n" href="plugins.inserts.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">输出过滤器 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 插入插件</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 2 plus 5? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="e7c016047463d7b432af4ec966910318">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/plugins.resources.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02448 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
