...
<html lang="en">
  <head>
    ...
    <title>Chapter 18. 以插件扩展Smarty | Smarty</title>
    <meta name="description" content="Chapter 18. 以插件扩展Smarty">
    <meta name="keywords" content="chapter, 18, smarty">
...
<tr><th colspan="3" align="center">Chapter 18. 以插件扩展Smarty</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="advanced.features.outputfilters.tpl">Prev</a> </td>
<th width="60%" align="center">Part III. 程序开发者篇</th>
<td width="20%" align="right"> <a accesskey="n" href="plugins.naming.conventions.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="chapter" title="Chapter 18. 以插件扩展Smarty">
<div class="titlepage"><div><div><h2 class="title">
<a name="plugins"></a>Chapter 18. 以插件扩展Smarty</h2></div></div></div>
<div class="toc">
...
<p>
  Smarty 2.0引入的插件架构，已经成为了Smarty最常使用的自定义功能了。
   插件包含了：
   </p>
...
<p>
   除了资源插件以外，为了向上兼容还是保留了通过register_* API来注册插件的方式。
   如果你不是使用API方式而是使用直接修改<code class="literal">$custom_funcs</code>, <code class="literal">$custom_mods</code>等方式，那么你需要调整你的代码，改为通过API方式或
   转换成自定义插件。
  </p>
<div class="sect1" title="插件如何工作">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.howto"></a>插件如何工作</h2></div></div></div>
<p>
   插件是按需载入的。当特定的修饰器，函数，资源等被调用的时候插件才会被载入。
   而且，即使同一请求中有多个Smarty实例在运行，每个资源也只会被载入一次。
   </p>
<p>
   前置/后置过滤器和输出过滤器稍微有些不同。
   虽然它们并没有在模板中使用，但是当模板执行的时候，它们必须通过API被注册或者被明确载入。
   相同类型的过滤器执行的顺序会依据它们注册或载入的先后顺序。
   </p>
<p>
   <a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir">插件目录</a>变量可以是一个路径的字符串或者是包含多个路径的数组。
   安装插件的方法是直接把插件文件放置在这些目录下，Smarty会自动按需使用。
   </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="plugins.naming.conventions.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">输出过滤器 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 命名规则</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 0 plus 10? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/plugins.tpl">
            </form>
            </div>
          </div>
