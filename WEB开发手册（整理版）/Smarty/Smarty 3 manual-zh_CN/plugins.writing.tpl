...
<html lang="en">
  <head>
    ...
    <title>编写插件 | Smarty</title>
    <meta name="description" content="编写插件">
...
<tr><th colspan="3" align="center">编写插件</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="plugins.naming.conventions.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 18. 以插件扩展Smarty</th>
<td width="20%" align="right"> <a accesskey="n" href="plugins.functions.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="编写插件">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.writing"></a>编写插件</h2></div></div></div>
<p>
	插件可以让Smarty自动载入，或通过register_* API函数在运行时进行注册。
	它们还可以通过unregister_* API函数来注销。
    </p>
<p>
	当插件是运行时注册的，插件的名称不一定需要遵循下面的命名规则。
    </p>
<p>
	如果插件依赖与其他插件提供的功能时（如依赖与一些Smarty自带的插件），
	比较好的方法是像下面这样载入需要的插件：
    </p>
...
<p>
	一般而言，Smarty_Internal_Template对象将作为插件的最后一个参数传递，
	除了两种例外情况：
     </p>
...
<li class="listitem"><p>
	 为了向上兼容老版本的Smarty，区块插件将 <em class="parameter"><code>$repeat</code></em> 作为最后一个参数，因此Smarty对象是倒数第二个参数。
     </p></li>
</ul></div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="plugins.functions.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">命名规则 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 模板函数</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 4 plus 13? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/plugins.writing.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02740 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
