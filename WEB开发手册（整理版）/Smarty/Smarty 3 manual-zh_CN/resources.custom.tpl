...
<html lang="en">
  <head>
    ...
    <title>自定义模板资源 | Smarty</title>
    <meta name="description" content="自定义模板资源">
...
<tr><th colspan="3" align="center">自定义模板资源</th></tr>
<tr>
...
<div class="sect1" title="自定义模板资源">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="resources.custom"></a>自定义模板资源</h2></div></div></div>
<p>
	你可以通过任何可访问的来源来提供模板，如数据库，网络sockets，文件等，
	编写这些来源的资源插件并将他们注册到Smarty。
 </p>
<p>
  参见<a class="link" href="plugins.resources.tpl" title="资源插件">资源插件</a>。
 </p>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
<p>
	 注意你不能覆盖内置的<code class="literal">file:</code>资源，
	 但你可以设计一个基于文件系统的资源并为其注册另一个资源名称。
  </p>
</div>
<div class="example">
<a name="id517841"></a><p class="title"><b>Example 16.10. U使用自定义资源</b></p>
...
<tr>
<td width="40%" align="left" valign="top">扩展模板资源 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 17. 高级特性</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 1 plus 15? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/resources.custom.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02960 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
