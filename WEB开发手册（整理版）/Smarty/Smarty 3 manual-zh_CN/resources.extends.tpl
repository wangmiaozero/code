...
<html lang="en">
  <head>
    ...
    <title>扩展模板资源 | Smarty</title>
    <meta name="description" content="扩展模板资源">
...
<tr><th colspan="3" align="center">扩展模板资源</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="resources.streams.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 16. 资源</th>
<td width="20%" align="right"> <a accesskey="n" href="resources.custom.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="扩展模板资源">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="resources.extends"></a>扩展模板资源</h2></div></div></div>
<p>
 <code class="literal">extends:</code>扩展资源使用在定义父/子关系的模板继承中。
 详情参见<a class="link" href="advanced.features.template.inheritance.tpl" title="模板继承">模板继承</a>。
 </p>
<p>
 Smarty 3.1后，<code class="literal">extends:</code>资源可以使用任何类型的
 <a class="link" href="resources.tpl" title="Chapter 16. 资源">资源</a>，
 包括<code class="literal">string:</code> 和 <code class="literal">eval:</code>。
 当使用<a class="link" href="resources.string.tpl" title="字符串资源">字符串资源</a>的时候，确保其已经被编码（URL编码或base64编码）。
 在继承链条中的<code class="literal">eval:</code>资源，
 “不保存编译文件”的特性将被<code class="literal">extends:</code>取代。
...
<p>
  当需要继承的时候使用这个。
	当在PHP代码中使用继承，子模板的覆盖看起来不是很明显。
	如果可以选择，这是一个更灵活和直接的方式来处理模板继承。
  </p>
</div>
<div class="example">
<a name="id518073"></a><p class="title"><b>Example 16.9. 使用模板继承</b></p>
...
<br class="example-break"><p>
  ...
  <a class="link" href="language.function.block.tpl" title="{block}"><code class="varname">{block}</code></a> 和
...
<td width="40%" align="right"> <a accesskey="n" href="resources.custom.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">数据流资源 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 自定义模板资源</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 8 plus 10? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/resources.extends.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02543 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
