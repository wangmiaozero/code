...
<html lang="en">
  <head>
    ...
    <title>数据流资源 | Smarty</title>
    <meta name="description" content="数据流资源">
...
<tr><th colspan="3" align="center">数据流资源</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="resources.string.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 16. 资源</th>
<td width="20%" align="right"> <a accesskey="n" href="resources.extends.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="数据流资源">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="resources.streams"></a>数据流资源</h2></div></div></div>
<p>
 可以将PHP的数据流作为一种模板资源。
 使用数据流和使用传统的资源类型差不多。
  </p>
<p>
  Smarty会先寻找已注册的模板资源，如果找不到，
  则会检查该PHP数据流是否可用。
  如果PHP数据流可用，则通过数据流获取模板。
    </p>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
<p>你可以进一步定义数据流的安全机制。</p>
</div>
<p>
  </p>
<div class="example">
<a name="id517309"></a><p class="title"><b>Example 16.7. PHP数据流</b></p>
<div class="example-contents">
<p>display()函数使用了一个PHP数据流</p>
...
<a name="id517357"></a><p class="title"><b>Example 16.8. 模板中使用</b></p>
<div class="example-contents">
<p>在模板中使用PHP数据流</p>
<pre class="programlisting">
...
<td width="40%" align="right"> <a accesskey="n" href="resources.extends.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">字符串资源 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 扩展模板资源</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/resources.streams.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02516 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
