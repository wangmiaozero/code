...
<html lang="en">
  <head>
    ...
    <title>Chapter 12. 常量 | Smarty</title>
    <meta name="description" content="Chapter 12. 常量">
    <meta name="keywords" content="chapter, 12, ">
...
<tr><th colspan="3" align="center">Chapter 12. 常量</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="charset.tpl">Prev</a> </td>
<th width="60%" align="center">Part III. 程序开发者篇</th>
<td width="20%" align="right"> <a accesskey="n" href="api.variables.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="chapter" title="Chapter 12. 常量">
<div class="titlepage"><div><div><h2 class="title">
<a name="smarty.constants"></a>Chapter 12. 常量</h2></div></div></div>
<div class="toc">
<p><b>Table of Contents</b></p>
<dl><dt><span class="sect1"><a href="smarty.constants.tpl#constant.smarty.dir">SMARTY_DIR</a></span></dt></dl>
</div>
<div class="sect1" title="SMARTY_DIR">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="constant.smarty.dir"></a>SMARTY_DIR</h2></div></div></div>
<p>
	这是Smarty类文件的<span class="bold"><strong>系统路径</strong></span>。
	如果在你的程序中没有明确定义，则Smarty将自动获取适当的路径。
    如果定义了该路径，那么路径<span class="bold"><strong>必须以斜杠/结尾</strong></span>.
    </p>
<div class="example">
<a name="id476385"></a><p class="title"><b>Example 12.1. SMARTY_DIR</b></p>
...
<br class="example-break"><p>
  参考
  <a class="link" href="language.variables.smarty.tpl#language.variables.smarty.const" title="{$smarty.const}"><em class="parameter"><code>$smarty.const</code></em></a>
  和
  <a class="link" href="variable.php.handling.tpl" title="$php_handling"><em class="parameter"><code>$php_handling constants</code></em></a>
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="api.variables.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">Chapter 11. 字符集编码 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 13. Smarty成员变量</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/smarty.constants.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02688 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
