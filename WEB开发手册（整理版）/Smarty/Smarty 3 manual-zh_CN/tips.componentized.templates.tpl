...
<html lang="en">
  <head>
    ...
    <title>组件化模板 | Smarty</title>
    <meta name="description" content="组件化模板">
...
<tr><th colspan="3" align="center">组件化模板</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="tips.wap.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 21. 技巧</th>
<td width="20%" align="right"> <a accesskey="n" href="tips.obfuscating.email.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="组件化模板">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="tips.componentized.templates"></a>组件化模板</h2></div></div></div>
<p>
   传统来说，应用程序使用模板编程都按这样的方式：
   先在PHP程序中，将需要的变量都获取到 (可能还会通过数据库获取)，
   然后实例化Smarty对象，调用<a class="link" href="api.assign.tpl" title="assign()"><code class="varname">assign()</code></a>来赋值变量，并且<a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code></a>。
   好的，我们来看看模板上显示股票的例子吧。
...
<div class="example">
<a name="id530702"></a><p class="title"><b>Example 21.7. 组件化模板</b></p>
<div class="example-contents">
<p>
      <code class="filename">function.load_ticker.php</code> -
      文件在
      <a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir">
      <em class="parameter"><code>$plugins 目录</code></em></a>
    </p>
...
<td width="40%" align="right"> <a accesskey="n" href="tips.obfuscating.email.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">WAP/WML页面 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 混淆电子邮件地址</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 5 plus 16? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/tips.componentized.templates.tpl">
            </form>
            </div>
          </div>
