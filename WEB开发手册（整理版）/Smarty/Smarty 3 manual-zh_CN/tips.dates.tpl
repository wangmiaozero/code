...
<tr><th colspan="3" align="center">日期时间</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="tips.passing.vars.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 21. 技巧</th>
<td width="20%" align="right"> <a accesskey="n" href="tips.wap.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="日期时间">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="tips.dates"></a>日期时间</h2></div></div></div>
<p>
   一般经验而言，都是将<a class="ulink" href="../../../www.php.net/time/index.htm" target="_top">时间戳</a>作为日期时间值传递给Smarty。
   模板设计者可以使用<a class="link" href="language.modifier.date.format.tpl" title="date_format"><code class="varname">date_format</code>
    </a>修饰器来控制日期时间的显示格式，还可以在需要时进行日期的比较。 
   </p>
<div class="example">
<a name="id530377"></a><p class="title"><b>Example 21.4. 使用 date_format</b></p>
...
<br class="example-break"><p>
   当在模板内使用<a class="link" href="language.function.html.select.date.tpl" title="{html_select_date}">
    <code class="varname">{html_select_date}</code></a>,
  程序设计者会希望将输出的日期转换回时间戳。下面的函数可以做到这点：
   </p>
<div class="example">
<a name="id530441"></a><p class="title"><b>Example 21.5. 转换元件的日期为时间戳</b></p>
...
<br class="example-break"><p>
   参见
   <a class="link" href="language.function.html.select.date.tpl" title="{html_select_date}">
   <code class="varname">{html_select_date}</code></a>,
   <a class="link" href="language.function.html.select.time.tpl" title="{html_select_time}">
   <code class="varname">{html_select_time}</code></a>,
   <a class="link" href="language.modifier.date.format.tpl" title="date_format">
   <code class="varname">date_format</code></a>
   和 <a class="link" href="language.variables.smarty.tpl#language.variables.smarty.now" title="{$smarty.now}">
...
<td width="40%" align="right"> <a accesskey="n" href="tips.wap.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">传递标题到头部模板 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> WAP/WML页面</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/tips.dates.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02493 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
