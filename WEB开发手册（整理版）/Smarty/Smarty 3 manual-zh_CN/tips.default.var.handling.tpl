...
<html lang="en">
  <head>
    ...
    <title>默认变量处理 | Smarty</title>
    <meta name="description" content="默认变量处理">
...
<tr><th colspan="3" align="center">默认变量处理</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="tips.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 21. 技巧</th>
<td width="20%" align="right"> <a accesskey="n" href="tips.passing.vars.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="默认变量处理">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="tips.default.var.handling"></a>默认变量处理</h2></div></div></div>
<p>
   当一个变量在模板内经常使用，而每次使用都需要给它设置<a class="link" href="language.modifier.default.tpl" title="default"><code class="varname">default</code></a>修饰器时，这将会非常不优雅。
   你可以用<a class="link" href="language.function.assign.tpl" title="{assign}"><code class="varname">{assign}</code></a>函数来给变量赋一个默认值。
   </p>
<div class="example">
<a name="id530167"></a><p class="title"><b>Example 21.2. 给变量赋默认值</b></p>
...
<br class="example-break"><p>
    参见
    <a class="link" href="language.modifier.default.tpl" title="default"><code class="varname">default</code></a>修饰器和<a class="link" href="tips.tpl#tips.blank.var.handling" title="空变量的处理">空变量的处理</a>.
   </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="tips.passing.vars.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">Chapter 21. 技巧 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 传递标题到头部模板</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 5 plus 2? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/tips.default.var.handling.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02248 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
