...
<html lang="en">
  <head>
    ...
    <title>混淆电子邮件地址 | Smarty</title>
    <meta name="description" content="混淆电子邮件地址">
...
<tr><th colspan="3" align="center">混淆电子邮件地址</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="tips.componentized.templates.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 21. 技巧</th>
<td width="20%" align="right"> <a accesskey="n" href="inforesources.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="混淆电子邮件地址">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="tips.obfuscating.email"></a>混淆电子邮件地址</h2></div></div></div>
<p>
   你会不会惊讶为什么你的邮件地址会收到那么多的垃圾邮件？
   其中一个原因是垃圾邮件发送者们的程序可以在页面上收集你的邮件地址。
   要对抗这些程序，你可以通过javascript在HTML代码里面混淆你的邮件地址，
   而且在浏览器里面看的时候是正常的。
   你可以通过<a class="link" href="language.function.mailto.tpl" title="{mailto}">
    <code class="varname">{mailto}</code></a>函数来进行这样的处理。
   </p>
<div class="example">
<a name="id530816"></a><p class="title"><b>Example 21.8. 混淆电邮地址的例子</b></p>
...
<p>
    参见
    <a class="link" href="language.modifier.escape.tpl" title="escape"><code class="varname">escape</code></a>修饰器和
...
<td width="40%" align="right"> <a accesskey="n" href="inforesources.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">组件化模板 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 22. 资料</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 19 plus 5? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/tips.obfuscating.email.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02131 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
