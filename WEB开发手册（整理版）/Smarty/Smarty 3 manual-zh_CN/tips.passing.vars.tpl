...
<html lang="en">
  <head>
    ...
    <title>传递标题到头部模板 | Smarty</title>
    <meta name="description" content="传递标题到头部模板">
...
<tr><th colspan="3" align="center">传递标题到头部模板</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="tips.default.var.handling.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 21. 技巧</th>
<td width="20%" align="right"> <a accesskey="n" href="tips.dates.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="传递标题到头部模板">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="tips.passing.vars"></a>传递标题到头部模板</h2></div></div></div>
<p>
   当你的模板多数使用了相同的头部和底部HTML代码，通常
   会将它们分隔到单独的模板中，用<a class="link" href="language.function.include.tpl" title="{include}">
    <code class="varname">{include}</code></a>来载入它们。
	但如果头部HTML会根据页面的不同，而需要有不同的标题，
	那么你需要在包含模板时设置标题为<a class="link" href="language.syntax.attributes.tpl" title="属性">属性</a>。
   </p>
<div class="example">
<a name="id530234"></a><p class="title"><b>Example 21.3. 传递标题到头部模板</b></p>
<div class="example-contents">
<p>
    <code class="filename">mainpage.tpl</code> - 当主体页面被渲染时，
	<span class="quote">“<span class="quote">Main Page</span>”</span>的标题值会被传递到
	<code class="filename">header.tpl</code>，这样就可以被当作标题使用了。
    </p>
...
<p>
    <code class="filename">archives.tpl</code> - 当主体页面被渲染时，
	页面标题会是<span class="quote">“<span class="quote">Archives</span>”</span>。
	注意在下面例子中，我们使用了来自配置文件<code class="filename">archives_page.conf</code>的变量，替代硬编码的变量值。
    </p>
<pre class="programlisting">
...
<p>
    <code class="filename">header.tpl</code> - 注意下面例子使用了
	<a class="link" href="language.modifier.default.tpl" title="default"><code class="varname">default</code></a>的变量修饰器，当标题<code class="literal">$title</code>
	变量未设置时，将显示<span class="quote">“<span class="quote">Smarty News</span>”</span>。
    </p>
<pre class="programlisting">
...
<a accesskey="p" href="tips.default.var.handling.tpl">Prev</a> </td>
<td width="20%" align="center"><a accesskey="u" href="tips.tpl">Up</a></td>
<td width="40%" align="right"> <a accesskey="n" href="tips.dates.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">默认变量处理 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 日期时间</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 8 plus 13? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/tips.passing.vars.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01986 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
