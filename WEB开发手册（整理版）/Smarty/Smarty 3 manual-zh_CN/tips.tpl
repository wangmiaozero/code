...
<html lang="en">
  <head>
    ...
    <title>Chapter 21. 技巧 | Smarty</title>
    <meta name="description" content="Chapter 21. 技巧">
    <meta name="keywords" content="chapter, 21, ">
...
<tr><th colspan="3" align="center">Chapter 21. 技巧</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="troubleshooting.tpl">Prev</a> </td>
<th width="60%" align="center">Part IV. 附录</th>
<td width="20%" align="right"> <a accesskey="n" href="tips.default.var.handling.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="chapter" title="Chapter 21. 技巧">
<div class="titlepage"><div><div><h2 class="title">
<a name="tips"></a>Chapter 21. 技巧</h2></div></div></div>
<div class="toc">
...
<div class="sect1" title="空变量的处理">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="tips.blank.var.handling"></a>空变量的处理</h2></div></div></div>
<p>
   很多情况你都需要显示一个默认值，来代替空的变量。
   如在HTML的表格里面显示<code class="literal">&amp;nbsp;</code>。
   通常可以用<a class="link" href="language.function.if.tpl" title="{if},{elseif},{else}"><code class="varname">{if}</code></a>来进行判断，
   而Smarty还可以通过更简便的<a class="link" href="language.modifier.default.tpl" title="default"><code class="varname">default</code></a>修饰器来处理。
    </p>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
<p>
	当PHP的<a class="ulink" href="../../../www.php.net/error_reporting/index.htm" target="_top"><code class="varname">error_reporting()</code></a>级别或者Smarty的<a class="link" href="variable.error.reporting.tpl" title="$error_reporting"><em class="parameter"><code>$error_reporting</code></em></a>设置成E_NOTICE时，在模板内使用未赋值的变量，将会提示
	<span class="quote">“<span class="quote">未定义变量</span>”</span> 错误。
    </p>
</div>
<p>
   </p>
<div class="example">
<a name="id530100"></a><p class="title"><b>Example 21.1. 当变量为空时显示 &amp;nbsp; </b></p>
...
参见<a class="link" href="language.modifier.default.tpl" title="default">
<code class="varname">default</code></a>修饰器和
<a class="link" href="tips.default.var.handling.tpl" title="默认变量处理">默认变量处理</a>.
</p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="tips.default.var.handling.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">Chapter 20. 疑难解答 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 默认变量处理</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 6 plus 20? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/tips.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02204 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
