...
<html lang="en">
  <head>
    ...
    <title>WAP/WML页面 | Smarty</title>
    <meta name="description" content="WAP/WML页面">
...
<tr><th colspan="3" align="center">WAP/WML页面</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="tips.dates.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 21. 技巧</th>
<td width="20%" align="right"> <a accesskey="n" href="tips.componentized.templates.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="WAP/WML页面">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="tips.wap"></a>WAP/WML页面</h2></div></div></div>
<p>
   WAP/WML页面需要发送PHP的<a class="ulink" href="../../../www.php.net/header/index.htm" target="_top">Content-Type 头信息</a>。
   简单的方法是写一个自定义函数来显示头部信息。
   但当开启了<a class="link" href="caching.tpl" title="Chapter 15. 缓存">缓存</a>时，你将需要使用
   <a class="link" href="language.function.insert.tpl" title="{insert}"><code class="varname">{insert}</code></a>来使其生效。
	记住<code class="varname">{insert}</code>是不会被缓存的! 
	确认在模板输出前没有任何的其他内容输出到浏览器，否则头信息将会发送失败。
   </p>
<div class="example">
<a name="id530548"></a><p class="title"><b>Example 21.6. 使用 {insert} 来插入一个WML类型的文件头</b></p>
<div class="example-contents">
<pre class="programlisting">

&lt;?php

// 确保apache已经配置使用.wml的后缀！
// 将以下函数放在你的程序当中，或者在Smarty.addons.php里面
...
<p>
	Smarty模板中的 insert 标签<span class="emphasis"><em>必须</em></span>按照下面方式来写：
    </p>
<pre class="programlisting">
...
<td width="40%" align="right"> <a accesskey="n" href="tips.componentized.templates.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">日期时间 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 组件化模板</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 10 plus 20? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/tips.wap.tpl">
            </form>
            </div>
          </div>
