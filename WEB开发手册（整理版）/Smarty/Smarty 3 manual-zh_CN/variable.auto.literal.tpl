...
<html lang="en">
  <head>
    ...
    <title>$auto_literal | Smarty</title>
    <meta name="description" content="$auto_literal">
    <meta name="keywords" content=", auto_literal">
...
<tr><th colspan="3" align="center">$auto_literal</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.variables.tpl">Prev</a> </td>
...
<div class="sect1" title="$auto_literal">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.auto.literal"></a>$auto_literal</h2></div></div></div>
<p>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 13. Smarty成员变量 </td>
...
<td width="40%" align="right" valign="top"> $autoload_filters</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 8 plus 7? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.auto.literal.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02915 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
