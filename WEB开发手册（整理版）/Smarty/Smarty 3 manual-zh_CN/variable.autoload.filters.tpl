...
<html lang="en">
  <head>
    ...
    <title>$autoload_filters | Smarty</title>
    <meta name="description" content="$autoload_filters">
    <meta name="keywords" content=", autoload_filters">
...
<a accesskey="p" href="variable.auto.literal.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.cache.dir.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
	  如果有些过滤器你希望每个模板编译的时候都可以调用，那么你可以使用这个参数。
	  Smarty将自动加载这些过滤器。参数是二维数组，键是过滤器的类型，值是包含着多个过滤器名字的数组。
	  例如：
       </p>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.cache.dir.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$auto_literal </td>
...
<td width="40%" align="right" valign="top"> $cache_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 16 plus 11? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.autoload.filters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02035 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
