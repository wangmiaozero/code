...
<html lang="en">
  <head>
    ...
    <title>$cache_dir | Smarty</title>
    <meta name="description" content="$cache_dir">
    <meta name="keywords" content=", cache_dir">
...
<a accesskey="p" href="variable.autoload.filters.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.cache.id.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
	  保存模板缓存文件的目录名称，默认是<code class="filename">./cache</code>。
	  这意味着Smarty将进入<code class="filename">cache/</code>目录查找缓存文件并把缓存文件当作PHP来执行。
       <span class="bold"><strong>该目录必须可写入</strong></span>,
     详细参见<a class="link" href="installing.smarty.basic.tpl" title="基础安装">安装</a>。
     </p>
<p>
	 你也可以建立<a class="link" href="caching.custom.tpl" title="自定义缓存实现">自定义缓存</a>来控制缓存文件，这将忽略本设置。
       参见
       <a class="link" href="variable.use.sub.dirs.tpl" title="$use_sub_dirs"><em class="parameter"><code>$use_sub_dirs</code></em></a>。
      </p>
...
<p>
        在Smarty 3.1之后，$cache_dir属性不能直接访问，需使用 <a class="link" href="api.get.cache.dir.tpl" title="getCacheDir()"><code class="varname">getCacheDir()</code></a> 和 
        <a class="link" href="api.set.cache.dir.tpl" title="setCacheDir()"><code class="varname">setCacheDir()</code></a> 来进行存取。
       </p>
</div>
<p>
  参见
  <a class="link" href="api.get.cache.dir.tpl" title="getCacheDir()"><code class="varname">getCacheDir()</code></a>, 
  <a class="link" href="api.set.cache.dir.tpl" title="setCacheDir()"><code class="varname">setCacheDir()</code></a>,
  <a class="link" href="variable.caching.tpl" title="$caching"><em class="parameter"><code>$caching</code></em></a>,
  <a class="link" href="variable.use.sub.dirs.tpl" title="$use_sub_dirs"><em class="parameter"><code>$use_sub_dirs</code></em></a>,
  <a class="link" href="variable.cache.lifetime.tpl" title="$cache_lifetime"><em class="parameter"><code>$cache_lifetime</code></em></a>,
  <a class="link" href="variable.cache.modified.check.tpl" title="$cache_modified_check"><em class="parameter"><code>$cache_modified_check</code></em></a>
  和
...
<td width="40%" align="right"> <a accesskey="n" href="variable.cache.id.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> $cache_id</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 12 plus 19? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="58a923b9210bef663a16f51183c180d7">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.cache.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02191 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
