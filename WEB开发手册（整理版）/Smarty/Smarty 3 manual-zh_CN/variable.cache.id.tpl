...
<html lang="en">
  <head>
    ...
    <title>$cache_id | Smarty</title>
    <meta name="description" content="$cache_id">
    <meta name="keywords" content=", cache_id">
...
<tr><th colspan="3" align="center">$cache_id</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.cache.dir.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.cache.lifetime.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$cache_id">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.cache.id"></a>$cache_id</h2></div></div></div>
<p>
 永久的缓存标识id。
这是可选的设置，在每个函数调用的时候均被传入同一个<em class="parameter"><code>$cache_id</code></em>，你可以设置<em class="parameter"><code>$cache_id</code></em>，随后这个标识id将被隐含地调用。
 </p>
<p>
 使用 <em class="parameter"><code>$cache_id</code></em> 你可以通过调用<a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code></a>
  或<a class="link" href="api.fetch.tpl" title="fetch()"><code class="varname">fetch()</code></a>来得到多个缓存文件，比如多份不同的内容来自同一个模板。
  详细参见
...
<td width="40%" align="right"> <a accesskey="n" href="variable.cache.lifetime.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$cache_dir </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $cache_lifetime</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.cache.id.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02132 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
