...
<html lang="en">
  <head>
    ...
    <meta name="description" content="$cache_lifetime">
    <meta name="keywords" content=", cache_lifetime">
...
<a accesskey="p" href="variable.cache.id.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.cache.locking.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<li class="listitem"><p>
	 使用<em class="parameter"><code>$cache_lifetime</code></em>必须先开启<em class="parameter"><code>$caching</code></em>（值可以是Smarty::CACHING_LIFETIME_CURRENT 或者 Smarty::CACHING_LIFETIME_SAVED）。
     </p></li>
<li class="listitem"><p>
	 设置<em class="parameter"><code>$cache_lifetime</code></em>为-1，则设置缓存永不过期。
     </p></li>
<li class="listitem"><p>
	 设置为0可以让缓存每次都重新生成。（只用于测试。关闭缓存的另一个更高效的方法，是设置<a class="link" href="variable.caching.tpl" title="$caching"><em class="parameter"><code>$caching</code></em></a> = Smarty::CACHING_OFF）
    </p></li>
<li class="listitem"><p>
	如果想要设置特定模板的缓存时间，你可以设置
	<a class="link" href="variable.caching.tpl" title="$caching">
       <em class="parameter"><code>$caching</code></em></a> = Smarty::CACHING_LIFETIME_SAVED，
	然后在调用<a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code>
      </a>或<a class="link" href="api.fetch.tpl" title="fetch()"><code class="varname">fetch()</code></a>之前，设置<em class="parameter"><code>$cache_lifetime</code></em>为一个特定的值。
     </p></li>
</ul></div>
<p>
	如果开启了<a class="link" href="variable.force.compile.tpl" title="$force_compile">
     <em class="parameter"><code>$force_compile</code></em></a>，那么缓存文件将每次都会重新生成，
 实际上等同于关闭缓存。
 你可以通过调用<a class="link" href="api.clear.all.cache.tpl" title="clearAllCache()"><code class="varname">clear_all_cache()</code></a>来清除全部的缓存，
	 或调用<a class="link" href="api.clear.cache.tpl" title="clearCache()"><code class="varname">clear_cache()</code></a>来清除特定的缓存。
    </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.cache.locking.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$cache_id </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $cache_locking</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 13 plus 20? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="75764d812f978c6e1f129aeca8e7a1c9">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.cache.lifetime.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02212 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
