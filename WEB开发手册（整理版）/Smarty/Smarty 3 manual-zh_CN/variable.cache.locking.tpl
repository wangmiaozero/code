...
<html lang="en">
  <head>
    ...
    <title>$cache_locking | Smarty</title>
    <meta name="description" content="$cache_locking">
    <meta name="keywords" content=", cache_locking">
...
<tr><th colspan="3" align="center">$cache_locking</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.cache.lifetime.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.cache.modified.check.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$cache_locking">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.cache.locking"></a>$cache_locking</h2></div></div></div>
<p>
	   缓存锁避免同时生成缓存。这意味着多个模板页面将只会被生成一次缓存，即使同一时刻它们被多次调用。
       </p>
<p>
	   默认缓存锁是关闭的。设置<code class="varname">$cache_locking</code>为true则开启。
       </p>
<p>
       参见
       <a class="link" href="variable.locking.timeout.tpl" title="$locking_timeout"><code class="varname">$locking_timeout</code></a>
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.cache.modified.check.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$cache_lifetime </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $cache_modified_check</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.cache.locking.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02203 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
