...
<html lang="en">
  <head>
    ...
    <title>$cache_modified_check | Smarty</title>
    <meta name="description" content="$cache_modified_check">
    <meta name="keywords" content=", cache_modified_check">
...
<a accesskey="p" href="variable.cache.locking.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.caching.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
如果缓存模板内有<a class="link" href="language.function.insert.tpl" title="{insert}"><code class="varname">{insert}</code></a>标签，该设置将不会生效。
...
<td width="40%" align="right"> <a accesskey="n" href="variable.caching.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$cache_locking </td>
...
<td width="40%" align="right" valign="top"> $caching</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.cache.modified.check.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02145 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
