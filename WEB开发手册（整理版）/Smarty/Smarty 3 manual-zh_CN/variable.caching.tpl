...
<a accesskey="p" href="variable.cache.modified.check.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.caching.type.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
	  设置Smarty是否将模板的输出缓存到<a class="link" href="variable.cache.dir.tpl" title="$cache_dir">
       <em class="parameter"><code>$cache_dir</code></em></a>里。
	  默认将设置成Smarty::CACHING_OFF。
	  如果你的模板每次都生成同样的内容，
	  建议开启<em class="parameter"><code>$caching</code></em>以得到更高的性能。
	   </p>
<p>
	   同个模板可以有<a class="link" href="caching.multiple.caches.tpl" title="单页多个缓存">多个缓存</a>。
       </p>
...
<li class="listitem"><p>
		...
		<a class="link" href="variable.cache.lifetime.tpl" title="$cache_lifetime"><em class="parameter"><code>$cache_lifetime</code></em></a>
		来判断缓存的有效时间，但你可以在调用<a class="link" href="api.fetch.tpl" title="fetch()">fetching</a>前，
		使用<a class="link" href="variable.cache.lifetime.tpl" title="$cache_lifetime"> <em class="parameter"><code>$cache_lifetime</code></em></a>
		来为特定的某个模板设置其过期时间。
	   参见<a class="link" href="api.is.cached.tpl" title="isCached()"><code class="varname">isCached()</code></a>.
           </p></li>
<li class="listitem"><p>
	   当开启了<a class="link" href="variable.compile.check.tpl" title="$compile_check"><em class="parameter"><code>$compile_check</code></em></a>，
	   如果模板文件或配置文件有修改，那么缓存将重新生成。
       </p></li>
<li class="listitem"><p>
	   当开启了<a class="link" href="variable.force.compile.tpl" title="$force_compile">
       <em class="parameter"><code>$force_compile</code></em></a>，缓存内容总是会重新生成。
      </p></li>
</ul></div>
<p>
  参见
  ...
  <a class="link" href="api.is.cached.tpl" title="isCached()"><code class="varname">is_cached()</code></a>
和
...
<td width="40%" align="right"> <a accesskey="n" href="variable.caching.type.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> $caching_type</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.caching.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02164 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
