...
<html lang="en">
  <head>
    ...
    <title>$caching_type | Smarty</title>
    <meta name="description" content="$caching_type">
    <meta name="keywords" content=", caching_type">
...
<tr><th colspan="3" align="center">$caching_type</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.caching.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.compile.check.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$caching_type">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.caching.type"></a>$caching_type</h2></div></div></div>
<p>
 该属性定义了缓存句柄的名称，默认是<code class="literal">file</code>，使用内置的文件系统操作作为缓存方法。
 </p>
<p>
  详细参见 <a class="link" href="caching.custom.tpl" title="自定义缓存实现">自定义缓存</a> 。
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.compile.check.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$caching </td>
...
<td width="40%" align="right" valign="top"> $compile_check</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.caching.type.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02104 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
