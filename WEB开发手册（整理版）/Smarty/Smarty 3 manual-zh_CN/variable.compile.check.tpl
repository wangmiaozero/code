...
<html lang="en">
  <head>
    ...
    <title>$compile_check | Smarty</title>
    <meta name="description" content="$compile_check">
    <meta name="keywords" content=", compile_check">
...
<a accesskey="p" href="variable.caching.type.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.compile.dir.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
	  设置为true时，PHP程序每次调用时，Smarty都会检查当前的模板从上次编译后是否已经被修改过（依据时间戳），
	   如果已被修改，它会重新编译该模板。
	   如果当该模板是从未被编译过的，那么它会忽略此设置并进行编译（不管这变量是否设置成false）。
	   默认该变量为true。
      </p>
<p>
	  当程序部署到了生产环境中（模板再也不需要修改），那么此编译检查也就不需要了，最好设置<em class="parameter"><code>$compile_check</code></em>为false。
	  但这时，如果有个模板被修改，在没有重新编译的情况下，你将*不会*看到任何改变。
	  </p>
<p>
	  如果<a class="link" href="variable.caching.tpl" title="$caching"><em class="parameter"><code>$caching</code></em></a>和
	  <em class="parameter"><code>$compile_check</code></em>同时设置为true，
	  那么当相关的模板文件或者配置文件被修改的时候，缓存文件将重新生成。
	  </p>
<p>
	  在 Smarty 3.1，<em class="parameter"><code>$compile_check</code></em>可以赋值为
	  <code class="literal">Smarty::COMPILECHECK_CACHEMISS</code>。
	  这会使得Smarty在重新生成某个缓存文件的时候，再次检查对应的编译文件。
	  也就是假设一个缓存文件存在但已经过期，Smarty会在重新生成缓存之前，启动一个单独的编译检查程序。
	  </p>
<p>
	   参见 <a class="link" href="variable.force.compile.tpl" title="$force_compile"> <em class="parameter"><code>$force_compile</code></em></a> 和 
	   <a class="link" href="api.clear.compiled.tpl.tpl" title="clearCompiledTemplate()"><code class="varname">clearCompiledTemplate()</code></a>.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.compile.dir.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> $compile_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 0 plus 13? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.compile.check.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02234 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
