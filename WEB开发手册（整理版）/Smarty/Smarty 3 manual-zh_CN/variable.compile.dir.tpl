...
<html lang="en">
  <head>
    ...
    <title>$compile_dir | Smarty</title>
    <meta name="description" content="$compile_dir">
    <meta name="keywords" content=", compile_dir">
...
<tr><th colspan="3" align="center">$compile_dir</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.compile.check.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.compile.id.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$compile_dir">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.compile.dir"></a>$compile_dir</h2></div></div></div>
<p>
	保存模板编译文件的目录名称。默认是<code class="filename">./templates_c</code>，
	这意味着Smarty将进入<code class="filename">templates_c/</code>目录来执行已编译的PHP文件。
...
<p>
     在Smarty 3.1之后，$cache_dir属性不能直接访问，需使用<a class="link" href="api.get.compile.dir.tpl" title="getCompileDir()"><code class="varname">getCompileDir()</code></a> 和 
      <a class="link" href="api.set.compile.dir.tpl" title="setCompileDir()"><code class="varname">setCompileDir()</code></a> 来进行存取。
     </p>
</div>
<p>
     参见
     <a class="link" href="api.get.compile.dir.tpl" title="getCompileDir()"><code class="varname">getCompileDir()</code></a>, 
     <a class="link" href="api.set.compile.dir.tpl" title="setCompileDir()"><code class="varname">setCompileDir()</code></a>,
...
<td width="40%" align="right"> <a accesskey="n" href="variable.compile.id.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> $compile_id</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.compile.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02137 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
