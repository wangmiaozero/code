...
<html lang="en">
  <head>
    ...
    <title>$compile_id | Smarty</title>
    <meta name="description" content="$compile_id">
    <meta name="keywords" content=", compile_id">
...
<a accesskey="p" href="variable.compile.dir.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.compile.locking.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
 永久的编译标识id。这是可选的设置，在每个函数调用的时候均被传入同一个<em class="parameter"><code>$compile_id</code></em>，你可以设置<em class="parameter"><code>$compile_id</code></em>，随后这个标识id将被隐含地调用。
 </p>
<p>
 <em class="parameter"><code>$compile_id</code></em>有个限制就是你不能够在多个模板目录<a class="link" href="variable.template.dir.tpl" title="$template_dir">
  <em class="parameter"><code>$template_dirs</code></em></a>的情况下使用同一个编译标识id<a class="link" href="variable.compile.dir.tpl" title="$compile_dir"><em class="parameter"><code>$compile_dir</code></em></a>。如果你单独为每个模板目录都设置一个<em class="parameter"><code>$compile_id</code></em>，那么Smarty将自动按<em class="parameter"><code>$compile_id</code></em>来对编译文件进行区分。
 </p>
<p>
 举个例子，你会在编译时用<a class="link" href="plugins.prefilters.postfilters.tpl" title="前置/后置过滤器">前置过滤器</a>来本地化你的模板（也就是每个语言均分开），可以用语言名作为<em class="parameter"><code>$compile_id</code></em>，那么你就可以为每种语言单独进行编译了。
 </p>
<p>
 在多域名 / 多虚拟主机的环境中，其他应用程序也有可能使用同一个编译目录，
 </p>
<div class="example">
<a name="id479632"></a><p class="title"><b>Example 13.1. 虚拟主机环境的$compile_id</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.compile.locking.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$compile_dir </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $compile_locking</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 5 plus 6? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.compile.id.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02304 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
