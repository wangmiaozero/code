...
<html lang="en">
  <head>
    ...
    <title>$compile_locking | Smarty</title>
    <meta name="description" content="$compile_locking">
    <meta name="keywords" content=", compile_locking">
...
<tr><th colspan="3" align="center">$compile_locking</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.compile.id.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.compiler.class.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$compile_locking">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.compile.locking"></a>$compile_locking</h2></div></div></div>
<p>
	   编译时避免同时编译同一个模板。
       </p>
<p>
	   编译锁默认是开启的。设置<code class="varname">$compile_locking</code>为false将关闭编译锁。
       </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.compiler.class.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$compile_id </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $compiler_class</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 0 plus 17? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.compile.locking.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02170 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
