...
<html lang="en">
  <head>
    ...
    <title>$compiler_class | Smarty</title>
    <meta name="description" content="$compiler_class">
    <meta name="keywords" content=", compiler_class">
...
<tr><th colspan="3" align="center">$compiler_class</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.compile.locking.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.config.booleanize.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$compiler_class">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.compiler.class"></a>$compiler_class</h2></div></div></div>
<p>
	  指定Smarty将会用来编译模板的编译器名称，默认是“Smarty_Compiler”。仅作为高级用途。
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.config.booleanize.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$compile_locking </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $config_booleanize</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 14 plus 18? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.compiler.class.tpl">
            </form>
            </div>
          </div>
