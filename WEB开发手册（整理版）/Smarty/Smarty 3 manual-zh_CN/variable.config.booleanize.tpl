...
<html lang="en">
  <head>
    ...
    <title>$config_booleanize | Smarty</title>
    <meta name="description" content="$config_booleanize">
    <meta name="keywords" content=", config_booleanize">
...
<a accesskey="p" href="variable.compiler.class.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.config.dir.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
	  设置为true的时候，<a class="link" href="config.files.tpl" title="Chapter 9. 配置文件">配置文件</a>内的变量值如果为<code class="literal">on/true/yes</code>
        或<code class="literal">off/false/no</code>将会自动转换为布尔值。
		这样你可以在使用<code class="literal">{if #foobar#}...{/if}</code>语句时，当foobar是<code class="literal">on</code>，<code class="literal">true</code>或者<code class="literal">yes</code>，<code class="varname">{if}</code>内的语句将被执行。
		默认是true。
      </p>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="variable.config.dir.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$compiler_class </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $config_dir</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 10 plus 17? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.config.booleanize.tpl">
            </form>
            </div>
          </div>
