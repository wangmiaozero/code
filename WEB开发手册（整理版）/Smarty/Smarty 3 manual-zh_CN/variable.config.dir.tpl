...
<html lang="en">
  <head>
    ...
    <title>$config_dir | Smarty</title>
    <meta name="description" content="$config_dir">
    <meta name="keywords" content=", config_dir">
...
<tr><th colspan="3" align="center">$config_dir</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.config.booleanize.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.config.overwrite.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$config_dir">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.config.dir"></a>$config_dir</h2></div></div></div>
<p>
	 设置存储 <a class="link" href="config.files.tpl" title="Chapter 9. 配置文件">配置文件</a>的目录。
	 默认是<code class="filename">./configs</code>，意味着Smarty将查询<code class="filename">configs/</code>并读取配置。
     </p>
...
<p>
	  在Smarty 3.1之后，$config_dir属性不能直接访问，需使用 
       ...
       <a class="link" href="api.add.config.dir.tpl" title="addConfigDir()"><code class="varname">addConfigDir()</code></a>来进行存取。
      </p>
</div>
<p>
      参见
      <a class="link" href="api.get.config.dir.tpl" title="getConfigDir()"><code class="varname">getConfigDir()</code></a>, 
      <a class="link" href="api.set.config.dir.tpl" title="setConfigDir()"><code class="varname">setConfigDir()</code></a> 和
      <a class="link" href="api.add.config.dir.tpl" title="addConfigDir()"><code class="varname">addConfigDir()</code></a>.
     </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.config.overwrite.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$config_booleanize </td>
...
<td width="40%" align="right" valign="top"> $config_overwrite</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.config.dir.tpl">
            </form>
            </div>
          </div>
