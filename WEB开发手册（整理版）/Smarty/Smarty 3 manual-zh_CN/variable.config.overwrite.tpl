...
<html lang="en">
  <head>
    ...
    <title>$config_overwrite | Smarty</title>
    <meta name="description" content="$config_overwrite">
    <meta name="keywords" content=", config_overwrite">
...
<tr><th colspan="3" align="center">$config_overwrite</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.config.dir.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.config.read.hidden.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$config_overwrite">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.config.overwrite"></a>$config_overwrite</h2></div></div></div>
<p>
  默认为true，设置为true时， <a class="link" href="config.files.tpl" title="Chapter 9. 配置文件">配置文件</a>
  内的变量将覆盖每个相同名称的变量值。
  当false时，相同名称的变量将合并成一个数组。
  这在你希望把配置文件内变量变成数组来循环使用的时候非常有用。
  </p>
<div class="example">
<a name="id479929"></a><p class="title"><b>Example 13.2. #变量#数组</b></p>
<div class="example-contents">
<p>
	以下例子是，当<em class="parameter"><code>$config_overwrite</code></em>为false时，
	使用<a class="link" href="language.function.cycle.tpl" title="{cycle}"><code class="varname">{cycle}</code></a>
	来显示一个在每列上交替红/绿/蓝三种颜色的表格。
    </p>
<p>配置文件</p>
...
<p>
	带<a class="link" href="language.function.section.tpl" title="{section},{sectionelse}">
      <code class="varname">{section}</code></a>循环的模板。
      </p>
<pre class="programlisting">
...
<br class="example-break"><p>
    ...
    <a class="link" href="api.config.load.tpl" title="configLoad()"><code class="varname">configLoad()</code></a>
    和<a class="link" href="config.files.tpl" title="Chapter 9. 配置文件">配置文件</a>。
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.config.read.hidden.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$config_dir </td>
...
<td width="40%" align="right" valign="top"> $config_read_hidden</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 0 plus 11? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="f44922a12e33066e7ca3503801886725">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.config.overwrite.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02156 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
