...
<html lang="en">
  <head>
    ...
    <title>$config_read_hidden | Smarty</title>
    <meta name="description" content="$config_read_hidden">
    <meta name="keywords" content=", config_read_hidden">
...
<tr><th colspan="3" align="center">$config_read_hidden</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.config.overwrite.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.debug_template.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$config_read_hidden">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.config.read.hidden"></a>$config_read_hidden</h2></div></div></div>
<p>
       如果设置成true，那么在<a class="link" href="config.files.tpl" title="Chapter 9. 配置文件">配置文件</a>内使用点号（.）开头的隐藏变量将可以被模板读取。
		通常会保持false，这样你可以在配置文件内保存一些敏感数据，如数据库的参数等，也不需要担心模板会载入这些信息。
	   默认为false。
	   </p>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="variable.debug_template.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> $debug_tpl</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.config.read.hidden.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02479 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
