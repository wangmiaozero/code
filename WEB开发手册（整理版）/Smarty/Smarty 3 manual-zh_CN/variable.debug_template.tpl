...
<html lang="en">
  <head>
    ...
    <title>$debug_tpl | Smarty</title>
    <meta name="description" content="$debug_tpl">
    <meta name="keywords" content=", debug_tpl">
...
<tr><th colspan="3" align="center">$debug_tpl</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.config.read.hidden.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.debugging.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$debug_tpl">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.debug_template"></a>$debug_tpl</h2></div></div></div>
<p>
	  设置调试控制台使用的模板文件名称。
	  默认是<code class="filename">debug.tpl</code>文件，存放在
	   <a class="link" href="smarty.constants.tpl#constant.smarty.dir" title="SMARTY_DIR"><code class="constant">SMARTY_DIR</code></a>里。
      </p>
<p>
      参见
...
<td width="40%" align="right"> <a accesskey="n" href="variable.debugging.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$config_read_hidden </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $debugging</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 19 plus 17? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="1f09e85eb462dfa6c23262b21a14ecf3">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.debug_template.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02116 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
