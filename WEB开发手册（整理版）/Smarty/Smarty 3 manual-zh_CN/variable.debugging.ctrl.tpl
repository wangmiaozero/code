...
<html lang="en">
  <head>
    ...
    <meta name="description" content="$debugging_ctrl">
    <meta name="keywords" content=", debugging_ctrl">
...
<a accesskey="p" href="variable.debugging.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.default.config.type.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
	  设置开启调试信息的方式。
	  设置成<code class="literal">NONE</code>则不开启调试信息。
	  <code class="literal">URL</code>值意味着当<code class="literal">URL参数</code>中有<code class="literal">SMARTY_DEBUG</code>关键字则开启调试信息。
		如果开启了<a class="link" href="variable.debugging.tpl" title="$debugging">
        <em class="parameter"><code>$debugging</code></em></a>，则本设置将忽略。
      </p>
<div class="example">
<a name="id480965"></a><p class="title"><b>Example 13.3. 在localhost上的$debugging_ctrl</b></p>
...
<br class="example-break"><p>
     参见 <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. 调试控制台">调试控制台</a>，
     <a class="link" href="variable.debugging.tpl" title="$debugging"><em class="parameter"><code>$debugging</code></em></a> 和
    <a class="link" href="variable.smarty.debug.id.tpl" title="$smarty_debug_id"><em class="parameter"><code>$smarty_debug_id</code></em></a>.
   </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.default.config.type.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$debugging </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $default_config_type</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 18 plus 20? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="a87cb1d5b7b71bbb07eb57d57577e0be">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.debugging.ctrl.tpl">
            </form>
            </div>
          </div>
