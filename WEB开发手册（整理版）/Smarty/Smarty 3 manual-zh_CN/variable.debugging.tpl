...
<a accesskey="p" href="variable.debug_template.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.debugging.ctrl.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
	  <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. 调试控制台">调试控制台</a>的开关设置。
		控制台以javascript弹出窗口的方式显示调试信息。
		调试信息包括<a class="link" href="language.function.include.tpl" title="{include}">包含</a>的模板，
		从PHP<a class="link" href="api.assign.tpl" title="assign()">赋值</a>过来的变量，还有
		<a class="link" href="language.config.variables.tpl" title="从配置文件获取的变量">预配置变量</a>等信息。
	   控制台不会显示在模板里面通过<a class="link" href="language.function.assign.tpl" title="{assign}"><code class="varname">{assign}</code>
       </a>函数进行赋值的变量。
      </p>
<p>
	  使用<a class="link" href="variable.debugging.ctrl.tpl" title="$debugging_ctrl">
      <em class="parameter"><code>$debugging_ctrl</code></em></a>可以通过URL的方式来开启控制台。
      </p>
<p>
     参见
      <a class="link" href="language.function.debug.tpl" title="{debug}"><code class="varname">{debug}</code></a>,
      <a class="link" href="variable.debug_template.tpl" title="$debug_tpl"><em class="parameter"><code>$debug_tpl</code></em></a>,
      和 <a class="link" href="variable.debugging.ctrl.tpl" title="$debugging_ctrl"><em class="parameter"><code>$debugging_ctrl</code></em></a>.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.debugging.ctrl.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$debug_tpl </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $debugging_ctrl</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 12 plus 10? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.debugging.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02105 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
