...
<html lang="en">
  <head>
    ...
    <title>$default_config_handler_func | Smarty</title>
    <meta name="description" content="$default_config_handler_func">
    <meta name="keywords" content=", default_config_handler_func">
...
<tr><th colspan="3" align="center">$default_config_handler_func</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.default.resource.type.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.default.template.handler.func.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$default_config_handler_func">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.default.config.handler.func"></a>$default_config_handler_func</h2></div></div></div>
<p>
...
<p>
  该设置一般在当配置文件是文件资源的时候起作用。
  当找不到资源自身的时候，该设置不会调用，而是会抛出SmartyException异常。
  </p>
</div>
<div class="example">
<a name="id481327"></a><p class="title"><b>Example 13.4. $default_config_handler_func</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.default.template.handler.func.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$default_resource_type </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $default_template_handler_func</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 11 plus 10? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.default.config.handler.func.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02158 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
