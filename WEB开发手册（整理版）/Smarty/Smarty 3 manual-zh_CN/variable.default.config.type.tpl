...
<html lang="en">
  <head>
    ...
    <title>$default_config_type | Smarty</title>
    <meta name="description" content="$default_config_type">
    <meta name="keywords" content=", default_config_type">
...
<tr><th colspan="3" align="center">$default_config_type</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.debugging.ctrl.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.default.modifiers.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$default_config_type">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.default.config.type"></a>$default_config_type</h2></div></div></div>
<p>
	  设置Smarty的配置文件使用的资源类型。
	  默认值为 <code class="literal">file</code>，这意味着
	  <code class="literal">$smarty-&gt;configLoad('test.conf')</code>和
	  <code class="literal">$smarty-&gt;configLoad('file:test.conf')</code>是等价的。

	  详细参见<a class="link" href="resources.tpl" title="Chapter 16. 资源">资源</a>。
	  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.default.modifiers.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$debugging_ctrl </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $default_modifiers</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 7 plus 11? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.default.config.type.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02110 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
