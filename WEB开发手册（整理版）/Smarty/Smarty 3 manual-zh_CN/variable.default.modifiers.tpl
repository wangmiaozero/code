...
<html lang="en">
  <head>
    ...
    <title>$default_modifiers | Smarty</title>
    <meta name="description" content="$default_modifiers">
    <meta name="keywords" content=", default_modifiers">
...
<tr><th colspan="3" align="center">$default_modifiers</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.default.config.type.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.default.resource.type.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$default_modifiers">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.default.modifiers"></a>$default_modifiers</h2></div></div></div>
<p>
	  这是一个包含修饰器名称的数组，这些修饰器将默认地对每个模板变量进行修饰操作。
	  例如我们对每个变量都进行HTML编码，可以用<code class="literal">array('escape:"htmlall"')</code>。
	  如果某个变量要避免这种默认的修饰操作，则需要加上“nofilter”的属性，例如<code class="literal">{$var nofilter}</code>。
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.default.resource.type.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$default_config_type </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $default_resource_type</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 3 plus 13? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.default.modifiers.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02101 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
