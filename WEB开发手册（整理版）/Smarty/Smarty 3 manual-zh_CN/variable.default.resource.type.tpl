...
<html lang="en">
  <head>
    ...
    <title>$default_resource_type | Smarty</title>
    <meta name="description" content="$default_resource_type">
    <meta name="keywords" content=", default_resource_type">
...
<a accesskey="p" href="variable.default.modifiers.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.default.config.handler.func.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
	  设置Smarty隐含使用的资源类型。
	  默认值是<code class="literal">file</code>，意味着<code class="literal">$smarty-&gt;display('index.tpl')</code>和
	  <code class="literal">$smarty-&gt;display('index.tpl')</code>是等价的。
...
<td width="40%" align="right"> <a accesskey="n" href="variable.default.config.handler.func.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$default_modifiers </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $default_config_handler_func</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.default.resource.type.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02157 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
