...
<html lang="en">
  <head>
    ...
    <title>$default_template_handler_func | Smarty</title>
    <meta name="description" content="$default_template_handler_func">
    <meta name="keywords" content=", default_template_handler_func">
  ...
  <body>
  <a class="skiplink" accesskey="S" href="index.htm">Skip over navigation</a>
  <div id="wrapper">
      <div id="header">
        <div id="header_logo">
...
<a accesskey="p" href="variable.default.config.handler.func.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.direct.access.security.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
  该设置一般在当模板是文件资源的时候起作用。
  当找不到资源自身的时候，该设置不会调用，而是会抛出SmartyException异常。
  </p>
</div>
<div class="example">
<a name="id481367"></a><p class="title"><b>Example 13.5. $default_template_handler_func</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.direct.access.security.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> $direct_access_security</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 9 plus 16? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.default.template.handler.func.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02197 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
