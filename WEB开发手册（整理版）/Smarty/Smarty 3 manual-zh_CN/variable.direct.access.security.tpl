...
<html lang="en">
  <head>
    ...
    <title>$direct_access_security | Smarty</title>
    <meta name="description" content="$direct_access_security">
    <meta name="keywords" content=", direct_access_security">
...
<tr><th colspan="3" align="center">$direct_access_security</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.default.template.handler.func.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.error.reporting.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$direct_access_security">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.direct.access.security"></a>$direct_access_security</h2></div></div></div>
<p>
	   直接访问安全机制禁止了直接通过浏览器访问已编译或已缓存的模板文件。
       </p>
<p>
	   直接访问安全机制默认是开启的。关闭该机制可以设置<code class="varname">$direct_access_security</code>为false。
       </p>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
<p>
	   这是一个编译时的选项。如果你修改了该设置，那么你必须重新编译模板才能生效。
       </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="variable.error.reporting.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$default_template_handler_func </td>
...
<td width="40%" align="right" valign="top"> $error_reporting</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 2 plus 2? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="b81ef7edf18495107bfb2f012e1f0fe5">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.direct.access.security.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02176 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
