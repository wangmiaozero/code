...
<html lang="en">
  <head>
    ...
    <title>$error_reporting | Smarty</title>
    <meta name="description" content="$error_reporting">
    <meta name="keywords" content=", error_reporting">
...
<a accesskey="p" href="variable.direct.access.security.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.escape.html.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
 设置一个非空值可以调整<a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code></a>和<a class="link" href="api.fetch.tpl" title="fetch()"><code class="varname">fetch()</code></a>内的
 <a class="ulink" href="../../../www.php.net/error_reporting/index.htm" target="_top"><code class="varname">error_reporting</code></a>报告级别。
 </p>
<p>
 Smarty 3.1.2提供了 <a class="link" href="api.mute.expected.errors.tpl" title="Smarty::muteExpectedErrors()"><code class="varname">muteExpectedErrors()</code></a>函数。
 在设置了自定义错误处理器后，需调用<code class="literal">Smarty::muteExpectedErrors();</code>来确保Smarty产生的warning和notices报告，不会传递到自定义错误处理器上。
 如果你的错误日志充满了关于<code class="literal">filemtime()</code>和<code class="literal">unlink()</code>调用时产生的warning，请使用Smarty的<a class="link" href="api.mute.expected.errors.tpl" title="Smarty::muteExpectedErrors()"><code class="varname">muteExpectedErrors()</code></a>。
 </p>
<p>
  参见
  <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. 调试控制台">调试</a>
  和
  <a class="link" href="troubleshooting.tpl" title="Chapter 20. 疑难解答">疑难解答</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.escape.html.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$direct_access_security </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $escape_html</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 15 plus 9? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.error.reporting.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02151 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
