...
<html lang="en">
  <head>
    ...
    <title>$escape_html | Smarty</title>
    <meta name="description" content="$escape_html">
    <meta name="keywords" content=", escape_html">
...
<tr><th colspan="3" align="center">$escape_html</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.error.reporting.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.force.cache.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$escape_html">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.escape.html"></a>$escape_html</h2></div></div></div>
<p>
 设置<code class="varname">$escape_html</code>为true，Smarty将会为所有模板里的变量调用
 <code class="literal">htmlspecialchars({$output}, ENT_QUOTES, SMARTY_RESOURCE_CHAR_SET);</code>，
 效果等同于调用<code class="literal">{$variable|escape:"html"}</code>。
 </p>
<p>
 模板设计者可以有选择地使用<code class="literal">nofilter</code>标签来关闭此特性在某个变量上的作用：<code class="literal">{$variable nofilter}</code>。
 </p>
<p>
 修饰器和过滤器的执行顺序如下：
 修饰器，
 ...
 在默认修饰器后执行的每个步骤都可以使用<code class="literal">nofilter</code>标签来关闭。
 </p>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.force.cache.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$error_reporting </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $force_cache</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 15 plus 17? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.escape.html.tpl">
            </form>
            </div>
          </div>
