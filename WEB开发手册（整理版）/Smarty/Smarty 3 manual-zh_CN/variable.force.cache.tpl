...
<html lang="en">
  <head>
    ...
    <title>$force_cache | Smarty</title>
    <meta name="description" content="$force_cache">
    <meta name="keywords" content=", force_cache">
...
<tr><th colspan="3" align="center">$force_cache</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.escape.html.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.force.compile.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$force_cache">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.force.cache"></a>$force_cache</h2></div></div></div>
<p>
	  设置Smarty在每次执行的时候都（重新）缓存模板。
	  这不会覆盖<a class="link" href="variable.caching.tpl" title="$caching"><em class="parameter"><code>$caching</code></em></a>级别，
	  仅是假设模板是从未被缓存而已。
      </p>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="variable.force.compile.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$escape_html </td>
...
<td width="40%" align="right" valign="top"> $force_compile</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 2 plus 10? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.force.cache.tpl">
            </form>
            </div>
          </div>
