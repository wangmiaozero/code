...
<html lang="en">
  <head>
    ...
    <title>$force_compile | Smarty</title>
    <meta name="description" content="$force_compile">
    <meta name="keywords" content=", force_compile">
...
<a accesskey="p" href="variable.force.cache.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.left.delimiter.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
	  ...
	  该设置将重写<a class="link" href="variable.compile.check.tpl" title="$compile_check">
       <em class="parameter"><code>$compile_check</code></em></a>值。
	默认情况下是false。
	这是开发和<a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. 调试控制台">调试</a>时比较方便的工具，但在实际生产环境中绝对不能使用。
	如果<a class="link" href="variable.caching.tpl" title="$caching"><em class="parameter"><code>$caching</code></em></a>是开启的，那么缓存文件将每次都会被重新缓存。
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.left.delimiter.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$force_cache </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $left_delimiter</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 18 plus 2? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.force.compile.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02119 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
