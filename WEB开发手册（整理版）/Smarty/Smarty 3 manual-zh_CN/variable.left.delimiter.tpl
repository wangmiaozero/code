...
<html lang="en">
  <head>
    ...
    <title>$left_delimiter | Smarty</title>
    <meta name="description" content="$left_delimiter">
    <meta name="keywords" content=", left_delimiter">
...
<tr><th colspan="3" align="center">$left_delimiter</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.force.compile.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.locking.timeout.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$left_delimiter">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.left.delimiter"></a>$left_delimiter</h2></div></div></div>
<p>
 模板语法中的左限定符。
  默认是<code class="literal">{</code>。
 </p>
<p>
  参见  <a class="link" href="variable.right.delimiter.tpl" title="$right_delimiter"><em class="parameter"><code>$right_delimiter</code></em></a>
 和
...
<td width="40%" align="right"> <a accesskey="n" href="variable.locking.timeout.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$force_compile </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $locking_timeout</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 15 plus 4? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.left.delimiter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02202 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
