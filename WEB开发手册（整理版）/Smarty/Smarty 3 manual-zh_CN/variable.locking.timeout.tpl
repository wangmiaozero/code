...
<html lang="en">
  <head>
    ...
    <title>$locking_timeout | Smarty</title>
    <meta name="description" content="$locking_timeout">
    <meta name="keywords" content=", locking_timeout">
...
<tr><th colspan="3" align="center">$locking_timeout</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.left.delimiter.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.merge.compiled.includes.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$locking_timeout">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.locking.timeout"></a>$locking_timeout</h2></div></div></div>
<p>
	设置一个缓存锁的最大执行时间，避免死锁的情况发生。
	默认是10秒。
    </p>
<p>
     参见
     <a class="link" href="variable.cache.locking.tpl" title="$cache_locking"><code class="varname">$cache_locking</code></a>
    </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.merge.compiled.includes.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$left_delimiter </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $merge_compiled_includes</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.locking.timeout.tpl">
            </form>
            </div>
          </div>
