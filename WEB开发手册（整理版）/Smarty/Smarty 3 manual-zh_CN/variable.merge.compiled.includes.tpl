...
<html lang="en">
  <head>
    ...
    <title>$merge_compiled_includes | Smarty</title>
    <meta name="description" content="$merge_compiled_includes">
    <meta name="keywords" content=", merge_compiled_includes">
...
<tr><th colspan="3" align="center">$merge_compiled_includes</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.locking.timeout.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.php.handling.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$merge_compiled_includes">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.merge.compiled.includes"></a>$merge_compiled_includes</h2></div></div></div>
<p>
	  设置<code class="varname">$merge_compiled_includes</code>为true，Smarty会将子模板的编译文件合并到主模板的编译代码中，
	  可以增加包含了许多子模板的模板文件的渲染速度。
      </p>
<p>
	  设置<code class="varname">{include}</code>的参数<code class="literal">inline</code>可以合并特定的子模板。
	  <code class="literal">inline</code>合并的方式并不一定要开启<code class="varname">$merge_compiled_includes</code>配置。
      </p>
<p>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.php.handling.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$locking_timeout </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $php_handling</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 7 plus 15? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.merge.compiled.includes.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02578 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
