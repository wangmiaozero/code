...
<html lang="en">
  <head>
    ...
    <title>$php_handling | Smarty</title>
    <meta name="description" content="$php_handling">
    <meta name="keywords" content=", php_handling">
...
<tr><th colspan="3" align="center">$php_handling</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.merge.compiled.includes.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.plugins.dir.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$php_handling">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.php.handling"></a>$php_handling</h2></div></div></div>
<p>
	  设置Smarty将如何处理嵌入到模板中的PHP代码。
	  这里有四个选项，默认是<code class="constant">Smarty::PHP_PASSTHRU</code>。
	  注意该设置不会影响到模板中使用<a class="link" href="language.function.php.tpl" title="{php}">
       <code class="varname">{php}{/php}</code></a>标签嵌入的PHP代码。
      </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
       <code class="constant">Smarty::PHP_PASSTHRU</code> - 原样输出这些代码。
       </p></li>
<li class="listitem"><p>
       <code class="constant">Smarty::PHP_QUOTE</code> - 把这些代码转换成HTML实体显示。
         </p></li>
<li class="listitem"><p>
       <code class="constant">Smarty::PHP_REMOVE</code> - 清除这些代码。</p></li>
<li class="listitem"><p>
       <code class="constant">Smarty::PHP_ALLOW</code> - 作为PHP代码来执行。</p></li>
</ul></div>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
<p>
	   强烈不建议在模板内嵌入PHP代码。
	   使用<a class="link" href="plugins.functions.tpl" title="模板函数">自定义函数</a>或者
        <a class="link" href="plugins.modifiers.tpl" title="修饰器">过滤器</a>来替代。
       </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="variable.plugins.dir.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$merge_compiled_includes </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $plugins_dir</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 14 plus 15? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="14c81338dc5451bc02ff0635d5b01925">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.php.handling.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02160 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
