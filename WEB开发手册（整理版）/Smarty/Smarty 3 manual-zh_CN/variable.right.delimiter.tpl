...
<html lang="en">
  <head>
    ...
    <title>$right_delimiter | Smarty</title>
    <meta name="description" content="$right_delimiter">
    <meta name="keywords" content=", right_delimiter">
...
<tr><th colspan="3" align="center">$right_delimiter</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.plugins.dir.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.smarty.debug.id.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$right_delimiter">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.right.delimiter"></a>$right_delimiter</h2></div></div></div>
<p>
 模板语法中的右限定符。
  默认是<code class="literal">}</code>。
 </p>
<p>
  参见 <a class="link" href="variable.left.delimiter.tpl" title="$left_delimiter"><em class="parameter"><code>$left_delimiter</code></em></a>
    和
  <a class="link" href="language.escaping.tpl" title="避免Smarty解析">避免解析</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.smarty.debug.id.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$plugins_dir </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $smarty_debug_id</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 7 plus 1? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.right.delimiter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02134 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
