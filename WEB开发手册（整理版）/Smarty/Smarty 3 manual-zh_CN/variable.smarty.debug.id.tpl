...
<html lang="en">
  <head>
    ...
    <title>$smarty_debug_id | Smarty</title>
    <meta name="description" content="$smarty_debug_id">
    <meta name="keywords" content=", smarty_debug_id">
...
<tr><th colspan="3" align="center">$smarty_debug_id</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.right.delimiter.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.template.dir.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$smarty_debug_id">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.smarty.debug.id"></a>$smarty_debug_id</h2></div></div></div>
<p>
	  <code class="varname">$smarty_debug_id</code>值定义了浏览器中调试的URL关键字。
	  默认值是<code class="literal">SMARTY_DEBUG</code>。
      </p>
<p>
      参见 <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. 调试控制台">错误控制台</a>，
     <a class="link" href="variable.debugging.tpl" title="$debugging"><em class="parameter"><code>$debugging</code></em></a> 和
       <a class="link" href="variable.debugging.ctrl.tpl" title="$debugging_ctrl"><em class="parameter"><code>$debugging_ctrl</code></em></a>.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.template.dir.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$right_delimiter </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $template_dir</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.smarty.debug.id.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02111 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
