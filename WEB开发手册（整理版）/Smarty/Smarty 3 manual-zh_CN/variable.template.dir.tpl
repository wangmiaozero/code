...
<html lang="en">
  <head>
    ...
    <title>$template_dir | Smarty</title>
    <meta name="description" content="$template_dir">
    <meta name="keywords" content=", template_dir">
...
<tr><th colspan="3" align="center">$template_dir</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.smarty.debug.id.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.trusted.dir.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$template_dir">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.template.dir"></a>$template_dir</h2></div></div></div>
<p>
	默认模板目录的设置。
	如果在包含文件时没有设置资源类型，那么Smarty会查询本目录。
	默认值是<code class="filename">./templates</code>，意味着Smaty会查询<code class="filename">templates/</code>寻找模板文件和执行PHP脚本。
	<span class="property">$template_dir</span>同样可以是一个多目录值的数组，Smarty将逐个查询这些目录直到匹配的模板被找到为止。
    </p>
...
<h3 class="title">技术说明</h3>
<p>
	 如果<em class="parameter"><code>$template_dir</code></em> 的目录是相对<a class="ulink" href="../../../www.php.net/ini.core.php#ini.include-path" target="_top">include_path</a>的目录，
	 那么你需要打开<a class="link" href="variable.use.include.path.tpl" title="$use_include_path"><em class="parameter"><code>$use_include_path</code></em></a> 设置。
     </p>
</div>
...
<p>
	 在Smarty 3.1之后，$template_dir属性不能直接访问，需使用 
      <a class="link" href="api.get.template.dir.tpl" title="getTemplateDir()"><code class="varname">getTemplateDir()</code></a>，
      <a class="link" href="api.set.template.dir.tpl" title="setTemplateDir()"><code class="varname">setTemplateDir()</code></a> 和
      <a class="link" href="api.add.template.dir.tpl" title="addTemplateDir()"><code class="varname">addTemplateDir()</code></a>来进行存取。
     </p>
</div>
<p>
     参见
     <a class="link" href="resources.tpl" title="Chapter 16. 资源"><code class="varname">资源</code></a>, 
     <a class="link" href="variable.use.include.path.tpl" title="$use_include_path"><em class="parameter"><code>$use_include_path</code></em></a>, 
     <a class="link" href="api.get.template.dir.tpl" title="getTemplateDir()"><code class="varname">getTemplateDir()</code></a>, 
     <a class="link" href="api.set.template.dir.tpl" title="setTemplateDir()"><code class="varname">setTemplateDir()</code></a> 和
     <a class="link" href="api.add.template.dir.tpl" title="addTemplateDir()"><code class="varname">addTemplateDir()</code></a>.
    </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.trusted.dir.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$smarty_debug_id </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $trusted_dir</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.template.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02568 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
