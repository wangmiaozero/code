...
<html lang="en">
  <head>
    ...
    <title>$trusted_dir | Smarty</title>
    <meta name="description" content="$trusted_dir">
    <meta name="keywords" content=", trusted_dir">
...
<tr><th colspan="3" align="center">$trusted_dir</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.template.dir.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.use.include.path.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$trusted_dir">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.trusted.dir"></a>$trusted_dir</h2></div></div></div>
<p>
	  仅当开启安全设置的时候才可使用<em class="parameter"><code>$trusted_dir</code></em>。
	  这是一个保存信任目录的数组。你可以把PHP脚本存放到信任目录中，在模板内通过<a class="link" href="language.function.include.php.tpl" title="{include_php}"><code class="varname">{include_php}</code></a>来直接执行这些PHP脚本。
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.use.include.path.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$template_dir </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $use_include_path</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.trusted.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02065 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
