...
<html lang="en">
  <head>
    ...
    <title>$use_include_path | Smarty</title>
    <meta name="description" content="$use_include_path">
    <meta name="keywords" content=", use_include_path">
...
<tr><th colspan="3" align="center">$use_include_path</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.trusted.dir.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.use.sub.dirs.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$use_include_path">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.use.include.path"></a>$use_include_path</h2></div></div></div>
<p>
 设置Smarty把<a class="ulink" href="../../../www.php.net/ini.core.php#ini.include-path" target="_top">include_path</a>
 加入<a class="link" href="resources.tpl#resources.file" title="文件资源"><code class="varname">文件资源</code></a>的处理器中，
 以及加入到<a class="link" href="variable.template.dir.tpl" title="$template_dir"><em class="parameter"><code>$template_dir</code></em></a>
 的搜索目录中。 
  本设置还会影响<a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir"><em class="parameter"><code>$plugins_dir</code></em></a>
  使用时也搜索include_path。
 </p>
<div class="note" title="说明" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">说明</h3>
<p>
  设计程序中，不能让你的应用系统依赖于include_path，也就是“依赖于实现”，
  这将极大的降低你的系统（和Smarty）的性能。
  </p>
</div>
<p>
 开启了use_include_path后，
 <a class="link" href="variable.template.dir.tpl" title="$template_dir"><em class="parameter"><code>$template_dir</code></em></a> 和 
  <a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir"><em class="parameter"><code>$plugins_dir</code></em></a> 
  将会以下面的方式来寻找文件。
 </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
   遍历（$template_dir 或 $plugins_dir 的）<code class="literal">$directory</code>目录数组。
   </p></li>
<li class="listitem"><p>
   <code class="literal">$directory</code>中的目录都是相对于
   <a class="ulink" href="../../../www.php.net/function.getcwd.php" target="_top">当前工作目录</a>的，
  查询需要的文件是否在目录中，如果找到文件，则返回。
   </p></li>
<li class="listitem"><p>
   遍历include_path内的<code class="literal">$path</code>路径。
   </p></li>
<li class="listitem"><p>
   <code class="literal">$directory</code>中的目录都是相对于<code class="literal">$path</code>的（可能是
   <a class="ulink" href="../../../www.php.net/function.getcwd.php" target="_top">当前工作目录</a>），
   查询需要的文件是否在目录中，如果找到文件，则返回。
   </p></li>
<li class="listitem"><p>
...
<p>
 这意味着任何相对于当前工作目录的目录/文件都会被搜索到，
 它将在include_path中检查任何可能的目录/文件。
 </p>
<div class="note" title="说明" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">说明</h3>
<p>
...
<p>
   参见
   <a class="link" href="resources.tpl" title="Chapter 16. 资源"><code class="varname">资源</code></a> 和 
...
<td width="40%" align="right"> <a accesskey="n" href="variable.use.sub.dirs.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$trusted_dir </td>
...
<td width="40%" align="right" valign="top"> $use_sub_dirs</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 11 plus 14? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.use.include.path.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01500 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
