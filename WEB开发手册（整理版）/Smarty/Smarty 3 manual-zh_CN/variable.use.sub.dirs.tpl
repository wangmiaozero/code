...
<html lang="en">
  <head>
    ...
    <title>$use_sub_dirs | Smarty</title>
    <meta name="description" content="$use_sub_dirs">
    <meta name="keywords" content=", use_sub_dirs">
...
<tr><th colspan="3" align="center">$use_sub_dirs</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.use.include.path.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty成员变量</th>
<td width="20%" align="right"> <a accesskey="n" href="api.functions.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$use_sub_dirs">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.use.sub.dirs"></a>$use_sub_dirs</h2></div></div></div>
<p>
 当<em class="parameter"><code>$use_sub_dirs</code></em>设置成true的时候，
 Smarty将在<a class="link" href="variable.compile.dir.tpl" title="$compile_dir">编译目录</a> 和
<a class="link" href="variable.cache.dir.tpl" title="$cache_dir">缓存目录</a>下面创建子目录。
默认是false。
...
<p>
子目录是非常高效的，所以如有可能的话，尽可能采用它。
理论上来说，在文件系统上的10个目录里每个目录有100个文件，
比起1个目录有1000个文件，前者性能高得多。
在Solaris 7 (UFS)系统上已经被证实了这点，还有较新的文件系统如ext3，甚至是reiserfs，均大同小异。
</p>
<div class="note" title="技术说明" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">技术说明</h3>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p><code class="literal">$use_sub_dirs=true</code>不会和
	<a class="ulink" href="../../../www.php.net/features.safe-mode" target="_top">safe_mode=On</a>一起工作，
	那就是为什么它是可选并且默认关闭的。
	</p></li>
<li class="listitem"><p>在Windows上设置<code class="literal">$use_sub_dirs=true</code>将会引起一些问题。</p></li>
<li class="listitem"><p>PHP6已经废除了安全模式。</p></li>
</ul></div>
</div>
<p>
  参见
  <a class="link" href="variable.compile.id.tpl" title="$compile_id"><em class="parameter"><code>$compile_id</code></em></a>,
  <a class="link" href="variable.cache.dir.tpl" title="$cache_dir"><em class="parameter"><code>$cache_dir</code></em></a>,
   和
...
<td width="40%" align="right"> <a accesskey="n" href="api.functions.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$use_include_path </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 14. Smarty成员方法</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <div id="commentFormChallenge">What is 19 plus 20? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/variable.use.sub.dirs.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02362 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
