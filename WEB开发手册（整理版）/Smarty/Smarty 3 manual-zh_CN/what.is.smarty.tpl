...
<html lang="en">
  <head>
    ...
    <title>Chapter 1. Smarty是什么? | Smarty</title>
    <meta name="description" content="Chapter 1. Smarty是什么?">
    <meta name="keywords" content="chapter, 1, smarty, ">
...
<tr><th colspan="3" align="center">Chapter 1. Smarty是什么?</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="getting.started.tpl">Prev</a> </td>
<th width="60%" align="center">Part I. 开始</th>
<td width="20%" align="right"> <a accesskey="n" href="installation.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="chapter" title="Chapter 1. Smarty是什么?">
<div class="titlepage"><div><div><h2 class="title">
<a name="what.is.smarty"></a>Chapter 1. Smarty是什么?</h2></div></div></div>
<p>
  Smarty是一个PHP的模板引擎。更明确来说，它可以帮助开发者更好地
  分离程序逻辑和页面显示。最好的例子，是当程序员和模板设计师是不同的两个角色的情况，而且
  大部分时候都不是同一个人的情况。
  </p>
<p>
...
<li class="listitem"><p>
   文章内有<code class="literal">$headline</code>, <code class="literal">$tagline</code>,
   <code class="literal">$author</code> 和 <code class="literal">$body</code>等各部分内容，
   这些内容没有包括它们如何被显示的信息。
   程序将它们<a class="link" href="api.assign.tpl" title="assign()">传递</a>给Smarty。
   </p></li>
<li class="listitem"><p>
   然后，模板设计师编辑模板，使用HTML标签和
   <a class="link" href="language.basic.syntax.tpl" title="Chapter 3. 基本语法">模板标签</a>，来对这些内容进行排版显示，
   如表格、DIV、背景颜色、字体大小、样式表、SVG等等。
   </p></li>
<li class="listitem"><p>
   当有一天，程序员需要改变文章数据内容的获取方式，也就是修改程序逻辑。
   那么这个改变不会影响到模板设计师的工作，内容还是会传递到模板。
   </p></li>
<li class="listitem"><p>
   同样的，如果模板设计师想要完全重新设计模板，也可以做到完全不需要修改程序逻辑。
   </p></li>
<li class="listitem"><p>
   所以，程序员可以改变程序逻辑，而不需要调整模板页面；
   模板设计师也可以修改模板，而不会打断程序逻辑。
  </p></li>
</ul></div>
<p>
...
<li class="listitem"><p>
   ...
   这些显示逻辑如：<a class="link" href="language.function.include.tpl" title="{include}">包含</a>
   其他模板，<a class="link" href="language.function.cycle.tpl" title="{cycle}">交替</a>设置表格每行的颜色，
   把变量转为
   <a class="link" href="language.modifier.upper.tpl" title="upper">大写</a>字母，
   <a class="link" href="language.function.foreach.tpl" title="{foreach},{foreachelse}">循环</a>遍历数组并
   <a class="link" href="api.display.tpl" title="display()">显示</a>出来。
   </p></li>
<li class="listitem"><p>
   Smarty也不是无论如何也强制分离业务和显示逻辑。毕竟Smarty
   无法知道谁是谁，所以，会不会把业务逻辑放到模板也是看你怎么处理。
    </p></li>
<li class="listitem"><p>
   同时，如果你希望在你的模板里<span class="emphasis"><em>没有</em></span>任何的逻辑代码，你也可以
	把模板写成仅剩下文字和变量。
  </p></li>
</ul></div>
<p>
   <span class="bold"><strong>Smarty的一些特性:</strong></span>
  </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
	非常快速。
...
<li class="listitem"><p>
	仅当模板文件被修改后才会聪明地<a class="link" href="variable.compile.check.tpl" title="$compile_check">重新编译</a>。
    </p></li>
<li class="listitem"><p>
	你可以很容易创建自己的<a class="link" href="language.custom.functions.tpl" title="Chapter 8. 自定义函数">函数</a>
     和 <a class="link" href="language.modifiers.tpl" title="Chapter 5. 变量修饰器">变量修饰器</a>，非常具有可扩展性。
    </p></li>
<li class="listitem"><p>
	可配置的模板定界符语法<a class="link" href="variable.left.delimiter.tpl" title="$left_delimiter">{delimiter}</a>，
	你可以使用<code class="literal">{$foo}</code>, <code class="literal">{{$foo}}</code>,
     <code class="literal">&lt;!--{$foo}--&gt;</code>等等。
    </p></li>
<li class="listitem"><p>
	条件判断语句<a class="link" href="language.function.if.tpl" title="{if},{elseif},{else}">
     <code class="literal">{if}..{elseif}..{else}..{/if}</code></a>
	 会直接使用PHP解析，所以<code class="literal">{if...}</code>后可以是简单或者较复杂的表达式。
    </p></li>
<li class="listitem"><p>
	支持无限的<a class="link" href="language.function.section.tpl" title="{section},{sectionelse}">
     <code class="varname">sections</code></a>, <code class="varname">if</code>等的嵌套。
    </p></li>
<li class="listitem"><p>
     内置<a class="link" href="caching.tpl" title="Chapter 15. 缓存">缓存</a>支持。
    </p></li>
<li class="listitem"><p>
	任意的<a class="link" href="resources.tpl" title="Chapter 16. 资源">模板</a>源。
    </p></li>
<li class="listitem"><p>
...
<li class="listitem"><p>
     <a class="link" href="plugins.tpl" title="Chapter 18. 以插件扩展Smarty">插件</a> 架构。
    </p></li>
</ul></div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="installation.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">Part I. 开始 </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 2. 安装</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="../../comments/post/index.htm">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/zh_CN/what.is.smarty.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01770 secs with <a href="../../../www.tinymvc.com/index.htm">TinyMVC</a> and Smarty 3.</p>
  </div>    
